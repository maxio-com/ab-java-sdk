...
```java
CompletableFuture<ListMetafieldsResponse> listMetafieldsAsync(
    final ResourceTypeEnum resourceType,
    final String name,
    final Integer page,
...
```java
CompletableFuture<PaginatedMetadata> listMetadataAsync(
    final ResourceTypeEnum resourceType,
    final Integer page,
    final Integer perPage,
...
| `resourceIds` | `List<Integer>` | Query, Optional | Allow to fetch metadata for multiple records based on provided ids.<br>**Constraints**: *Maximum Items*: `50` |
