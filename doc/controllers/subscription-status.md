...
```java
CompletableFuture<SubscriptionResponse> retrySubscriptionAsync(
...
subscriptionStatusController.retrySubscriptionAsync(subscriptionId).thenAccept(result -> {
...
```java
CompletableFuture<SubscriptionResponse> cancelSubscriptionAsync(
    final String subscriptionId,
...
```java
String subscriptionId = "subscription_id0";
subscriptionStatusController.cancelSubscriptionAsync(subscriptionId, null).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
CompletableFuture<SubscriptionResponse> resumeSubscriptionAsync(
    final String subscriptionId,
    final ResumptionChargeEnum calendarBillingResumptionCharge)
```
...
|  --- | --- | --- | --- |
| `subscriptionId` | `String` | Template, Required | The Chargify id of the subscription |
| `calendarBillingResumptionCharge` | [`ResumptionChargeEnum`](../../doc/models/resumption-charge-enum.md) | Query, Optional | (For calendar billing subscriptions only) The way that the resumed subscription's charge should be handled<br>**Default**: `ResumptionChargeEnum.PRORATED` |
...
subscriptionStatusController.resumeSubscriptionAsync(subscriptionId, Liquid error: Value cannot be null. (Parameter 'key')).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
CompletableFuture<SubscriptionResponse> pauseSubscriptionAsync(
    final String subscriptionId,
...
subscriptionStatusController.pauseSubscriptionAsync(subscriptionId, body).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
CompletableFuture<SubscriptionResponse> updateAutomaticSubscriptionResumptionAsync(
    final String subscriptionId,
    final PauseRequest body)
```
...
subscriptionStatusController.updateAutomaticSubscriptionResumptionAsync(subscriptionId, body).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
CompletableFuture<SubscriptionResponse> reactivateSubscriptionAsync(
    final String subscriptionId,
...
subscriptionStatusController.reactivateSubscriptionAsync(subscriptionId, body).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
CompletableFuture<DelayedCancellationResponse> initiateDelayedCancellationAsync(
    final String subscriptionId,
    final CancellationRequest body)
```
...
```java
String subscriptionId = "subscription_id0";
subscriptionStatusController.initiateDelayedCancellationAsync(subscriptionId, null).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
CompletableFuture<DelayedCancellationResponse> stopDelayedCancellationAsync(
    final String subscriptionId)
```
...
subscriptionStatusController.stopDelayedCancellationAsync(subscriptionId).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
CompletableFuture<SubscriptionResponse> cancelDunningAsync(
    final String subscriptionId)
```
...
subscriptionStatusController.cancelDunningAsync(subscriptionId).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
...
```java
CompletableFuture<RenewalPreviewResponse> previewRenewalAsync(
    final String subscriptionId,
...
subscriptionStatusController.previewRenewalAsync(subscriptionId, body).thenAccept(result -> {
    // TODO success callback handler
    System.out.println(result);
}).exceptionally(exception -> {
    // TODO failure callback handler
