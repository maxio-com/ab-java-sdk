...
| `ExpirationInterval` | `Integer` | Optional | Applicable only to prepaid usage components where rollover_prepaid_remainder is true. The number of `expiration_interval_unit`s after which rollover amounts should expire. | Integer getExpirationInterval() | setExpirationInterval(Integer expirationInterval) |
...
ComponentPricePoint componentPricePoint = new ComponentPricePoint.Builder()
    .id(122)
