...
| `Group` | [`SubscriptionGroup`](../../doc/models/containers/subscription-group.md) | Optional | This is a container for one-of cases. | SubscriptionGroup getGroup() | setGroup(SubscriptionGroup group) |
...
| `PrepaidDunning` | [`SubscriptionPrepaidDunning`](../../doc/models/containers/subscription-prepaid-dunning.md) | Optional | This is a container for one-of cases. | SubscriptionPrepaidDunning getPrepaidDunning() | setPrepaidDunning(SubscriptionPrepaidDunning prepaidDunning) |
