...
|  --- | --- | --- | --- | --- | --- |
| `Include` | [`ListComponentsPricePointsInclude`](../../doc/models/list-components-price-points-include.md) | Optional | Allows including additional data in the response. Use in query: `include=currency_prices`. | ListComponentsPricePointsInclude getInclude() | setInclude(ListComponentsPricePointsInclude include) |
