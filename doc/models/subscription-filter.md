...
SubscriptionFilter subscriptionFilter = new SubscriptionFilter.Builder()
    ...
    .startDatetime(DateTimeHelper.fromRfc8601DateTime("2024-01-17T09:15:30+00:00"))
    .endDatetime(DateTimeHelper.fromRfc8601DateTime("2024-01-17T17:20:06Z"))
    .build();
```
