...
| `PaymentType` | [`PaymentTypeEnum`](../../doc/models/payment-type-enum.md) | Optional | **Default**: `PaymentTypeEnum.CREDIT_CARD` | PaymentTypeEnum getPaymentType() | setPaymentType(PaymentTypeEnum paymentType) |
...
| `CurrentVault` | [`CreatePaymentProfileVaultEnum`](../../doc/models/create-payment-profile-vault-enum.md) | Optional | The vault that stores the payment profile with the provided `vault_token`. Use `bogus` for testing. | CreatePaymentProfileVaultEnum getCurrentVault() | setCurrentVault(CreatePaymentProfileVaultEnum currentVault) |
