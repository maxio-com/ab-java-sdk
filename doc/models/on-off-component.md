...
| `PricingScheme` | [`OnOffComponentPricingScheme`](../../doc/models/containers/on-off-component-pricing-scheme.md) | Required | This is a container for one-of cases. | OnOffComponentPricingScheme getPricingScheme() | setPricingScheme(OnOffComponentPricingScheme pricingScheme) |
