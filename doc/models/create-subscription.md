...
| `Group` | [`CreateSubscriptionGroup`](../../doc/models/containers/create-subscription-group.md) | Optional | This is a container for one-of cases. | CreateSubscriptionGroup getGroup() | setGroup(CreateSubscriptionGroup group) |
