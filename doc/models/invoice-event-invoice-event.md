...
| `PaymentMethod` | [`InvoiceEventInvoiceEventPaymentMethod`](../../doc/models/containers/invoice-event-invoice-event-payment-method.md) | Optional | This is a container for one-of cases. | InvoiceEventInvoiceEventPaymentMethod getPaymentMethod() | setPaymentMethod(InvoiceEventInvoiceEventPaymentMethod paymentMethod) |
...
| `CreditNoteAttributes` | [`CreditNoteInvoiceEvent`](../../doc/models/credit-note-invoice-event.md) | Optional | - | CreditNoteInvoiceEvent getCreditNoteAttributes() | setCreditNoteAttributes(CreditNoteInvoiceEvent creditNoteAttributes) |
