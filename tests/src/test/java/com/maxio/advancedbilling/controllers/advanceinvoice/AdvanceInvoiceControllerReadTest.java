...
class AdvanceInvoiceControllerReadTest {
    ...
    @Test
    void shouldReturn200onReadAdvanceInvoice() throws IOException, ApiException {
        // given
        ...
        // when
        Invoice invoice = advanceInvoiceController.readAdvanceInvoice(subscription.getId());
        ...
        assertThat(invoice.getUpdatedAt().truncatedTo(ChronoUnit.SECONDS)).isBeforeOrEqualTo(beforeDateTime);
    ...
    @Test
    void shouldReturn404WhenReadingAdvanceInvoiceForNonExistentSubscription() {
        // when - then
        assertNotFound(
                () -> advanceInvoiceController.readAdvanceInvoice(123)
        );
    }
    ...
    void shouldReturn401WhenProvidingInvalidCredentials() {
        ...
        assertUnauthorized(() -> TestClientProvider
                ...
                .readAdvanceInvoice(subscription.getId())
        );
    }
}
