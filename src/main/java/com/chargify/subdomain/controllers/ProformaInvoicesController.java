...
import com.chargify.subdomain.exceptions.ErrorMapResponseException;
import com.chargify.subdomain.exceptions.SubscriptionsProformaInvoicesJson400ErrorException;
import com.chargify.subdomain.exceptions.SubscriptionsProformaInvoicesPreviewJson400ErrorException;
...
import com.chargify.subdomain.models.ProformaInvoicePreview;
import com.chargify.subdomain.models.SignupProformaPreviewResponse;
...
public final class ProformaInvoicesController extends BaseController {
     ...
     */
    public CompletableFuture<Void> createConsolidatedProformaInvoiceAsync(
            final String uid) {
        try { 
            return prepareCreateConsolidatedProformaInvoiceRequest(uid).executeAsync(); 
        } catch (Exception e) {  
     ...
     * @return    Returns the ProformaInvoice response from the API call
     */
    public CompletableFuture<ProformaInvoice> listSubscriptionGroupProformaInvoicesAsync(
            final String uid) {
        try { 
            return prepareListSubscriptionGroupProformaInvoicesRequest(uid).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ProformaInvoice response from the API call
     */
    public CompletableFuture<ProformaInvoice> readProformaInvoiceAsync(
            final int proformaInvoiceUid) {
        try { 
            return prepareReadProformaInvoiceRequest(proformaInvoiceUid).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ProformaInvoice response from the API call
     */
    public CompletableFuture<ProformaInvoice> createProformaInvoiceAsync(
            final String subscriptionId) {
        try { 
            return prepareCreateProformaInvoiceRequest(subscriptionId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the List of ProformaInvoice response from the API call
     */
    public CompletableFuture<List<ProformaInvoice>> listProformaInvoicesAsync(
            final String subscriptionId,
            final String startDate,
            final String endDate,
            final StatusEnum status,
     ...
     * @return    Returns the ProformaInvoice response from the API call
     */
    public CompletableFuture<ProformaInvoice> voidProformaInvoiceAsync(
            final String proformaInvoiceUid,
            final VoidInvoiceRequest body) {
        try { 
            return prepareVoidProformaInvoiceRequest(proformaInvoiceUid, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ProformaInvoicePreview response from the API call
     */
    public CompletableFuture<ProformaInvoicePreview> previewProformaInvoiceAsync(
            final String subscriptionId) {
        try { 
            return preparePreviewProformaInvoiceRequest(subscriptionId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ProformaInvoice response from the API call
     */
    public CompletableFuture<ProformaInvoice> createSignupProformaInvoiceAsync(
            final CreateSubscriptionRequest body) {
        try { 
            return prepareCreateSignupProformaInvoiceRequest(body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
        ...
        return new ApiCall.Builder<ProformaInvoice, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("400",
                                ...
                                (reason, context) -> new SubscriptionsProformaInvoicesJson400ErrorException(reason, context)))
                        .localErrorCase("403",
                                 ErrorCase.setReason("Forbidden",
                                (reason, context) -> new ApiException(reason, context)))
                        .localErrorCase("422",
     ...
     * @return    Returns the SignupProformaPreviewResponse response from the API call
     */
    public CompletableFuture<SignupProformaPreviewResponse> previewSignupProformaInvoiceAsync(
            final String includeNextProformaInvoice,
            final CreateSubscriptionRequest body) {
        try { 
            return preparePreviewSignupProformaInvoiceRequest(includeNextProformaInvoice,
    ...
    private ApiCall<SignupProformaPreviewResponse, ApiException> preparePreviewSignupProformaInvoiceRequest(
        ...
        return new ApiCall.Builder<SignupProformaPreviewResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("400",
                                 ErrorCase.setReason("Bad Request",
                                (reason, context) -> new SubscriptionsProformaInvoicesPreviewJson400ErrorException(reason, context)))
                        .localErrorCase("403",
                                 ErrorCase.setReason("Forbidden",
                                (reason, context) -> new ApiException(reason, context)))
                        .localErrorCase("422",
