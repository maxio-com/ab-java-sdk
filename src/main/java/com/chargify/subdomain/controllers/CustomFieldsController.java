...
import com.chargify.subdomain.models.CreateMetadataRequest;
import com.chargify.subdomain.models.CreateMetafieldsRequest;
import com.chargify.subdomain.models.ListMetafieldsResponse;
import com.chargify.subdomain.models.Metadata;
import com.chargify.subdomain.models.Metafield;
import com.chargify.subdomain.models.PaginatedMetadata;
import com.chargify.subdomain.models.ResourceTypeEnum;
import com.chargify.subdomain.models.UpdateMetadataRequest;
import com.chargify.subdomain.models.UpdateMetafieldsRequest;
import com.chargify.subdomain.models.containers.ListMetadataDirection;
import com.chargify.subdomain.models.containers.ListMetafieldsDirection;
...
public final class CustomFieldsController extends BaseController {
     ...
     * @return    Returns the List of Metafield response from the API call
     */
    public CompletableFuture<List<Metafield>> createMetafieldsAsync(
            final ResourceTypeEnum resourceType,
            final CreateMetafieldsRequest body) {
        try { 
            return prepareCreateMetafieldsRequest(resourceType, body).executeAsync(); 
        } catch (Exception e) {  
     ...
     * @return    Returns the ListMetafieldsResponse response from the API call
     */
    public CompletableFuture<ListMetafieldsResponse> listMetafieldsAsync(
            final ResourceTypeEnum resourceType,
            final String name,
            final Integer page,
            final Integer perPage,
        ...
        try { 
            return prepareListMetafieldsRequest(resourceType, name, page, perPage,
     ...
     * @return    Returns the List of Metafield response from the API call
     */
    public CompletableFuture<List<Metafield>> updateMetafieldAsync(
            final ResourceTypeEnum resourceType,
            final String name,
            final String currentName,
            final UpdateMetafieldsRequest body) {
        try { 
            return prepareUpdateMetafieldRequest(resourceType, name, currentName, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     */
    public CompletableFuture<Void> deleteMetafieldAsync(
            final ResourceTypeEnum resourceType,
            final String name) {
        try { 
            return prepareDeleteMetafieldRequest(resourceType, name).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the List of Metadata response from the API call
     */
    public CompletableFuture<List<Metadata>> createMetadataAsync(
            final ResourceTypeEnum resourceType,
            final String resourceId,
            final String value,
            final CreateMetadataRequest body) {
        try { 
            return prepareCreateMetadataRequest(resourceType, resourceId, value, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the PaginatedMetadata response from the API call
     */
    public CompletableFuture<PaginatedMetadata> readMetadataAsync(
            final ResourceTypeEnum resourceType,
            final String resourceId,
            final Integer page,
            final Integer perPage) {
        try { 
            return prepareReadMetadataRequest(resourceType, resourceId, page, perPage).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the List of Metadata response from the API call
     */
    public CompletableFuture<List<Metadata>> updateMetadataAsync(
            final ResourceTypeEnum resourceType,
            final String resourceId,
            final String value,
            final UpdateMetadataRequest body) {
        try { 
            return prepareUpdateMetadataRequest(resourceType, resourceId, value, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @param  names  Optional parameter: Example:
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
     ...
     * @return    Returns the void response from the API call
     */
    public CompletableFuture<Void> deleteMetadataAsync(
            final ResourceTypeEnum resourceType,
            final String resourceId,
            final String name,
            final List<String> names) {
        try { 
            return prepareDeleteMetadataRequest(resourceType, resourceId, name, names).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the PaginatedMetadata response from the API call
     */
    public CompletableFuture<PaginatedMetadata> listMetadataAsync(
            final ResourceTypeEnum resourceType,
            final Integer page,
            final Integer perPage,
            final BasicDateFieldEnum dateField,
        ...
        try { 
            return prepareListMetadataRequest(resourceType, page, perPage, dateField, startDate, endDate,
            startDatetime, endDatetime, withDeleted, resourceIds, direction).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
