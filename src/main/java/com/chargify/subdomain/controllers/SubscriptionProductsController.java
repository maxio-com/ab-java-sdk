...
import com.chargify.subdomain.models.SubscriptionMigrationPreviewRequest;
import com.chargify.subdomain.models.SubscriptionMigrationPreviewResponse;
import com.chargify.subdomain.models.SubscriptionProductMigrationRequest;
...
public final class SubscriptionProductsController extends BaseController {
     ...
     * @return    Returns the SubscriptionResponse response from the API call
     */
    public CompletableFuture<SubscriptionResponse> migrateSubscriptionProductAsync(
            final String subscriptionId,
            final SubscriptionProductMigrationRequest body) {
        try { 
            return prepareMigrateSubscriptionProductRequest(subscriptionId, body).executeAsync(); 
        } catch (Exception e) {  
     ...
     * @return    Returns the SubscriptionMigrationPreviewResponse response from the API call
     */
    public CompletableFuture<SubscriptionMigrationPreviewResponse> previewSubscriptionProductMigrationAsync(
            final String subscriptionId,
            final SubscriptionMigrationPreviewRequest body) {
        try { 
            return preparePreviewSubscriptionProductMigrationRequest(subscriptionId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
