...
public final class ProductFamiliesController extends BaseController {
     ...
     * @return    Returns the List of ProductResponse response from the API call
     */
    public CompletableFuture<List<ProductResponse>> listProductsForProductFamilyAsync(
            final int productFamilyId,
            final Integer page,
            final Integer perPage,
            final BasicDateFieldEnum dateField,
     ...
     * @return    Returns the ProductFamilyResponse response from the API call
     */
    public CompletableFuture<ProductFamilyResponse> createProductFamilyAsync(
            final CreateProductFamilyRequest body) {
        try { 
            return prepareCreateProductFamilyRequest(body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the List of ProductFamilyResponse response from the API call
     */
    public CompletableFuture<List<ProductFamilyResponse>> listProductFamiliesAsync(
            final BasicDateFieldEnum dateField,
            final String startDate,
            final String endDate,
            final String startDatetime,
     ...
     * @return    Returns the ProductFamilyResponse response from the API call
     */
    public CompletableFuture<ProductFamilyResponse> readProductFamilyAsync(
            final int id) {
        try { 
            return prepareReadProductFamilyRequest(id).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
