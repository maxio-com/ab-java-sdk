...
import com.chargify.subdomain.exceptions.CustomersJson422ErrorException;
...
import com.chargify.subdomain.models.UpdateCustomerRequest;
...
public final class CustomersController extends BaseController {
     ...
     * @return    Returns the CustomerResponse response from the API call
     */
    public CompletableFuture<CustomerResponse> createCustomerAsync(
     ...
     * @return    Returns the List of CustomerResponse response from the API call
     */
    public CompletableFuture<List<CustomerResponse>> listCustomersAsync(
            final ListCustomersDirection direction,
            final Integer page,
            final Integer perPage,
            final BasicDateFieldEnum dateField,
        ...
        try { 
            return prepareListCustomersRequest(direction, page, perPage, dateField, startDate, endDate,
            startDatetime, endDatetime, q).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the CustomerResponse response from the API call
     */
    public CompletableFuture<CustomerResponse> readCustomerAsync(
            final int id) {
        try { 
            return prepareReadCustomerRequest(id).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the CustomerResponse response from the API call
     */
    public CompletableFuture<CustomerResponse> updateCustomerAsync(
            final int id,
            final UpdateCustomerRequest body) {
        try { 
            return prepareUpdateCustomerRequest(id, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     */
    public CompletableFuture<Void> deleteCustomerAsync(
            final int id) {
        try { 
            return prepareDeleteCustomerRequest(id).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the CustomerResponse response from the API call
     */
    public CompletableFuture<CustomerResponse> readCustomerByReferenceAsync(
            final String reference) {
        try { 
            return prepareReadCustomerByReferenceRequest(reference).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the List of SubscriptionResponse response from the API call
     */
    public CompletableFuture<List<SubscriptionResponse>> listCustomerSubscriptionsAsync(
            final int customerId) {
        try { 
            return prepareListCustomerSubscriptionsRequest(customerId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
