...
import com.chargify.subdomain.models.ReasonCodesJsonResponse;
import com.chargify.subdomain.models.UpdateReasonCodeRequest;
...
public final class ReasonCodesController extends BaseController {
     ...
     * @return    Returns the ReasonCodeResponse response from the API call
     */
    public CompletableFuture<ReasonCodeResponse> createReasonCodeAsync(
            final CreateReasonCodeRequest body) {
        try { 
            return prepareCreateReasonCodeRequest(body).executeAsync(); 
        } catch (Exception e) {  
     ...
     * @return    Returns the List of ReasonCodeResponse response from the API call
     */
    public CompletableFuture<List<ReasonCodeResponse>> listReasonCodesAsync(
            final Integer page,
            final Integer perPage) {
        try { 
            return prepareListReasonCodesRequest(page, perPage).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ReasonCodeResponse response from the API call
     */
    public CompletableFuture<ReasonCodeResponse> readReasonCodeAsync(
            final int reasonCodeId) {
        try { 
            return prepareReadReasonCodeRequest(reasonCodeId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ReasonCodeResponse response from the API call
     */
    public CompletableFuture<ReasonCodeResponse> updateReasonCodeAsync(
            final int reasonCodeId,
            final UpdateReasonCodeRequest body) {
        try { 
            return prepareUpdateReasonCodeRequest(reasonCodeId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ReasonCodesJsonResponse response from the API call
     */
    public CompletableFuture<ReasonCodesJsonResponse> deleteReasonCodeAsync(
            final int reasonCodeId) {
        try { 
            return prepareDeleteReasonCodeRequest(reasonCodeId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
