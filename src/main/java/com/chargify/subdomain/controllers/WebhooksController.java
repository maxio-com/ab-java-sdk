...
public final class WebhooksController extends BaseController {
     ...
     * @return    Returns the List of WebhookResponse response from the API call
     */
    public CompletableFuture<List<WebhookResponse>> listWebhooksAsync(
            final WebhookStatusEnum status,
            final String sinceDate,
            final String untilDate,
            final Integer page,
     ...
     * @return    Returns the EnableWebhooksResponse response from the API call
     */
    public CompletableFuture<EnableWebhooksResponse> enableWebhooksAsync(
            final EnableWebhooksRequest body) {
        try { 
            return prepareEnableWebhooksRequest(body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ReplayWebhooksResponse response from the API call
     */
    public CompletableFuture<ReplayWebhooksResponse> replayWebhooksAsync(
            final ReplayWebhooksRequest body) {
        try { 
            return prepareReplayWebhooksRequest(body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the EndpointResponse response from the API call
     */
    public CompletableFuture<EndpointResponse> createEndpointAsync(
            final UpdateEndpointRequest body) {
        try { 
            return prepareCreateEndpointRequest(body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the List of Endpoint response from the API call
     */
    public CompletableFuture<List<Endpoint>> listEndpointsAsync() {
        try { 
            return prepareListEndpointsRequest().executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the EndpointResponse response from the API call
     */
    public CompletableFuture<EndpointResponse> updateEndpointAsync(
            final int endpointId,
            final UpdateEndpointRequest body) {
        try { 
            return prepareUpdateEndpointRequest(endpointId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
