...
import com.chargify.subdomain.exceptions.SubscriptionsAllocationsPreviewJson422ErrorException;
import com.chargify.subdomain.exceptions.SubscriptionsComponentsAllocationsAllocationIdJson422ErrorException;
import com.chargify.subdomain.exceptions.SubscriptionsPricePointsJson422ErrorException;
import com.chargify.subdomain.http.request.HttpMethod;
import com.chargify.subdomain.models.AllocateComponents;
import com.chargify.subdomain.models.AllocationPreviewResponse;
import com.chargify.subdomain.models.AllocationResponse;
import com.chargify.subdomain.models.BulkComponentSPricePointAssignment;
import com.chargify.subdomain.models.CreateAllocationRequest;
import com.chargify.subdomain.models.CreateUsageRequest;
import com.chargify.subdomain.models.CreditSchemeRequest;
import com.chargify.subdomain.models.EBBEvent;
...
import com.chargify.subdomain.models.ListSubscriptionComponentsResponse;
...
import com.chargify.subdomain.models.SubscriptionComponentResponse;
import com.chargify.subdomain.models.SubscriptionResponse;
import com.chargify.subdomain.models.SubscriptionStateEnum;
import com.chargify.subdomain.models.UpdateAllocationExpirationDate;
import com.chargify.subdomain.models.UsageResponse;
import com.chargify.subdomain.models.containers.ListSubscriptionComponentsDirection;
...
public final class SubscriptionComponentsController extends BaseController {
     ...
     * @return    Returns the SubscriptionComponentResponse response from the API call
     */
    public CompletableFuture<SubscriptionComponentResponse> readSubscriptionComponentAsync(
            final String subscriptionId,
            final int componentId) {
        try { 
            return prepareReadSubscriptionComponentRequest(subscriptionId, componentId).executeAsync(); 
        } catch (Exception e) {  
     ...
     * @return    Returns the List of SubscriptionComponentResponse response from the API call
     */
    public CompletableFuture<List<SubscriptionComponentResponse>> listSubscriptionComponentsAsync(
            final String subscriptionId,
            final ListSubscriptionComponentsDateFieldEnum dateField,
            final ListSubscriptionComponentsDirection direction,
            final String endDate,
        ...
        try { 
            return prepareListSubscriptionComponentsRequest(subscriptionId, dateField, direction, endDate,
            endDatetime, pricePointIds, productFamilyIds, sort, startDate, startDatetime, include,
            filterUseSiteExchangeRate, filterCurrencies).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the BulkComponentSPricePointAssignment response from the API call
     */
    public CompletableFuture<BulkComponentSPricePointAssignment> updateSubscriptionComponentsPricePointsAsync(
            final String subscriptionId,
        ...
        return new ApiCall.Builder<BulkComponentSPricePointAssignment, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("422",
                                ...
                                (reason, context) -> new SubscriptionsPricePointsJson422ErrorException(reason, context)))
                        .globalErrorCase(GLOBAL_ERROR_CASES))
                .build();
    }
     ...
     * @return    Returns the SubscriptionResponse response from the API call
     */
    public CompletableFuture<SubscriptionResponse> resetSubscriptionComponentsPricePointsAsync(
            final String subscriptionId) {
        try { 
            return prepareResetSubscriptionComponentsPricePointsRequest(subscriptionId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the AllocationResponse response from the API call
     */
    public CompletableFuture<AllocationResponse> allocateComponentAsync(
            final String subscriptionId,
            final int componentId,
            final CreateAllocationRequest body) {
        try { 
            return prepareAllocateComponentRequest(subscriptionId, componentId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the List of AllocationResponse response from the API call
     */
    public CompletableFuture<List<AllocationResponse>> listAllocationsAsync(
            final String subscriptionId,
            final int componentId,
            final Integer page) {
        try { 
            return prepareListAllocationsRequest(subscriptionId, componentId, page).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the List of AllocationResponse response from the API call
     */
    public CompletableFuture<List<AllocationResponse>> allocateComponentsAsync(
            final String subscriptionId,
            final AllocateComponents body) {
        try { 
            return prepareAllocateComponentsRequest(subscriptionId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the AllocationPreviewResponse response from the API call
     */
    public CompletableFuture<AllocationPreviewResponse> previewAllocationsAsync(
            final String subscriptionId,
            final CreateAllocationRequest body) {
        try { 
            return preparePreviewAllocationsRequest(subscriptionId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
    ...
    private ApiCall<AllocationPreviewResponse, ApiException> preparePreviewAllocationsRequest(
        ...
        return new ApiCall.Builder<AllocationPreviewResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("422",
                                 ErrorCase.setReason("Unprocessable Entity (WebDAV)",
                                (reason, context) -> new SubscriptionsAllocationsPreviewJson422ErrorException(reason, context)))
                        .globalErrorCase(GLOBAL_ERROR_CASES))
                .build();
    }
     ...
     */
    public CompletableFuture<Void> updatePrepaidUsageAllocationAsync(
            final String subscriptionId,
            final int componentId,
            final int allocationId,
            final UpdateAllocationExpirationDate body) {
        try { 
            return prepareUpdatePrepaidUsageAllocationRequest(subscriptionId, componentId, allocationId,
            body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    ...
    private ApiCall<Void, ApiException> prepareUpdatePrepaidUsageAllocationRequest(
        ...
        return new ApiCall.Builder<Void, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("422",
                                 ErrorCase.setReason("Unprocessable Entity (WebDAV)",
                                (reason, context) -> new SubscriptionsComponentsAllocationsAllocationIdJson422ErrorException(reason, context)))
                        .globalErrorCase(GLOBAL_ERROR_CASES))
                .build();
    }
     ...
     * @return    Returns the void response from the API call
     */
    public CompletableFuture<Void> deletePrepaidUsageAllocationAsync(
            final String subscriptionId,
            final int componentId,
            final int allocationId,
            final CreditSchemeRequest body) {
        try { 
            return prepareDeletePrepaidUsageAllocationRequest(subscriptionId, componentId, allocationId,
            body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
     ...
     * @return    Returns the UsageResponse response from the API call
     */
    public CompletableFuture<UsageResponse> createUsageAsync(
            final String subscriptionId,
            final int componentId,
            final CreateUsageRequest body) {
        try { 
            return prepareCreateUsageRequest(subscriptionId, componentId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the List of UsageResponse response from the API call
     */
    public CompletableFuture<List<UsageResponse>> listUsagesAsync(
            final String subscriptionId,
            final int componentId,
            final Integer sinceId,
            final Integer maxId,
        ...
        try { 
            return prepareListUsagesRequest(subscriptionId, componentId, sinceId, maxId, sinceDate,
            untilDate, page, perPage).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the void response from the API call
     */
    public CompletableFuture<Void> activateEventBasedComponentAsync(
            final int subscriptionId,
            final int componentId) {
        try { 
            return prepareActivateEventBasedComponentRequest(subscriptionId, componentId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the void response from the API call
     */
    public CompletableFuture<Void> deactivateEventBasedComponentAsync(
            final int subscriptionId,
            final int componentId) {
        try { 
            return prepareDeactivateEventBasedComponentRequest(subscriptionId, componentId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the void response from the API call
     */
    public CompletableFuture<Void> recordEventAsync(
            final String subdomain,
            final String apiHandle,
            final String storeUid,
            final EBBEvent body) {
        try { 
            return prepareRecordEventRequest(subdomain, apiHandle, storeUid, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @param  subdomain  Required parameter: Example:
     * @param  apiHandle  Required parameter: Example:
     * @param  storeUid  Optional parameter: If you've attached your own Keen project as a Chargify
     *         event data-store, use this parameter to indicate the data-store.
     * @param  body  Optional parameter: Example:
     * @throws    ApiException    Represents error response from the server.
     ...
     * @return    Returns the void response from the API call
     */
    public CompletableFuture<Void> recordEventsAsync(
            final String subdomain,
            final String apiHandle,
            final String storeUid,
            final List<EBBEvent> body) {
        try { 
            return prepareRecordEventsRequest(subdomain, apiHandle, storeUid, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ListSubscriptionComponentsResponse response from the API call
     */
    public CompletableFuture<ListSubscriptionComponentsResponse> listSubscriptionComponentsForSiteAsync(
            final Integer page,
            final Integer perPage,
            final ListSubscriptionComponentsSortEnum sort,
            final ListSubscriptionComponentsForSiteDirection direction,
        ...
        try { 
            return prepareListSubscriptionComponentsForSiteRequest(page, perPage, sort, direction,
            dateField, startDate, startDatetime, endDate, endDatetime, subscriptionIds,
            pricePointIds, productFamilyIds, include, filterUseSiteExchangeRate, filterCurrencies,
            filterSubscriptionStates, filterSubscriptionDateField, filterSubscriptionStartDate,
            filterSubscriptionStartDatetime, filterSubscriptionEndDate,
            filterSubscriptionEndDatetime).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
        ...
        return new ApiCall.Builder<ListSubscriptionComponentsResponse, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .queryParam(param -> param.key("filter[subscription][states]")
                                .value(SubscriptionStateEnum.toValue(filterSubscriptionStates)).isRequired(false))
