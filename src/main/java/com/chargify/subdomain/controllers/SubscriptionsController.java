...
import com.chargify.subdomain.exceptions.SubscriptionsActivateJson400ErrorException;
import com.chargify.subdomain.exceptions.SubscriptionsAddCouponJson422ErrorException;
import com.chargify.subdomain.exceptions.SubscriptionsRemoveCouponJson422ErrorException;
import com.chargify.subdomain.http.request.HttpMethod;
import com.chargify.subdomain.models.ActivateSubscriptionRequest;
import com.chargify.subdomain.models.AddCouponsRequest;
...
import com.chargify.subdomain.models.OverrideSubscriptionRequest;
import com.chargify.subdomain.models.PrepaidConfigurationResponse;
import com.chargify.subdomain.models.SubscriptionIncludeEnum;
import com.chargify.subdomain.models.SubscriptionPreviewResponse;
import com.chargify.subdomain.models.SubscriptionPurgeTypeEnum;
import com.chargify.subdomain.models.SubscriptionResponse;
import com.chargify.subdomain.models.UpdateSubscriptionRequest;
import com.chargify.subdomain.models.UpsertPrepaidConfigurationRequest;
...
public final class SubscriptionsController extends BaseController {
     ...
     * @return    Returns the SubscriptionResponse response from the API call
     */
    public CompletableFuture<SubscriptionResponse> createSubscriptionAsync(
     ...
     * @return    Returns the List of SubscriptionResponse response from the API call
     */
    public CompletableFuture<List<SubscriptionResponse>> listSubscriptionsAsync(
     ...
     * @return    Returns the SubscriptionResponse response from the API call
     */
    public CompletableFuture<SubscriptionResponse> updateSubscriptionAsync(
            final String subscriptionId,
    ...
    public SubscriptionResponse readSubscription(
            final String subscriptionId,
            final List<SubscriptionIncludeEnum> include) throws ApiException, IOException {
     ...
     * @return    Returns the SubscriptionResponse response from the API call
     */
    public CompletableFuture<SubscriptionResponse> readSubscriptionAsync(
            final String subscriptionId,
            final List<SubscriptionIncludeEnum> include) {
        try { 
            return prepareReadSubscriptionRequest(subscriptionId, include).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
    ...
    private ApiCall<SubscriptionResponse, ApiException> prepareReadSubscriptionRequest(
            final String subscriptionId,
            final List<SubscriptionIncludeEnum> include) throws IOException {
        return new ApiCall.Builder<SubscriptionResponse, ApiException>()
                .globalConfig(getGlobalConfiguration())
                .requestBuilder(requestBuilder -> requestBuilder
                        .server(Server.ENUM_DEFAULT.value())
                        ...
                        .queryParam(param -> param.key("include[]")
                                .value(SubscriptionIncludeEnum.toValue(include)).isRequired(false))
                        .templateParam(param -> param.key("subscription_id").value(subscriptionId)
                                .shouldEncode(true))
                        .headerParam(param -> param.key("accept").value("application/json"))
                        .authenticationKey(BaseController.AUTHENTICATION_KEY)
     ...
     */
    public CompletableFuture<Void> overrideSubscriptionAsync(
            final String subscriptionId,
            final OverrideSubscriptionRequest body) {
        try { 
            return prepareOverrideSubscriptionRequest(subscriptionId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @param  reference  Optional parameter: Example:
     * @return    Returns the SubscriptionResponse response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
     ...
     * @return    Returns the SubscriptionResponse response from the API call
     */
    public CompletableFuture<SubscriptionResponse> readSubscriptionByReferenceAsync(
            final String reference) {
        try { 
            return prepareReadSubscriptionByReferenceRequest(reference).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @param  subscriptionId  Required parameter: The Chargify id of the subscription
     * @param  ack  Optional parameter: id of the customer.
    ...
    public void purgeSubscription(
            final String subscriptionId,
            final Integer ack,
            final List<SubscriptionPurgeTypeEnum> cascade) throws ApiException, IOException {
     ...
     * @return    Returns the void response from the API call
     */
    public CompletableFuture<Void> purgeSubscriptionAsync(
            final String subscriptionId,
            final Integer ack,
            final List<SubscriptionPurgeTypeEnum> cascade) {
        try { 
            return preparePurgeSubscriptionRequest(subscriptionId, ack, cascade).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
    ...
    private ApiCall<Void, ApiException> preparePurgeSubscriptionRequest(
            final String subscriptionId,
            final Integer ack,
            final List<SubscriptionPurgeTypeEnum> cascade) throws IOException {
        return new ApiCall.Builder<Void, ApiException>()
                .globalConfig(getGlobalConfiguration())
                .requestBuilder(requestBuilder -> requestBuilder
                        .server(Server.ENUM_DEFAULT.value())
                        ...
                        .queryParam(param -> param.key("cascade[]")
                                .value(SubscriptionPurgeTypeEnum.toValue(cascade)).isRequired(false))
                        .templateParam(param -> param.key("subscription_id").value(subscriptionId)
                                .shouldEncode(true))
                        .authenticationKey(BaseController.AUTHENTICATION_KEY)
                        .httpMethod(HttpMethod.POST))
     ...
     * @return    Returns the PrepaidConfigurationResponse response from the API call
     */
    public CompletableFuture<PrepaidConfigurationResponse> createPrepaidSubscriptionAsync(
            final String subscriptionId,
            final UpsertPrepaidConfigurationRequest body) {
        try { 
            return prepareCreatePrepaidSubscriptionRequest(subscriptionId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the SubscriptionPreviewResponse response from the API call
     */
    public CompletableFuture<SubscriptionPreviewResponse> previewSubscriptionAsync(
            final CreateSubscriptionRequest body) {
        try { 
            return preparePreviewSubscriptionRequest(body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the SubscriptionResponse response from the API call
     */
    public CompletableFuture<SubscriptionResponse> applyCouponToSubscriptionAsync(
            final String subscriptionId,
            final String code,
            final AddCouponsRequest body) {
        try { 
            return prepareApplyCouponToSubscriptionRequest(subscriptionId, code, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the String response from the API call
     */
    public CompletableFuture<String> deleteCouponFromSubscriptionAsync(
            final String subscriptionId,
            final String couponCode) {
        try { 
            return prepareDeleteCouponFromSubscriptionRequest(subscriptionId, couponCode).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
    ...
    private ApiCall<String, ApiException> prepareDeleteCouponFromSubscriptionRequest(
        ...
        return new ApiCall.Builder<String, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("422",
                                 ErrorCase.setReason("Unprocessable Entity (WebDAV)",
                                (reason, context) -> new SubscriptionsRemoveCouponJson422ErrorException(reason, context)))
                        .globalErrorCase(GLOBAL_ERROR_CASES))
                .build();
    }
     ...
     * @return    Returns the SubscriptionResponse response from the API call
     */
    public CompletableFuture<SubscriptionResponse> activateSubscriptionAsync(
            final String subscriptionId,
            final ActivateSubscriptionRequest body) {
        try { 
            return prepareActivateSubscriptionRequest(subscriptionId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
    ...
    private ApiCall<SubscriptionResponse, ApiException> prepareActivateSubscriptionRequest(
        ...
        return new ApiCall.Builder<SubscriptionResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("400",
                                 ErrorCase.setReason("Bad Request",
                                (reason, context) -> new SubscriptionsActivateJson400ErrorException(reason, context)))
                        .globalErrorCase(GLOBAL_ERROR_CASES))
                .build();
    }
}