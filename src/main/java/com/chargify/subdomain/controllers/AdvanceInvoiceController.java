...
import com.chargify.subdomain.models.IssueAdvanceInvoiceRequest;
...
public final class AdvanceInvoiceController extends BaseController {
     ...
     * @return    Returns the Invoice response from the API call
     */
    public CompletableFuture<Invoice> issueAdvanceInvoiceAsync(
            final String subscriptionId,
            final IssueAdvanceInvoiceRequest body) {
        try { 
            return prepareIssueAdvanceInvoiceRequest(subscriptionId, body).executeAsync(); 
        } catch (Exception e) {  
     ...
     * @return    Returns the Invoice response from the API call
     */
    public CompletableFuture<Invoice> readAdvanceInvoiceAsync(
            final String subscriptionId) {
        try { 
            return prepareReadAdvanceInvoiceRequest(subscriptionId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the Invoice response from the API call
     */
    public CompletableFuture<Invoice> voidAdvanceInvoiceAsync(
            final String subscriptionId,
            final VoidInvoiceRequest body) {
        try { 
            return prepareVoidAdvanceInvoiceRequest(subscriptionId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
