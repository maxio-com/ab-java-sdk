...
import com.chargify.subdomain.exceptions.PortalCustomersManagementLinkJson429ErrorException;
import com.chargify.subdomain.http.request.HttpMethod;
import com.chargify.subdomain.models.AutoInviteEnum;
import com.chargify.subdomain.models.CustomerResponse;
import com.chargify.subdomain.models.PortalManagementLink;
import com.chargify.subdomain.models.ResentInvitation;
import com.chargify.subdomain.models.RevokedInvitation;
...
public final class BillingPortalController extends BaseController {
    ...
    public CustomerResponse enableBillingPortalForCustomer(
            ...
            final AutoInviteEnum autoInvite) throws ApiException, IOException {
     ...
     * @return    Returns the CustomerResponse response from the API call
     */
    public CompletableFuture<CustomerResponse> enableBillingPortalForCustomerAsync(
            final int customerId,
            final AutoInviteEnum autoInvite) {
        try { 
            return prepareEnableBillingPortalForCustomerRequest(customerId, autoInvite).executeAsync(); 
        } catch (Exception e) {  
    ...
    private ApiCall<CustomerResponse, ApiException> prepareEnableBillingPortalForCustomerRequest(
            final int customerId,
            final AutoInviteEnum autoInvite) throws IOException {
     ...
     * @return    Returns the PortalManagementLink response from the API call
     */
    public CompletableFuture<PortalManagementLink> readBillingPortalLinkAsync(
            final int customerId) {
        try { 
            return prepareReadBillingPortalLinkRequest(customerId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
        ...
        return new ApiCall.Builder<PortalManagementLink, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("429",
                                ...
                                (reason, context) -> new PortalCustomersManagementLinkJson429ErrorException(reason, context)))
                        .globalErrorCase(GLOBAL_ERROR_CASES))
                .build();
    }
     ...
     * @return    Returns the ResentInvitation response from the API call
     */
    public CompletableFuture<ResentInvitation> resendBillingPortalInvitationAsync(
            final int customerId) {
        try { 
            return prepareResendBillingPortalInvitationRequest(customerId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the RevokedInvitation response from the API call
     */
    public CompletableFuture<RevokedInvitation> revokeBillingPortalAccessAsync(
            final int customerId) {
        try { 
            return prepareRevokeBillingPortalAccessRequest(customerId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
