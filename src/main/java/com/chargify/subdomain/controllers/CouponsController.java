...
import com.chargify.subdomain.exceptions.CouponsValidateJson404ErrorException;
...
import com.chargify.subdomain.models.Coupon;
import com.chargify.subdomain.models.CouponCurrency;
import com.chargify.subdomain.models.CouponCurrencyRequest;
import com.chargify.subdomain.models.CouponResponse;
import com.chargify.subdomain.models.CouponSubcodes;
import com.chargify.subdomain.models.CouponSubcodesResponse;
import com.chargify.subdomain.models.CouponUsage;
import com.chargify.subdomain.models.containers.CreateCouponBody;
import com.chargify.subdomain.models.containers.UpdateCouponBody;
...
public final class CouponsController extends BaseController {
     ...
     * @return    Returns the CouponResponse response from the API call
     */
    public CompletableFuture<CouponResponse> createCouponAsync(
            final int productFamilyId,
            final CreateCouponBody body) {
        try { 
            return prepareCreateCouponRequest(productFamilyId, body).executeAsync(); 
        } catch (Exception e) {  
     ...
     * @return    Returns the List of Coupon response from the API call
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
    public List<Coupon> listCouponsForProductFamily(
            final int productFamilyId,
            final Integer page,
     ...
     * @return    Returns the List of Coupon response from the API call
     */
    public CompletableFuture<List<Coupon>> listCouponsForProductFamilyAsync(
            final int productFamilyId,
            final Integer page,
            final Integer perPage,
            final BasicDateFieldEnum filterDateField,
        ...
        try { 
            return prepareListCouponsForProductFamilyRequest(productFamilyId, page, perPage,
            filterDateField, filterEndDate, filterEndDatetime, filterStartDate, filterStartDatetime,
            filterIds, filterCodes, currencyPrices, filterUseSiteExchangeRate).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     */
    private ApiCall<List<Coupon>, ApiException> prepareListCouponsForProductFamilyRequest(
            final int productFamilyId,
            final Integer page,
            final Integer perPage,
            final BasicDateFieldEnum filterDateField,
        ...
        return new ApiCall.Builder<List<Coupon>, ApiException>()
                .globalConfig(getGlobalConfiguration())
                .requestBuilder(requestBuilder -> requestBuilder
                        .server(Server.ENUM_DEFAULT.value())
                        .path("/product_families/{product_family_id}/coupons.json")
     ...
     * @return    Returns the CouponResponse response from the API call
     */
    public CompletableFuture<CouponResponse> readCouponByCodeAsync(
            final Integer productFamilyId,
            final String code) {
        try { 
            return prepareReadCouponByCodeRequest(productFamilyId, code).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the CouponResponse response from the API call
     */
    public CompletableFuture<CouponResponse> readCouponAsync(
            final int productFamilyId,
            final int couponId) {
        try { 
            return prepareReadCouponRequest(productFamilyId, couponId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the CouponResponse response from the API call
     */
    public CompletableFuture<CouponResponse> updateCouponAsync(
            final int productFamilyId,
            final int couponId,
            final UpdateCouponBody body) {
        try { 
            return prepareUpdateCouponRequest(productFamilyId, couponId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the CouponResponse response from the API call
     */
    public CompletableFuture<CouponResponse> archiveCouponAsync(
            final int productFamilyId,
            final int couponId) {
        try { 
            return prepareArchiveCouponRequest(productFamilyId, couponId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the List of CouponResponse response from the API call
     */
    public CompletableFuture<List<CouponResponse>> listCouponsAsync(
            final Integer page,
            final Integer perPage,
            final BasicDateFieldEnum dateField,
            final String startDate,
            ...
            final Boolean filterUseSiteExchangeRate) {
        try { 
            return prepareListCouponsRequest(page, perPage, dateField, startDate, endDate, startDatetime,
            endDatetime, filterIds, filterCodes, currencyPrices, filterEndDate, filterEndDatetime,
            filterStartDate, filterStartDatetime, filterDateField,
     ...
     * @return    Returns the List of CouponUsage response from the API call
     */
    public CompletableFuture<List<CouponUsage>> readCouponUsageAsync(
            final int productFamilyId,
            final int couponId) {
        try { 
            return prepareReadCouponUsageRequest(productFamilyId, couponId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the CouponResponse response from the API call
     */
    public CompletableFuture<CouponResponse> validateCouponAsync(
            final String code,
            final Integer productFamilyId) {
        try { 
            return prepareValidateCouponRequest(code, productFamilyId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
        ...
        return new ApiCall.Builder<CouponResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("404",
                                ...
                                (reason, context) -> new CouponsValidateJson404ErrorException(reason, context)))
                        .globalErrorCase(GLOBAL_ERROR_CASES))
                .build();
    }
     ...
     * @return    Returns the List of CouponCurrency response from the API call
     */
    public CompletableFuture<List<CouponCurrency>> updateCouponCurrencyPricesAsync(
            final int couponId,
            final CouponCurrencyRequest body) {
        try { 
            return prepareUpdateCouponCurrencyPricesRequest(couponId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the CouponSubcodesResponse response from the API call
     */
    public CompletableFuture<CouponSubcodesResponse> createCouponSubcodesAsync(
            final int couponId,
            final CouponSubcodes body) {
        try { 
            return prepareCreateCouponSubcodesRequest(couponId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the CouponSubcodes response from the API call
     */
    public CompletableFuture<CouponSubcodes> listCouponSubcodesAsync(
            final int couponId,
            final Integer page,
            final Integer perPage) {
        try { 
            return prepareListCouponSubcodesRequest(couponId, page, perPage).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the CouponSubcodesResponse response from the API call
     */
    public CompletableFuture<CouponSubcodesResponse> updateCouponSubcodesAsync(
            final int couponId,
            final CouponSubcodes body) {
        try { 
            return prepareUpdateCouponSubcodesRequest(couponId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     *         belongs
     * @param  subcode  Required parameter: Example:
     * @throws    ApiException    Represents error response from the server.
     * @throws    IOException    Signals that an I/O exception of some sort has occurred.
     */
     ...
     */
    public CompletableFuture<Void> deleteCouponSubcodeAsync(
            final int couponId,
            final String subcode) {
        try { 
            return prepareDeleteCouponSubcodeRequest(couponId, subcode).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
