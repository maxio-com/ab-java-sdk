...
import com.chargify.subdomain.exceptions.SubscriptionsRetryJson422ErrorException;
import com.chargify.subdomain.http.request.HttpMethod;
import com.chargify.subdomain.models.CancellationRequest;
import com.chargify.subdomain.models.DelayedCancellationResponse;
import com.chargify.subdomain.models.PauseRequest;
import com.chargify.subdomain.models.ReactivateSubscriptionRequest;
import com.chargify.subdomain.models.RenewalPreviewRequest;
import com.chargify.subdomain.models.RenewalPreviewResponse;
import com.chargify.subdomain.models.ResumptionChargeEnum;
...
public final class SubscriptionStatusController extends BaseController {
     ...
     * @return    Returns the SubscriptionResponse response from the API call
     */
    public CompletableFuture<SubscriptionResponse> retrySubscriptionAsync(
            final String subscriptionId) {
        try { 
            return prepareRetrySubscriptionRequest(subscriptionId).executeAsync(); 
        } catch (Exception e) {  
        ...
        return new ApiCall.Builder<SubscriptionResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("422",
                                ...
                                (reason, context) -> new SubscriptionsRetryJson422ErrorException(reason, context)))
     ...
     * @return    Returns the SubscriptionResponse response from the API call
     */
    public CompletableFuture<SubscriptionResponse> cancelSubscriptionAsync(
            final String subscriptionId,
            final CancellationRequest body) {
        try { 
            return prepareCancelSubscriptionRequest(subscriptionId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
    ...
    public SubscriptionResponse resumeSubscription(
            final String subscriptionId,
            final ResumptionChargeEnum calendarBillingResumptionCharge) throws ApiException, IOException {
     ...
     * @return    Returns the SubscriptionResponse response from the API call
     */
    public CompletableFuture<SubscriptionResponse> resumeSubscriptionAsync(
            final String subscriptionId,
            final ResumptionChargeEnum calendarBillingResumptionCharge) {
        try { 
            return prepareResumeSubscriptionRequest(subscriptionId,
            calendarBillingResumptionCharge).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
    ...
    private ApiCall<SubscriptionResponse, ApiException> prepareResumeSubscriptionRequest(
            final String subscriptionId,
            final ResumptionChargeEnum calendarBillingResumptionCharge) throws IOException {
        return new ApiCall.Builder<SubscriptionResponse, ApiException>()
                .globalConfig(getGlobalConfiguration())
                .requestBuilder(requestBuilder -> requestBuilder
                        .server(Server.ENUM_DEFAULT.value())
     ...
     * @return    Returns the SubscriptionResponse response from the API call
     */
    public CompletableFuture<SubscriptionResponse> pauseSubscriptionAsync(
            final String subscriptionId,
     ...
     * @return    Returns the SubscriptionResponse response from the API call
     */
    public CompletableFuture<SubscriptionResponse> updateAutomaticSubscriptionResumptionAsync(
            final String subscriptionId,
            final PauseRequest body) {
        try { 
            return prepareUpdateAutomaticSubscriptionResumptionRequest(subscriptionId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * Subscription + Given you have a trial_ended subscription + Send a PUT request #### Results +
     * The subscription will transition to active ### Reactivating a trial ended subscription,
     * without the include_trial flag + Given you have a trial_ended subscription + The product
     * associated with the subscription has a trial + Send a PUT request to
     * `https://acme.chargify.com/subscriptions/{subscription_id}/reactivate.json` #### Results +
     ...
     * @return    Returns the SubscriptionResponse response from the API call
     */
    public CompletableFuture<SubscriptionResponse> reactivateSubscriptionAsync(
            final String subscriptionId,
            final ReactivateSubscriptionRequest body) {
        try { 
            return prepareReactivateSubscriptionRequest(subscriptionId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the DelayedCancellationResponse response from the API call
     */
    public CompletableFuture<DelayedCancellationResponse> initiateDelayedCancellationAsync(
            final String subscriptionId,
            final CancellationRequest body) {
        try { 
            return prepareInitiateDelayedCancellationRequest(subscriptionId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the DelayedCancellationResponse response from the API call
     */
    public CompletableFuture<DelayedCancellationResponse> stopDelayedCancellationAsync(
            final String subscriptionId) {
        try { 
            return prepareStopDelayedCancellationRequest(subscriptionId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the SubscriptionResponse response from the API call
     */
    public CompletableFuture<SubscriptionResponse> cancelDunningAsync(
            final String subscriptionId) {
        try { 
            return prepareCancelDunningRequest(subscriptionId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the RenewalPreviewResponse response from the API call
     */
    public CompletableFuture<RenewalPreviewResponse> previewRenewalAsync(
            final String subscriptionId,
            final RenewalPreviewRequest body) {
        try { 
            return preparePreviewRenewalRequest(subscriptionId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
