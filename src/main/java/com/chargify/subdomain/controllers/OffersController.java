...
import com.chargify.subdomain.exceptions.OffersJson422ErrorException;
...
public final class OffersController extends BaseController {
     ...
     * @return    Returns the OfferResponse response from the API call
     */
    public CompletableFuture<OfferResponse> createOfferAsync(
            final CreateOfferRequest body) {
        try { 
            return prepareCreateOfferRequest(body).executeAsync(); 
        } catch (Exception e) {  
        ...
        return new ApiCall.Builder<OfferResponse, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("422",
                                ...
                                (reason, context) -> new OffersJson422ErrorException(reason, context)))
     ...
     * @return    Returns the ListOffersResponse response from the API call
     */
    public CompletableFuture<ListOffersResponse> listOffersAsync() {
        try { 
            return prepareListOffersRequest().executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the OfferResponse response from the API call
     */
    public CompletableFuture<OfferResponse> readOffersAsync(
            final int offerId) {
        try { 
            return prepareReadOffersRequest(offerId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     */
    public CompletableFuture<Void> archiveOfferAsync(
            final int offerId) {
        try { 
            return prepareArchiveOfferRequest(offerId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the void response from the API call
     */
    public CompletableFuture<Void> unarchiveOfferAsync(
            final int offerId) {
        try { 
            return prepareUnarchiveOfferRequest(offerId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
