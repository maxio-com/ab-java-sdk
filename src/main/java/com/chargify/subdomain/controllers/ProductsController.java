...
import com.chargify.subdomain.models.CreateOrUpdateProductRequest;
...
public final class ProductsController extends BaseController {
     ...
     * @return    Returns the ProductResponse response from the API call
     */
    public CompletableFuture<ProductResponse> createProductAsync(
            final int productFamilyId,
            final CreateOrUpdateProductRequest body) {
        try { 
            return prepareCreateProductRequest(productFamilyId, body).executeAsync(); 
        } catch (Exception e) {  
     ...
     * @return    Returns the ProductResponse response from the API call
     */
    public CompletableFuture<ProductResponse> readProductAsync(
            final int productId) {
        try { 
            return prepareReadProductRequest(productId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ProductResponse response from the API call
     */
    public CompletableFuture<ProductResponse> updateProductAsync(
            final int productId,
            final CreateOrUpdateProductRequest body) {
        try { 
            return prepareUpdateProductRequest(productId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ProductResponse response from the API call
     */
    public CompletableFuture<ProductResponse> archiveProductAsync(
            final int productId) {
        try { 
            return prepareArchiveProductRequest(productId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ProductResponse response from the API call
     */
    public CompletableFuture<ProductResponse> readProductByHandleAsync(
            final String apiHandle) {
        try { 
            return prepareReadProductByHandleRequest(apiHandle).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the List of ProductResponse response from the API call
     */
    public CompletableFuture<List<ProductResponse>> listProductsAsync(
            final BasicDateFieldEnum dateField,
            final String endDate,
            final String endDatetime,
            final String startDate,
