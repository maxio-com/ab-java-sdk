...
public final class EventsController extends BaseController {
     ...
     * @param  maxId  Optional parameter: Example:
     * @param  direction  Optional parameter: Example: desc
     ...
     * @return    Returns the List of EventResponse response from the API call
     */
    public CompletableFuture<List<EventResponse>> listEventsAsync(
            final Integer page,
            final Integer perPage,
            final Integer sinceId,
            final Integer maxId,
        ...
        try { 
            return prepareListEventsRequest(page, perPage, sinceId, maxId, direction, filter, dateField,
            startDate, endDate, startDatetime, endDatetime).executeAsync(); 
        } catch (Exception e) {  
        ...
        return new ApiCall.Builder<List<EventResponse>, ApiException>()
                ...
                .requestBuilder(requestBuilder -> requestBuilder
                        ...
                        .queryParam(param -> param.key("filter")
                                .value(EventTypeEnum.toValue(filter)).isRequired(false))
    ...
    public List<EventResponse> listSubscriptionEvents(
            ...
            final Integer maxId,
            final DirectionEnum direction,
            final List<EventTypeEnum> filter) throws ApiException, IOException {
     ...
     * @return    Returns the List of EventResponse response from the API call
     */
    public CompletableFuture<List<EventResponse>> listSubscriptionEventsAsync(
            final String subscriptionId,
            final Integer page,
            final Integer perPage,
            final Integer sinceId,
    ...
    private ApiCall<List<EventResponse>, ApiException> prepareListSubscriptionEventsRequest(
            ...
            final Integer maxId,
            final DirectionEnum direction,
            final List<EventTypeEnum> filter) throws IOException {
        return new ApiCall.Builder<List<EventResponse>, ApiException>()
                .globalConfig(getGlobalConfiguration())
                .requestBuilder(requestBuilder -> requestBuilder
                        .server(Server.ENUM_DEFAULT.value())
     ...
     * @return    Returns the Count response from the API call
     */
    public CompletableFuture<Count> readEventsCountAsync(
            final Integer page,
            final Integer perPage,
            final Integer sinceId,
            final Integer maxId,
