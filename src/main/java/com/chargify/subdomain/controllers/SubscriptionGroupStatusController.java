...
import com.chargify.subdomain.models.CancelGroupedSubscriptionsRequest;
import com.chargify.subdomain.models.ReactivateSubscriptionGroupRequest;
import com.chargify.subdomain.models.ReactivateSubscriptionGroupResponse;
...
public final class SubscriptionGroupStatusController extends BaseController {
     ...
     */
    public CompletableFuture<Void> cancelSubscriptionsInGroupAsync(
            final String uid,
            final CancelGroupedSubscriptionsRequest body) {
        try { 
            return prepareCancelSubscriptionsInGroupRequest(uid, body).executeAsync(); 
        } catch (Exception e) {  
     ...
     * @return    Returns the void response from the API call
     */
    public CompletableFuture<Void> initiateDelayedCancellationForGroupAsync(
            final String uid) {
        try { 
            return prepareInitiateDelayedCancellationForGroupRequest(uid).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the void response from the API call
     */
    public CompletableFuture<Void> stopDelayedCancellationForGroupAsync(
            final String uid) {
        try { 
            return prepareStopDelayedCancellationForGroupRequest(uid).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ReactivateSubscriptionGroupResponse response from the API call
     */
    public CompletableFuture<ReactivateSubscriptionGroupResponse> reactivateSubscriptionGroupAsync(
            final String uid,
            final ReactivateSubscriptionGroupRequest body) {
        try { 
            return prepareReactivateSubscriptionGroupRequest(uid, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
