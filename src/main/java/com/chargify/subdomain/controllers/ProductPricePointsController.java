...
import com.chargify.subdomain.exceptions.ProductPricePointsCurrencyPricesJson422ErrorException;
import com.chargify.subdomain.http.request.HttpMethod;
import com.chargify.subdomain.models.BasicDateFieldEnum;
import com.chargify.subdomain.models.BulkCreateProductPricePointsRequest;
import com.chargify.subdomain.models.BulkCreateProductPricePointsResponse;
import com.chargify.subdomain.models.CreateProductCurrencyPricesRequest;
import com.chargify.subdomain.models.CreateProductPricePointRequest;
...
import com.chargify.subdomain.models.ProductPricePointCurrencyPrice;
import com.chargify.subdomain.models.ProductPricePointResponse;
import com.chargify.subdomain.models.UpdateCurrencyPricesRequest;
import com.chargify.subdomain.models.UpdateProductPricePointRequest;
...
public final class ProductPricePointsController extends BaseController {
     ...
     * @return    Returns the ProductPricePointResponse response from the API call
     */
    public CompletableFuture<ProductPricePointResponse> createProductPricePointAsync(
            final int productId,
            final CreateProductPricePointRequest body) {
        try { 
            return prepareCreateProductPricePointRequest(productId, body).executeAsync(); 
        } catch (Exception e) {  
     ...
     * @return    Returns the ListProductPricePointsResponse response from the API call
     */
    public CompletableFuture<ListProductPricePointsResponse> listProductPricePointsAsync(
            final int productId,
            final Integer page,
            final Integer perPage,
            final Boolean currencyPrices,
     ...
     * @return    Returns the ProductPricePointResponse response from the API call
     */
    public CompletableFuture<ProductPricePointResponse> updateProductPricePointAsync(
            final int productId,
            final int pricePointId,
            final UpdateProductPricePointRequest body) {
        try { 
            return prepareUpdateProductPricePointRequest(productId, pricePointId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ProductPricePointResponse response from the API call
     */
    public CompletableFuture<ProductPricePointResponse> readProductPricePointAsync(
            final int productId,
            final int pricePointId,
            final Boolean currencyPrices) {
        try { 
            return prepareReadProductPricePointRequest(productId, pricePointId,
            currencyPrices).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ProductPricePointResponse response from the API call
     */
    public CompletableFuture<ProductPricePointResponse> archiveProductPricePointAsync(
            final int productId,
            final int pricePointId) {
        try { 
            return prepareArchiveProductPricePointRequest(productId, pricePointId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ProductPricePointResponse response from the API call
     */
    public CompletableFuture<ProductPricePointResponse> unarchiveProductPricePointAsync(
            final int productId,
            final int pricePointId) {
        try { 
            return prepareUnarchiveProductPricePointRequest(productId, pricePointId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ProductPricePointResponse response from the API call
     */
    public CompletableFuture<ProductPricePointResponse> setDefaultPricePointForProductAsync(
            final int productId,
            final int pricePointId) {
        try { 
            return prepareSetDefaultPricePointForProductRequest(productId, pricePointId).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the BulkCreateProductPricePointsResponse response from the API call
     */
    public CompletableFuture<BulkCreateProductPricePointsResponse> createProductPricePointsAsync(
            final int productId,
            final BulkCreateProductPricePointsRequest body) {
        try { 
            return prepareCreateProductPricePointsRequest(productId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ProductPricePointCurrencyPrice response from the API call
     */
    public CompletableFuture<ProductPricePointCurrencyPrice> createProductCurrencyPricesAsync(
            final int productPricePointId,
            final CreateProductCurrencyPricesRequest body) {
        try { 
            return prepareCreateProductCurrencyPricesRequest(productPricePointId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
        ...
        return new ApiCall.Builder<ProductPricePointCurrencyPrice, ApiException>()
                ...
                .responseHandler(responseHandler -> responseHandler
                        ...
                        .localErrorCase("422",
                                ...
                                (reason, context) -> new ProductPricePointsCurrencyPricesJson422ErrorException(reason, context)))
                        .globalErrorCase(GLOBAL_ERROR_CASES))
                .build();
    }
     ...
     * @return    Returns the List of ProductPricePointCurrencyPrice response from the API call
     */
    public CompletableFuture<List<ProductPricePointCurrencyPrice>> updateProductCurrencyPricesAsync(
            final int productPricePointId,
            final UpdateCurrencyPricesRequest body) {
        try { 
            return prepareUpdateProductCurrencyPricesRequest(productPricePointId, body).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
     ...
     * @return    Returns the ListProductPricePointsResponse response from the API call
     */
    public CompletableFuture<ListProductPricePointsResponse> listAllProductPricePointsAsync(
            final ListAllProductPricePointsDirection direction,
            final IncludeNotNullEnum filterArchivedAt,
            final BasicDateFieldEnum filterDateField,
            final String filterEndDate,
        ...
        try { 
            return prepareListAllProductPricePointsRequest(direction, filterArchivedAt, filterDateField,
            filterEndDate, filterEndDatetime, filterIds, filterStartDate, filterStartDatetime,
            filterType, include, page, perPage).executeAsync(); 
        } catch (Exception e) {  
            throw new CompletionException(e); 
        }
    }
