...
public class ListSubcriptionGroupPrepaymentItem {
    ...
    private String memo;
    private PrepaymentMethodEnum paymentType;
     ...
     * @param  paymentType  PrepaymentMethodEnum value for paymentType.
    ...
    public ListSubcriptionGroupPrepaymentItem(
            ...
            Boolean external,
            String memo,
            PrepaymentMethodEnum paymentType,
            String createdAt) {
        this.id = id;
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public PrepaymentMethodEnum getPaymentType() {
        return paymentType;
    }
     ...
     * collected using the default credit card payment profile and applied to the prepayment account
     * balance. This is especially useful for manual replenishment of prepaid subscriptions.
     * @param paymentType Value for PrepaymentMethodEnum
     */
    @JsonSetter("payment_type")
    public void setPaymentType(PrepaymentMethodEnum paymentType) {
        this.paymentType = paymentType;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder paymentType(PrepaymentMethodEnum paymentType) {
            this.paymentType = paymentType;
            return this;
        }
