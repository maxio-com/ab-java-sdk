...
import com.chargify.subdomain.models.containers.OveragePricingPrices;
import com.chargify.subdomain.models.containers.OveragePricingPricingScheme;
...
public class OveragePricing {
    ...
    private List<OveragePricingPrices> prices;
     ...
     * @param  prices  List of OveragePricingPrices value for prices.
     */
    public OveragePricing(
            OveragePricingPricingScheme pricingScheme,
            List<OveragePricingPrices> prices) {
    ...
    /**
     * Getter for Prices.
     * @return Returns the List of OveragePricingPrices
     */
    @JsonGetter("prices")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public List<OveragePricingPrices> getPrices() {
        return prices;
    }

    /**
     * Setter for Prices.
     * @param prices Value for List of OveragePricingPrices
     */
    @JsonSetter("prices")
    public void setPrices(List<OveragePricingPrices> prices) {
        this.prices = prices;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder prices(List<OveragePricingPrices> prices) {
            this.prices = prices;
            return this;
        }
