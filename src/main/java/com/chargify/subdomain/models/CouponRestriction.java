...
public class CouponRestriction {
    private String id;
    private RestrictionTypeEnum itemType;
     ...
     * @param  itemType  RestrictionTypeEnum value for itemType.
     ...
     */
    protected CouponRestriction(String id, RestrictionTypeEnum itemType, Integer itemId,
            String name, OptionalNullable<String> handle) {
        this.id = id;
        this.itemType = itemType;
        this.itemId = itemId;
        this.name = name;
    ...
    /**
     * Getter for ItemType.
     * @return Returns the RestrictionTypeEnum
     */
    @JsonGetter("item_type")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public RestrictionTypeEnum getItemType() {
        return itemType;
    }

    /**
     * Setter for ItemType.
     * @param itemType Value for RestrictionTypeEnum
     */
    @JsonSetter("item_type")
    public void setItemType(RestrictionTypeEnum itemType) {
        this.itemType = itemType;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder itemType(RestrictionTypeEnum itemType) {
            this.itemType = itemType;
            return this;
        }
