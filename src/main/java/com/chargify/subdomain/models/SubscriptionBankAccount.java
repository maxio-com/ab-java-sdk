...
public class SubscriptionBankAccount {
    ...
    private BankAccountVaultEnum currentVault;
     ...
     * @param  currentVault  BankAccountVaultEnum value for currentVault.
    ...
    public SubscriptionBankAccount(
            ...
            BankAccountVaultEnum currentVault,
            Integer customerId,
     ...
     * @return Returns the BankAccountVaultEnum
     */
    @JsonGetter("current_vault")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public BankAccountVaultEnum getCurrentVault() {
        return currentVault;
    }
     ...
     * The vault that stores the payment profile with the provided vault_token.
     * @param currentVault Value for BankAccountVaultEnum
     */
    @JsonSetter("current_vault")
    public void setCurrentVault(BankAccountVaultEnum currentVault) {
        this.currentVault = currentVault;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder currentVault(BankAccountVaultEnum currentVault) {
            this.currentVault = currentVault;
            return this;
        }
