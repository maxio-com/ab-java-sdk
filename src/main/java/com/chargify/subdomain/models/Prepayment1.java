...
public class Prepayment1 {
     ...
     * @param  paymentType  Object value for paymentType.
     */
    public Prepayment1(
            double id,
     ...
     * @param paymentType Value for Object
     */
    ...
    public String toString() {
        return "Prepayment1 [" + "id=" + id + ", subscriptionId=" + subscriptionId
                ...
                + ", createdAt=" + createdAt + ", details=" + details + ", paymentType="
                + paymentType + "]";
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder paymentType(Object paymentType) {
            this.paymentType = paymentType;
            return this;
        }
        ...
        public Prepayment1 build() {
            return new Prepayment1(id, subscriptionId, amountInCents, remainingAmountInCents,
                    external, memo, createdAt, details, paymentType);
        }
    }
}
