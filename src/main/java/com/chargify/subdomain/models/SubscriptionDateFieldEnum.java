...
/**
 * SubscriptionDateFieldEnum to be used.
 */
public enum SubscriptionDateFieldEnum {
    ...
    private static TreeMap<String, SubscriptionDateFieldEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static SubscriptionDateFieldEnum constructFromString(String toConvert) throws IOException {
        SubscriptionDateFieldEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static SubscriptionDateFieldEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of SubscriptionDateFieldEnum values to list of string values.
     * @param toConvert The list of SubscriptionDateFieldEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<SubscriptionDateFieldEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (SubscriptionDateFieldEnum enumValue : toConvert) {
