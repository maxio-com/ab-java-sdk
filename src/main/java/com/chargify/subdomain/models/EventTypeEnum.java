...
public enum EventTypeEnum {
    ...
    private static TreeMap<String, EventTypeEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static EventTypeEnum constructFromString(String toConvert) throws IOException {
        EventTypeEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static EventTypeEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of EventTypeEnum values to list of string values.
     * @param toConvert The list of EventTypeEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<EventTypeEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (EventTypeEnum enumValue : toConvert) {
