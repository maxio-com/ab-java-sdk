...
import com.chargify.subdomain.models.containers.CreateMultiInvoicePaymentAmount;
...
public class CreateMultiInvoicePayment {
    ...
    private InvoicePaymentMethodTypeEnum method;
     ...
     * @param  method  InvoicePaymentMethodTypeEnum value for method.
    ...
    public CreateMultiInvoicePayment(
            ...
            String memo,
            String details,
            InvoicePaymentMethodTypeEnum method,
            String receivedOn) {
        this.memo = memo;
     ...
     * @return Returns the InvoicePaymentMethodTypeEnum
     */
    @JsonGetter("method")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public InvoicePaymentMethodTypeEnum getMethod() {
        return method;
    }
     ...
     * Setter for Method.
     * The type of payment method used.
     * @param method Value for InvoicePaymentMethodTypeEnum
     */
    @JsonSetter("method")
    public void setMethod(InvoicePaymentMethodTypeEnum method) {
        this.method = method;
    }
    ...
    public static class Builder {
        ...
        private String memo;
        private String details;
        private InvoicePaymentMethodTypeEnum method = InvoicePaymentMethodTypeEnum.OTHER;
        private String receivedOn;
         ...
         * @return Builder
         */
        public Builder method(InvoicePaymentMethodTypeEnum method) {
            this.method = method;
            return this;
        }
