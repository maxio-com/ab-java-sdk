...
/**
 * SubscriptionStateEnum to be used.
 */
public enum SubscriptionStateEnum {
    ...
    private static TreeMap<String, SubscriptionStateEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static SubscriptionStateEnum constructFromString(String toConvert) throws IOException {
        SubscriptionStateEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static SubscriptionStateEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of SubscriptionStateEnum values to list of string values.
     * @param toConvert The list of SubscriptionStateEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<SubscriptionStateEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (SubscriptionStateEnum enumValue : toConvert) {
