...
import com.chargify.subdomain.models.containers.QuantityBasedComponentPricingScheme;
import com.chargify.subdomain.models.containers.QuantityBasedComponentUnitPrice;
...
public class QuantityBasedComponent {
    ...
    public String toString() {
        return "QuantityBasedComponent [" + "name=" + name + ", unitName=" + unitName
                ...
                + priceInCents + ", recurring=" + recurring + "]";
    }
    ...
    public static class Builder {
        ...
        public QuantityBasedComponent build() {
            return new QuantityBasedComponent(name, unitName, pricingScheme, description, handle,
                    ...
                    taxCode, hideDateRangeOnInvoice, priceInCents, recurring);
        }
    }
}
