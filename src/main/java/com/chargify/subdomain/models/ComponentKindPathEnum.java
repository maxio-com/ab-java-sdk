...
/**
 * ComponentKindPathEnum to be used.
 */
public enum ComponentKindPathEnum {
    METERED_COMPONENTS,
    ...
    private static TreeMap<String, ComponentKindPathEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static ComponentKindPathEnum constructFromString(String toConvert) throws IOException {
        ComponentKindPathEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static ComponentKindPathEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of ComponentKindPathEnum values to list of string values.
     * @param toConvert The list of ComponentKindPathEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<ComponentKindPathEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (ComponentKindPathEnum enumValue : toConvert) {
