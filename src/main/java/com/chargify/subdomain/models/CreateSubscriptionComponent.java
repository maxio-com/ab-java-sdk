...
import com.chargify.subdomain.models.containers.CreateSubscriptionComponentComponentId;
import com.chargify.subdomain.models.containers.CreateSubscriptionComponentPricePointId;
...
public class CreateSubscriptionComponent {
    ...
    public String toString() {
        return "CreateSubscriptionComponent [" + "componentId=" + componentId + ", enabled="
                ...
                + allocatedQuantity + ", pricePointId=" + pricePointId + ", customPrice="
                + customPrice + "]";
    }
    ...
    public static class Builder {
        ...
        public CreateSubscriptionComponent build() {
            return new CreateSubscriptionComponent(componentId, enabled, unitBalance,
                    allocatedQuantity, pricePointId, customPrice);
        }
    }
}
