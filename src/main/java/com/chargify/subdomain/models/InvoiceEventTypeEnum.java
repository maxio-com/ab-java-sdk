...
/**
 * InvoiceEventTypeEnum to be used.
 */
public enum InvoiceEventTypeEnum {
    ...
    private static TreeMap<String, InvoiceEventTypeEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static InvoiceEventTypeEnum constructFromString(String toConvert) throws IOException {
        InvoiceEventTypeEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static InvoiceEventTypeEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of InvoiceEventTypeEnum values to list of string values.
     * @param toConvert The list of InvoiceEventTypeEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<InvoiceEventTypeEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (InvoiceEventTypeEnum enumValue : toConvert) {
