...
public class MovementLineItem {
    ...
    public String toString() {
        return "MovementLineItem [" + "productId=" + productId + ", componentId=" + componentId
                + ", name=" + name + ", mrr=" + mrr + ", mrrMovements=" + mrrMovements
                + ", quantity=" + quantity + ", prevQuantity=" + prevQuantity + ", recurring="
                + recurring + "]";
    }
    ...
    public static class Builder {
        ...
        public MovementLineItem build() {
            return new MovementLineItem(productId, componentId, name, mrr, mrrMovements, quantity,
                    prevQuantity, recurring);
        }
    }
}
