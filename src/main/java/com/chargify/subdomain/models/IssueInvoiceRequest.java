...
public class IssueInvoiceRequest {
    private FailedPaymentActionEnum onFailedPayment;
     ...
     * @param  onFailedPayment  FailedPaymentActionEnum value for onFailedPayment.
     */
    public IssueInvoiceRequest(
            FailedPaymentActionEnum onFailedPayment) {
     ...
     * @return Returns the FailedPaymentActionEnum
     */
    @JsonGetter("on_failed_payment")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public FailedPaymentActionEnum getOnFailedPayment() {
     ...
     * applies); payment failure recorded in the invoice history; subscription will most likely go
     * into "past_due" or "canceled" state (depending upon net terms and dunning settings).
     * @param onFailedPayment Value for FailedPaymentActionEnum
     */
    @JsonSetter("on_failed_payment")
    public void setOnFailedPayment(FailedPaymentActionEnum onFailedPayment) {
        this.onFailedPayment = onFailedPayment;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder onFailedPayment(FailedPaymentActionEnum onFailedPayment) {
            this.onFailedPayment = onFailedPayment;
            return this;
        }
