...
import com.chargify.subdomain.models.containers.MeteredComponentPricingScheme;
import com.chargify.subdomain.models.containers.MeteredComponentUnitPrice;
...
public class MeteredComponent {
    ...
    private List<CreateComponentPrice> prices;
     ...
     * @param  prices  List of CreateComponentPrice value for prices.
    ...
    public MeteredComponent(
            ...
            String handle,
            Boolean taxable,
            List<CreateComponentPrice> prices,
     ...
     * @return Returns the List of CreateComponentPrice
     */
    @JsonGetter("prices")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public List<CreateComponentPrice> getPrices() {
        return prices;
    }
     ...
     * Rules](https://maxio-chargify.zendesk.com/hc/en-us/articles/5405020625677#price-bracket-rules)
     * for an overview of how price brackets work for different pricing schemes.
     * @param prices Value for List of CreateComponentPrice
     */
    @JsonSetter("prices")
    public void setPrices(List<CreateComponentPrice> prices) {
        this.prices = prices;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder prices(List<CreateComponentPrice> prices) {
            this.prices = prices;
            return this;
        }
        ...
        public MeteredComponent build() {
            return new MeteredComponent(name, unitName, pricingScheme, description, handle, taxable,
                    ...
                    hideDateRangeOnInvoice, priceInCents);
        }
    }
}
