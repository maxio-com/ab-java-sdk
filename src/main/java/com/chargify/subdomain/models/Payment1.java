...
/**
 * This is a model class for Payment1 type.
 */
public class Payment1 {
    ...
    /**
     * Converts this Payment1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Payment1 [" + "id=" + id + ", amountInCents=" + amountInCents + ", success="
                + success + ", memo=" + memo + "]";
    }

    /**
     * Builds a new {@link Payment1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Payment1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Payment1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Payment1} object using the set fields.
         * @return {@link Payment1}
         */
        public Payment1 build() {
            return new Payment1(id, amountInCents, success, memo);
        }
    }
}
