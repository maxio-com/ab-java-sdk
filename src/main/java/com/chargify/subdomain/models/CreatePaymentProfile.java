...
import com.chargify.subdomain.models.containers.CreatePaymentProfileExpirationMonth;
import com.chargify.subdomain.models.containers.CreatePaymentProfileExpirationYear;
...
public class CreatePaymentProfile {
    ...
    private CreatePaymentProfileVaultEnum currentVault;
     ...
     * @param  currentVault  CreatePaymentProfileVaultEnum value for currentVault.
    ...
    public CreatePaymentProfile(
            ...
            String billingZip,
            CreatePaymentProfileVaultEnum currentVault,
            String vaultToken,
     ...
     */
    protected CreatePaymentProfile(String chargifyToken, Integer id, PaymentTypeEnum paymentType,
            String firstName, String lastName, String maskedCardNumber, String fullNumber,
            CardTypeEnum cardType, CreatePaymentProfileExpirationMonth expirationMonth,
            ...
            String billingCountry, String billingZip, CreatePaymentProfileVaultEnum currentVault,
            String vaultToken, String customerVaultToken, Integer customerId, String paypalEmail,
     ...
     * testing.
     * @return Returns the CreatePaymentProfileVaultEnum
     */
    @JsonGetter("current_vault")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public CreatePaymentProfileVaultEnum getCurrentVault() {
        return currentVault;
    }
     ...
     * The vault that stores the payment profile with the provided `vault_token`. Use `bogus` for
     * testing.
     * @param currentVault Value for CreatePaymentProfileVaultEnum
     */
    @JsonSetter("current_vault")
    public void setCurrentVault(CreatePaymentProfileVaultEnum currentVault) {
        this.currentVault = currentVault;
    }
    ...
    public static class Builder {
        private String chargifyToken;
        private Integer id;
        private PaymentTypeEnum paymentType = PaymentTypeEnum.CREDIT_CARD;
        private String firstName;
        private String lastName;
        private String maskedCardNumber;
        private String fullNumber;
         ...
         * @return Builder
         */
        public Builder currentVault(CreatePaymentProfileVaultEnum currentVault) {
            this.currentVault = currentVault;
            return this;
        }
        ...
        public CreatePaymentProfile build() {
            return new CreatePaymentProfile(chargifyToken, id, paymentType, firstName, lastName,
                    ...
                    bankRoutingNumber, bankAccountNumber, bankBranchCode);
        }
    }
}
