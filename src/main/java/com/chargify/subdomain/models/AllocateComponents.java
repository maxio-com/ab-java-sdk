...
public class AllocateComponents {
    ...
    private LegacyPaymentCollectionMethodEnum paymentCollectionMethod;
     ...
     * @param  paymentCollectionMethod  LegacyPaymentCollectionMethodEnum value for
    ...
    public AllocateComponents(
            ...
            LegacyPaymentCollectionMethodEnum paymentCollectionMethod) {
     ...
     * subscription
     * @return Returns the LegacyPaymentCollectionMethodEnum
     */
    @JsonGetter("payment_collection_method")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public LegacyPaymentCollectionMethodEnum getPaymentCollectionMethod() {
     ...
     * (Optional) If not passed, the allocation(s) will use the payment collection method on the
     * subscription
     * @param paymentCollectionMethod Value for LegacyPaymentCollectionMethodEnum
     */
    @JsonSetter("payment_collection_method")
    public void setPaymentCollectionMethod(LegacyPaymentCollectionMethodEnum paymentCollectionMethod) {
        this.paymentCollectionMethod = paymentCollectionMethod;
    }
