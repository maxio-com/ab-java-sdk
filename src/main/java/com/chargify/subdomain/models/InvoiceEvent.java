...
import com.chargify.subdomain.models.containers.InvoiceEventEventData;
...
public class InvoiceEvent {
    private Integer id;
    private InvoiceEventTypeEnum eventType;
     ...
     * @param  eventType  InvoiceEventTypeEnum value for eventType.
     ...
     * Invoice Event Type
     * @return Returns the InvoiceEventTypeEnum
     */
     ...
     * Invoice Event Type
     * @param eventType Value for InvoiceEventTypeEnum
     */
    @JsonSetter("event_type")
    public void setEventType(InvoiceEventTypeEnum eventType) {
        this.eventType = eventType;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder eventType(InvoiceEventTypeEnum eventType) {
            this.eventType = eventType;
            return this;
        }
