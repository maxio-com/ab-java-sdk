...
public class UpdateComponent {
    ...
    private CreditTypeEnum upgradeCharge;
     ...
     * @param  upgradeCharge  CreditTypeEnum value for upgradeCharge.
     */
    public UpdateComponent(
            String handle,
            String name,
    ...
    protected UpdateComponent(String handle, String name, OptionalNullable<String> description,
            ...
            ItemCategoryEnum itemCategory, Boolean displayOnHostedPage,
            CreditTypeEnum upgradeCharge) {
        this.handle = handle;
        this.name = name;
     ...
     * `full`, `none`.
     * @return Returns the CreditTypeEnum
     */
    @JsonGetter("upgrade_charge")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public CreditTypeEnum getUpgradeCharge() {
     ...
     * The type of charge to be applied when a component is upgraded. Valid values are: `prorated`,
     * `full`, `none`.
     * @param upgradeCharge Value for CreditTypeEnum
     */
    @JsonSetter("upgrade_charge")
    public void setUpgradeCharge(CreditTypeEnum upgradeCharge) {
        this.upgradeCharge = upgradeCharge;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder upgradeCharge(CreditTypeEnum upgradeCharge) {
            this.upgradeCharge = upgradeCharge;
            return this;
        }
