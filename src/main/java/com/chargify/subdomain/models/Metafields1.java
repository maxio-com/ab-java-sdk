...
public class Metafields1 {
    ...
    private MetafieldInputEnum inputType;
     ...
     */
    public Metafields1() {
        inputType = MetafieldInputEnum.TEXT;
    }
     ...
     * @param  inputType  MetafieldInputEnum value for inputType.
     ...
     * @return Returns the MetafieldInputEnum
     */
    @JsonGetter("input_type")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public MetafieldInputEnum getInputType() {
        return inputType;
    }
     ...
     * dropdown and radio have a set of allowed values that can be input, and appear differently on
     * a Public Signup Page.
     * @param inputType Value for MetafieldInputEnum
     */
    @JsonSetter("input_type")
    public void setInputType(MetafieldInputEnum inputType) {
        this.inputType = inputType;
    }
    ...
    public static class Builder {
        ...
        private String name;
        private MetafieldScope scope;
        private MetafieldInputEnum inputType = MetafieldInputEnum.TEXT;
        private List<String> mEnum;
         ...
         * @return Builder
         */
        public Builder inputType(MetafieldInputEnum inputType) {
            this.inputType = inputType;
            return this;
        }
