...
public class ListSubscriptionsInput {
    ...
    private SubscriptionDateFieldEnum dateField;
    ...
    private SubscriptionSortEnum sort;
     ...
     * @param  state  SubscriptionStateEnum value for state.
     ...
     * @param  dateField  SubscriptionDateFieldEnum value for dateField.
     ...
     * @param  sort  SubscriptionSortEnum value for sort.
     */
    public ListSubscriptionsInput(
            Integer page,
            Integer perPage,
            ...
            Integer coupon,
            SubscriptionDateFieldEnum dateField,
            LocalDate startDate,
            LocalDate endDate,
     ...
     * @return Returns the SubscriptionStateEnum
     */
    @JsonGetter("state")
    @JsonInclude(JsonInclude.Include.NON_NULL)
     ...
     * Setter for State.
     * The current state of the subscription
     * @param state Value for SubscriptionStateEnum
     */
    @JsonSetter("state")
    public void setState(SubscriptionStateEnum state) {
        this.state = state;
    }
     ...
     * @return Returns the SubscriptionDateFieldEnum
     */
    @JsonGetter("date_field")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public SubscriptionDateFieldEnum getDateField() {
        return dateField;
    }
     ...
     * current_period_ends_at, current_period_starts_at, created_at, activated_at, canceled_at,
     * expires_at, trial_started_at, trial_ended_at, updated_at
     * @param dateField Value for SubscriptionDateFieldEnum
     */
    @JsonSetter("date_field")
    public void setDateField(SubscriptionDateFieldEnum dateField) {
        this.dateField = dateField;
    }
     ...
     * @return Returns the SubscriptionSortEnum
     */
    @JsonGetter("sort")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public SubscriptionSortEnum getSort() {
        return sort;
    }
     ...
     * Setter for Sort.
     * The attribute by which to sort
     * @param sort Value for SubscriptionSortEnum
     */
    @JsonSetter("sort")
    public void setSort(SubscriptionSortEnum sort) {
        this.sort = sort;
    }
    ...
    public static class Builder {
        ...
        private Map<String, String> metadata;
        private ListSubscriptionsInputDirection direction;
        private SubscriptionSortEnum sort = SubscriptionSortEnum.SIGNUP_DATE;
         ...
         * @return Builder
         */
        public Builder state(SubscriptionStateEnum state) {
            this.state = state;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder dateField(SubscriptionDateFieldEnum dateField) {
            this.dateField = dateField;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder sort(SubscriptionSortEnum sort) {
            this.sort = sort;
            return this;
        }
