...
/**
 * CardType1Enum to be used.
 */
public enum CardType1Enum {
    VISA,
    ...
    private static TreeMap<String, CardType1Enum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static CardType1Enum constructFromString(String toConvert) throws IOException {
        CardType1Enum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static CardType1Enum fromString(String toConvert) {
    ...
    /**
     * Convert list of CardType1Enum values to list of string values.
     * @param toConvert The list of CardType1Enum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<CardType1Enum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (CardType1Enum enumValue : toConvert) {
