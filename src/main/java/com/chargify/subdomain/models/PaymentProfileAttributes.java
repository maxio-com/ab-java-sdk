...
import com.chargify.subdomain.models.containers.PaymentProfileAttributesExpirationMonth;
import com.chargify.subdomain.models.containers.PaymentProfileAttributesExpirationYear;
...
public class PaymentProfileAttributes {
    ...
    private CurrentVaultEnum currentVault;
     ...
     * @param  currentVault  CurrentVaultEnum value for currentVault.
    ...
    protected PaymentProfileAttributes(String chargifyToken, Integer id, String paymentType,
            ...
            CardTypeEnum cardType, PaymentProfileAttributesExpirationMonth expirationMonth,
            ...
            String billingCountry, String billingZip, CurrentVaultEnum currentVault,
     ...
     * the provided vault_token. see additional notes on Braintree Blue
     * @return Returns the CurrentVaultEnum
     */
    @JsonGetter("current_vault")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public CurrentVaultEnum getCurrentVault() {
        return currentVault;
    }
     ...
     * (Optional, used only for Subscription Import) The vault that stores the payment profile with
     * the provided vault_token. see additional notes on Braintree Blue
     * @param currentVault Value for CurrentVaultEnum
     */
    @JsonSetter("current_vault")
    public void setCurrentVault(CurrentVaultEnum currentVault) {
        this.currentVault = currentVault;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder currentVault(CurrentVaultEnum currentVault) {
            this.currentVault = currentVault;
            return this;
        }
