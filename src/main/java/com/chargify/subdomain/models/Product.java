...
import com.chargify.subdomain.models.containers.ProductExpirationIntervalUnit;
import com.chargify.subdomain.models.containers.ProductIntervalUnit;
import com.chargify.subdomain.models.containers.ProductTrialIntervalUnit;
...
public class Product {
    ...
    protected Product(Integer id, String name, OptionalNullable<String> handle, String description,
            ...
            OptionalNullable<Boolean> useSiteExchangeRate,
            OptionalNullable<String> itemCategory) {
        this.id = id;
        this.name = name;
        this.handle = handle;
        this.description = description;
