...
public enum DiscountTypeEnum {
    ...
    private static TreeMap<String, DiscountTypeEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static DiscountTypeEnum constructFromString(String toConvert) throws IOException {
        DiscountTypeEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
