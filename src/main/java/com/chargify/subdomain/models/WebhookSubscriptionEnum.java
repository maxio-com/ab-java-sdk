...
/**
 * WebhookSubscriptionEnum to be used.
 */
public enum WebhookSubscriptionEnum {
    BILLING_DATE_CHANGE,
    ...
    private static TreeMap<String, WebhookSubscriptionEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static WebhookSubscriptionEnum constructFromString(String toConvert) throws IOException {
        WebhookSubscriptionEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static WebhookSubscriptionEnum fromString(String toConvert) {
    ...
    /**
     * Convert list of WebhookSubscriptionEnum values to list of string values.
     * @param toConvert The list of WebhookSubscriptionEnum values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<WebhookSubscriptionEnum> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (WebhookSubscriptionEnum enumValue : toConvert) {
