...
public class ComponentPricePoint {
    private Integer id;
    private PricePointTypeEnum type;
     ...
     * @param  type  PricePointTypeEnum value for type.
     ...
     */
    protected ComponentPricePoint(Integer id, PricePointTypeEnum type, Boolean mDefault,
            String name, String pricingScheme, Integer componentId, String handle,
     ...
     * @return Returns the PricePointTypeEnum
     */
    @JsonGetter("type")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public PricePointTypeEnum getType() {
        return type;
    }
     ...
     * **catalog**: a price point that is **not** marked as a default price for a certain product
     * and is **not** a custom one.
     * @param type Value for PricePointTypeEnum
     */
    @JsonSetter("type")
    public void setType(PricePointTypeEnum type) {
        this.type = type;
    }
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder type(PricePointTypeEnum type) {
            this.type = type;
            return this;
        }
