...
import com.chargify.subdomain.models.containers.CreateSubscriptionComponents;
import com.chargify.subdomain.models.containers.CreateSubscriptionGroup;
import com.chargify.subdomain.models.containers.CreateSubscriptionOfferId;
...
public class CreateSubscription {
    ...
    private PaymentCollectionMethodForSubscriptionEnum paymentCollectionMethod;
     ...
     * @param  paymentCollectionMethod  PaymentCollectionMethodForSubscriptionEnum value for
    ...
    public CreateSubscription(
            ...
            PaymentCollectionMethodForSubscriptionEnum paymentCollectionMethod,
     ...
     * @return Returns the PaymentCollectionMethodForSubscriptionEnum
     */
    @JsonGetter("payment_collection_method")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public PaymentCollectionMethodForSubscriptionEnum getPaymentCollectionMethod() {
     ...
     * Architecture valid options are - `invoice`, `automatic`. For current Relationship Invoicing
     * Architecture valid options are - `remittance`, `automatic`, `prepaid`.
     * @param paymentCollectionMethod Value for PaymentCollectionMethodForSubscriptionEnum
     */
    @JsonSetter("payment_collection_method")
    public void setPaymentCollectionMethod(PaymentCollectionMethodForSubscriptionEnum paymentCollectionMethod) {
        this.paymentCollectionMethod = paymentCollectionMethod;
    }
    ...
    public String toString() {
        return "CreateSubscription [" + "productHandle=" + productHandle + ", productId="
                ...
                + paymentProfileAttributes + ", bankAccountAttributes=" + bankAccountAttributes
                + ", components=" + components + ", calendarBilling=" + calendarBilling
                + ", metafields=" + metafields + ", customerReference=" + customerReference
                + ", group=" + group + ", ref=" + ref + ", cancellationMessage="
                ...
                + ", offerId=" + offerId + ", prepaidSubscriptionConfiguration="
                + prepaidSubscriptionConfiguration + ", previousBillingAt=" + previousBillingAt
                + ", importMrr=" + importMrr + ", canceledAt=" + canceledAt + ", activatedAt="
                + activatedAt + ", agreementAcceptance=" + agreementAcceptance + ", achAgreement="
                + achAgreement + ", dunningCommunicationDelayEnabled="
    ...
    public static class Builder {
        ...
        public CreateSubscription build() {
            return new CreateSubscription(productHandle, productId, productPricePointHandle,
                    ...
                    productChangeDelayed, offerId, prepaidSubscriptionConfiguration,
                    previousBillingAt, importMrr, canceledAt, activatedAt, agreementAcceptance,
                    achAgreement, dunningCommunicationDelayEnabled,
                    dunningCommunicationDelayTimeZone, skipBillingManifestTaxes);
        }
    }
