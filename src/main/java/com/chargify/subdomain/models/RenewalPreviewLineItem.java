...
public class RenewalPreviewLineItem {
    ...
    public String toString() {
        return "RenewalPreviewLineItem [" + "transactionType=" + transactionType + ", kind=" + kind
                ...
                + ", productId=" + productId + ", componentId=" + componentId + ", componentHandle="
                + componentHandle + ", componentName=" + componentName + ", productHandle="
                + productHandle + "]";
    }
    ...
    public static class Builder {
        ...
        public RenewalPreviewLineItem build() {
            return new RenewalPreviewLineItem(transactionType, kind, amountInCents, memo,
                    discountAmountInCents, taxableAmountInCents, productId, componentId,
                    componentHandle, componentName, productHandle);
        }
    }
}
