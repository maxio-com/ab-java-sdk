...
public class CreatePrepayment {
    ...
    private String memo;
    private PrepaymentMethodEnum method;
     ...
     * @param  method  PrepaymentMethodEnum value for method.
     ...
     * @return Returns the PrepaymentMethodEnum
     */
    @JsonGetter("method")
    public PrepaymentMethodEnum getMethod() {
        return method;
    }
     ...
     * collected using the default credit card payment profile and applied to the prepayment account
     * balance. This is especially useful for manual replenishment of prepaid subscriptions.
     * @param method Value for PrepaymentMethodEnum
     */
    @JsonSetter("method")
    public void setMethod(PrepaymentMethodEnum method) {
        this.method = method;
    }
    ...
    public static class Builder {
         ...
         * @param  method  PrepaymentMethodEnum value for method.
         */
        public Builder(double amount, String details, String memo, PrepaymentMethodEnum method) {
            this.amount = amount;
            this.details = details;
            this.memo = memo;
            this.method = method;
         ...
         * @return Builder
         */
        public Builder method(PrepaymentMethodEnum method) {
            this.method = method;
            return this;
        }
