...
public abstract class SubscriptionComponentPricePointType {
    ...
    public interface Cases<R> {
        R pricePointType(PricePointTypeEnum pricePointType);
    }
    ...
    @TypeCombinatorCase(type = "PricePointTypeEnum")
    private static class PricePointTypeCase extends SubscriptionComponentPricePointType {

        @JsonValue
        private PricePointTypeEnum pricePointType;

        PricePointTypeCase(PricePointTypeEnum pricePointType) {
        ...
        private PricePointTypeCase(JsonNode jsonNode) throws IOException {
            this.pricePointType = 
                PricePointTypeEnum.fromString(ApiHelper.deserialize(jsonNode, String.class));
