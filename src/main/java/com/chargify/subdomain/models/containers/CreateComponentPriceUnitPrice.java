 ...
 */
@JsonDeserialize(using = CreateComponentPriceUnitPrice.CreateComponentPriceUnitPriceDeserializer.class)
public abstract class CreateComponentPriceUnitPrice {
     ...
     */
    public static CreateComponentPriceUnitPrice fromMString(String mString) {
     ...
     */
    public static CreateComponentPriceUnitPrice fromPrecision(double precision) {
    ...
    private static class MStringCase extends CreateComponentPriceUnitPrice {
    ...
    private static class PrecisionCase extends CreateComponentPriceUnitPrice {
    ...
    /**
     * This is a custom deserializer class for CreateComponentPriceUnitPrice.
     */
    protected static class CreateComponentPriceUnitPriceDeserializer
            extends JsonDeserializer<CreateComponentPriceUnitPrice> {

        @Override
        public CreateComponentPriceUnitPrice deserialize(JsonParser jp, DeserializationContext ctxt)
