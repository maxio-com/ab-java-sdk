 ...
 */
@JsonDeserialize(using = CreateAllocationQuantity.CreateAllocationQuantityDeserializer.class)
public abstract class CreateAllocationQuantity {
     ...
     */
    public static CreateAllocationQuantity fromNumber(int number) {
     ...
     */
    public static CreateAllocationQuantity fromPrecision(double precision) {
    ...
    private static class NumberCase extends CreateAllocationQuantity {
    ...
    private static class PrecisionCase extends CreateAllocationQuantity {
    ...
    /**
     * This is a custom deserializer class for CreateAllocationQuantity.
     */
    protected static class CreateAllocationQuantityDeserializer
            extends JsonDeserializer<CreateAllocationQuantity> {

        @Override
        public CreateAllocationQuantity deserialize(JsonParser jp, DeserializationContext ctxt)
