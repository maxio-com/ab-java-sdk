...
import com.chargify.subdomain.models.ExtendedIntervalUnitEnum;
...
public abstract class ProductExpirationIntervalUnitCase0 {
     ...
     * @param extendedIntervalUnit ExtendedIntervalUnitEnum value for extendedIntervalUnit.
     * @return The ExtendedIntervalUnitCase object.
     */
    public static ProductExpirationIntervalUnitCase0 fromExtendedIntervalUnit(
            ExtendedIntervalUnitEnum extendedIntervalUnit) {
    ...
    public interface Cases<R> {
        R extendedIntervalUnit(ExtendedIntervalUnitEnum extendedIntervalUnit);
    }
    ...
    @TypeCombinatorCase(type = "ExtendedIntervalUnitEnum")
    private static class ExtendedIntervalUnitCase extends ProductExpirationIntervalUnitCase0 {

        @JsonValue
        private ExtendedIntervalUnitEnum extendedIntervalUnit;

        ExtendedIntervalUnitCase(ExtendedIntervalUnitEnum extendedIntervalUnit) {
        ...
        private ExtendedIntervalUnitCase(JsonNode jsonNode) throws IOException {
            this.extendedIntervalUnit = 
                ExtendedIntervalUnitEnum.fromString(ApiHelper.deserialize(jsonNode, String.class));
