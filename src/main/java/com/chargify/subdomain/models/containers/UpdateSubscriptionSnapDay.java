...
import com.chargify.subdomain.models.SnapDayEnum;
...
public abstract class UpdateSubscriptionSnapDay {
     ...
     * @param snapDay SnapDayEnum value for snapDay.
     * @return The SnapDayCase object.
     */
    public static UpdateSubscriptionSnapDay fromSnapDay(SnapDayEnum snapDay) {
    ...
    @TypeCombinatorCase(type = "SnapDayEnum")
    private static class SnapDayCase extends UpdateSubscriptionSnapDay {

        @JsonValue
        private SnapDayEnum snapDay;

        SnapDayCase(SnapDayEnum snapDay) {
        ...
        private SnapDayCase(JsonNode jsonNode) throws IOException {
            this.snapDay = 
                SnapDayEnum.fromString(ApiHelper.deserialize(jsonNode, String.class));
