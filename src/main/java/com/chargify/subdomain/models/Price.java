...
import com.chargify.subdomain.models.containers.PriceEndingQuantity;
import com.chargify.subdomain.models.containers.PriceStartingQuantity;
import com.chargify.subdomain.models.containers.PriceUnitPrice;
...
public class Price {
    ...
    @JsonCreator
    protected Price(
            @JsonProperty("starting_quantity") PriceStartingQuantity startingQuantity,
            @JsonProperty("unit_price") PriceUnitPrice unitPrice) {
        this(startingQuantity, unitPrice, OptionalNullable.of(null));
        unsetEndingQuantity();
    }
