...
public class BankAccountPaymentProfile {
     ...
     */
    protected BankAccountPaymentProfile(Integer id, String firstName, String lastName,
    ...
    public String toString() {
        return "BankAccountPaymentProfile [" + "id=" + id + ", firstName=" + firstName
    ...
    public static class Builder {
        ...
        public BankAccountPaymentProfile build() {
            return new BankAccountPaymentProfile(id, firstName, lastName, customerId, currentVault,
                    ...
                    bankAccountHolderType, paymentType, verified, siteGatewaySettingId,
                    gatewayHandle);
        }
    }
}
