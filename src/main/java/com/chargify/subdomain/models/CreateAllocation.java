...
import com.chargify.subdomain.models.containers.CreateAllocationPricePointId;
import com.chargify.subdomain.models.containers.CreateAllocationQuantity;
...
public class CreateAllocation {
    private CreateAllocationQuantity quantity;
    private Integer componentId;
    private String memo;
    private String prorationDowngradeScheme;
    private String prorationUpgradeScheme;
    private Boolean accrueCharge;
    private CreditType1Enum downgradeCredit;
    private CreditType1Enum upgradeCharge;
     ...
     * @param  quantity  CreateAllocationQuantity value for quantity.
     ...
     * @param  downgradeCredit  CreditType1Enum value for downgradeCredit.
     * @param  upgradeCharge  CreditType1Enum value for upgradeCharge.
     * @param  pricePointId  CreateAllocationPricePointId value for pricePointId.
     */
    public CreateAllocation(
            CreateAllocationQuantity quantity,
            Integer componentId,
            String memo,
            String prorationDowngradeScheme,
            String prorationUpgradeScheme,
            Boolean accrueCharge,
            CreditType1Enum downgradeCredit,
            CreditType1Enum upgradeCharge,
     ...
     */
    protected CreateAllocation(CreateAllocationQuantity quantity, Integer componentId, String memo,
            String prorationDowngradeScheme, String prorationUpgradeScheme, Boolean accrueCharge,
            CreditType1Enum downgradeCredit, CreditType1Enum upgradeCharge,
     ...
     * @return Returns the CreateAllocationQuantity
     */
    @JsonGetter("quantity")
    public CreateAllocationQuantity getQuantity() {
        return quantity;
    }
     ...
     * an integer. If decimal allocations are enabled for the component, it will be a decimal
     * number. For On/Off components, use 1for on and 0 for off.
     * @param quantity Value for CreateAllocationQuantity
     */
    @JsonSetter("quantity")
    public void setQuantity(CreateAllocationQuantity quantity) {
        this.quantity = quantity;
    }
     ...
     * @return Returns the CreditType1Enum
     */
    @JsonGetter("downgrade_credit")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public CreditType1Enum getDowngradeCredit() {
     ...
     * The type of credit to be created if the change in cost is a downgrade. Defaults to the
     * component and then site setting if one is not provided.
     * @param downgradeCredit Value for CreditType1Enum
     */
    @JsonSetter("downgrade_credit")
    public void setDowngradeCredit(CreditType1Enum downgradeCredit) {
        this.downgradeCredit = downgradeCredit;
    }
    ...
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public CreditType1Enum getUpgradeCharge() {
     ...
     * The type of charge to be created if the change in cost is an upgrade. Defaults to the
     * component and then site setting if one is not provided.
     * @param upgradeCharge Value for CreditType1Enum
     */
    @JsonSetter("upgrade_charge")
    public void setUpgradeCharge(CreditType1Enum upgradeCharge) {
        this.upgradeCharge = upgradeCharge;
    }
    ...
    public static class Builder {
         ...
         * @param  quantity  CreateAllocationQuantity value for quantity.
         */
        public Builder(CreateAllocationQuantity quantity) {
            this.quantity = quantity;
        }
         ...
         * @return Builder
         */
        public Builder quantity(CreateAllocationQuantity quantity) {
            this.quantity = quantity;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder downgradeCredit(CreditType1Enum downgradeCredit) {
            this.downgradeCredit = downgradeCredit;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder upgradeCharge(CreditType1Enum upgradeCharge) {
            this.upgradeCharge = upgradeCharge;
            return this;
        }
