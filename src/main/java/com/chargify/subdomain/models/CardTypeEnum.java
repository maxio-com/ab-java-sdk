...
public enum CardTypeEnum {
    ...
    private static TreeMap<String, CardTypeEnum> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static CardTypeEnum constructFromString(String toConvert) throws IOException {
        CardTypeEnum enumValue = fromString(toConvert);
        if (enumValue == null)
        {
