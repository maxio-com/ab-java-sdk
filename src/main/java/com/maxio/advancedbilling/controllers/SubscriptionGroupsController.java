...
public final class SubscriptionGroupsController extends BaseController {
     ...
     * attribute set. When passing a product to a subscription you can use either `product_id` or
    ...
    /**
     * Returns subscription group details. #### Current Billing Amount in Cents Current billing
     * amount for the subscription group is not returned by default. If this information is desired,
    ...
    /**
     * Updates subscription group members. `"member_ids"` should contain an array of both
     * subscription IDs to set as group members and subscription IDs already present in the groups.
     * Not including them will result in removing them from the subscription group. To clean up
     * members, just leave the array empty.
     * @param  uid  Required parameter: The uid of the subscription group
     * @param  body  Optional parameter:
     * @return    Returns the SubscriptionGroupResponse response from the API call
     * @throws    ApiException    Represents error response from the server.
