...
public final class CustomersController extends BaseController {
     ...
     * restriction is that you may only create one customer for a given reference value. If
     ...
     * customer via a piece of shared information. Alternatively, you may choose to leave
     * `reference` blank, and store Advanced Billing’s unique ID for the customer, which is in the
     * `id` attribute. Full documentation on how to locate, create and edit Customers in the
