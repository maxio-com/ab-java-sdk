...
public final class InvoicesController extends BaseController {
     ...
     * `amount`) details. ``` { "payment": { "memo": "to pay the bills", "details": "check number
     * 8675309", "method": "check", "amount": "250.00", "applications": [ { "invoice_uid":
     * "inv_8gk5bwkct3gqt", "amount": "100.00" }, { "invoice_uid": "inv_7bc6bwkct3lyt", "amount":
     * "150.00" } ] } } ``` Note that the invoice payment amounts must be greater than 0. Total
