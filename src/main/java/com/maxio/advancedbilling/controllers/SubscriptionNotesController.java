...
public final class SubscriptionNotesController extends BaseController {
    ...
    /**
     * Creates a note for a subscription. Notes allow you to record information about a particular
     * Subscription in a free text format. If you have structured data such as birth date, color,
     * etc., consider using [Metadata]($e/Custom%20Fields/createMetadata) instead. For more
