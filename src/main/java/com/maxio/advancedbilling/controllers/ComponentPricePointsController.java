...
public final class ComponentPricePointsController extends BaseController {
    ...
    /**
     * Lists the price points associated with a component. You may specify the component by using
     * either the numeric id or the `handle:gold` syntax. When fetching a component's price points,
     * if you have defined multiple currencies at the site level, you can optionally pass the
     * `?currency_prices=true` query param to include an array of currency price data in the
     * response. If the price point is set to `use_site_exchange_rate: true`, it will return pricing
    ...
    /**
     * Updates a component price point and its associated prices. Passing in a price bracket without
     * an `id` will attempt to create a new price. Including an `id` will update the corresponding
     * price, and including the `_destroy` flag set to true along with the `id` will remove that
     * price. Note: Custom price points cannot be updated directly. They must be edited through the
     * Subscription.
     * @param  componentId  Required parameter: The id or handle of the component. When using the
     *         handle, it must be prefixed with `handle:`. Example: `123` for an integer ID, or
     *         `handle:example-product-handle` for a string handle.
    ...
    /**
     * Returns details for a specific component price point. You can achieve this by using either
     * the component price point ID or handle.
     * @param  componentId  Required parameter: The id or handle of the component. When using the
     *         handle, it must be prefixed with `handle:`. Example: `123` for an integer ID, or
     *         `handle:example-product-handle` for a string handle.
     * @param  pricePointId  Required parameter: The id or handle of the price point. When using the
    ...
    /**
     * Archives a component price point. Subscriptions using a price point that has been archived
    ...
    /**
     * Creates currency prices for a given currency defined at the site level. When creating
     * currency prices, they need to mirror the structure of your primary pricing. For each price
     * level defined on the component price point, there should be a matching price level created in
     * the given currency. Note: Currency Prices are not able to be created for custom price points.
     * @param  pricePointId  Required parameter: The Advanced Billing id of the price point
     * @param  body  Optional parameter:
    ...
    /**
     * Updates currency prices for a given currency defined at the site level. Note: Currency Prices
     * are not able to be updated for custom price points.
     * @param  pricePointId  Required parameter: The Advanced Billing id of the price point
     * @param  body  Optional parameter:
     * @return    Returns the ComponentCurrencyPricesResponse response from the API call
     * @throws    ApiException    Represents error response from the server.
