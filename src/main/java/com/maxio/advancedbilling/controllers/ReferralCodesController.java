...
public final class ReferralCodesController extends BaseController {
     ...
     * useful for validating referral codes that are entered by a customer. ## Referrals
     * Documentation Full documentation on how to use the referrals feature in the Advanced Billing
     * UI can be located
