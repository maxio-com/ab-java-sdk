...
/**
 * This is a model class for MetafieldsUpdateMetafieldsRequest type.
 */
public class MetafieldsUpdateMetafieldsRequest {
     ...
     * Default constructor.
     */
    public MetafieldsUpdateMetafieldsRequest() {
    ...
    /**
     * Converts this MetafieldsUpdateMetafieldsRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "MetafieldsUpdateMetafieldsRequest [" + "currentName=" + currentName + ", name="
                + name + ", scope=" + scope + ", inputType=" + inputType + ", mEnum=" + mEnum + "]";
    }

    /**
     * Builds a new {@link MetafieldsUpdateMetafieldsRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link MetafieldsUpdateMetafieldsRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link MetafieldsUpdateMetafieldsRequest}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link MetafieldsUpdateMetafieldsRequest} object using the set fields.
         * @return {@link MetafieldsUpdateMetafieldsRequest}
         */
        public MetafieldsUpdateMetafieldsRequest build() {
            return new MetafieldsUpdateMetafieldsRequest(currentName, name, scope, inputType,
                    mEnum);
        }
    }
}
