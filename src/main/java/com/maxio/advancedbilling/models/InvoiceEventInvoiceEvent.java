...
import com.maxio.advancedbilling.models.containers.InvoiceEventInvoiceEventPaymentMethod;
import java.time.LocalDateTime;
import java.util.List;

/**
 * This is a model class for InvoiceEventInvoiceEvent type.
 */
public class InvoiceEventInvoiceEvent {
    private String uid;
    ...
    private InvoiceEventInvoiceEventPaymentMethod paymentMethod;
    ...
    private CreditNoteInvoiceEvent creditNoteAttributes;
     ...
     * Default constructor.
     */
    public InvoiceEventInvoiceEvent() {
    }
     ...
     * @param  paymentMethod  InvoiceEventInvoiceEventPaymentMethod value for paymentMethod.
     ...
     * @param  creditNoteAttributes  CreditNoteInvoiceEvent value for creditNoteAttributes.
    ...
    public InvoiceEventInvoiceEvent(
            ...
            String debitNoteUid,
            InvoiceEventInvoiceEventPaymentMethod paymentMethod,
            ...
            String totalAmount,
            Boolean applyCredit,
            CreditNoteInvoiceEvent creditNoteAttributes,
            Integer paymentId,
            String refundAmount,
            Integer refundId,
            Boolean prepayment,
     ...
     * @return Returns the InvoiceEventInvoiceEventPaymentMethod
     */
    @JsonGetter("payment_method")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public InvoiceEventInvoiceEventPaymentMethod getPaymentMethod() {
     ...
     * A nested data structure detailing the method of payment
     * @param paymentMethod Value for InvoiceEventInvoiceEventPaymentMethod
     */
    @JsonSetter("payment_method")
    public void setPaymentMethod(InvoiceEventInvoiceEventPaymentMethod paymentMethod) {
        this.paymentMethod = paymentMethod;
    }
     ...
     * @return Returns the CreditNoteInvoiceEvent
     */
    @JsonGetter("credit_note_attributes")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public CreditNoteInvoiceEvent getCreditNoteAttributes() {
        return creditNoteAttributes;
    }

    /**
     * Setter for CreditNoteAttributes.
     * @param creditNoteAttributes Value for CreditNoteInvoiceEvent
     */
    @JsonSetter("credit_note_attributes")
    public void setCreditNoteAttributes(CreditNoteInvoiceEvent creditNoteAttributes) {
        this.creditNoteAttributes = creditNoteAttributes;
    }
    ...
    /**
     * Converts this InvoiceEventInvoiceEvent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "InvoiceEventInvoiceEvent [" + "uid=" + uid + ", creditNoteNumber="
    ...
    /**
     * Builds a new {@link InvoiceEventInvoiceEvent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link InvoiceEventInvoiceEvent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link InvoiceEventInvoiceEvent}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder paymentMethod(InvoiceEventInvoiceEventPaymentMethod paymentMethod) {
            this.paymentMethod = paymentMethod;
            return this;
        }
         ...
         * @return Builder
         */
        public Builder creditNoteAttributes(CreditNoteInvoiceEvent creditNoteAttributes) {
            this.creditNoteAttributes = creditNoteAttributes;
            return this;
        }
        ...
        /**
         * Builds a new {@link InvoiceEventInvoiceEvent} object using the set fields.
         * @return {@link InvoiceEventInvoiceEvent}
         */
        public InvoiceEventInvoiceEvent build() {
            return new InvoiceEventInvoiceEvent(uid, creditNoteNumber, creditNoteUid,
