...
public class InvoiceAddress {
    ...
    protected InvoiceAddress(OptionalNullable<String> street, OptionalNullable<String> line2,
    ...
    /**
     * Converts this InvoiceAddress into string format.
    ...
    /**
     * Builds a new {@link InvoiceAddress.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link InvoiceAddress.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link InvoiceAddress}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link InvoiceAddress} object using the set fields.
         * @return {@link InvoiceAddress}
         */
        public InvoiceAddress build() {
            return new InvoiceAddress(street, line2, city, state, zip, country);
        }
    }
}
