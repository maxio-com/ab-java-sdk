...
/**
 * This is a model class for PrepaymentPrepaymentResponse type.
 */
public class PrepaymentPrepaymentResponse {
    private double id;
     ...
     * Default constructor.
     */
    public PrepaymentPrepaymentResponse() {
    }
    ...
    /**
     * Converts this PrepaymentPrepaymentResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PrepaymentPrepaymentResponse [" + "id=" + id + ", subscriptionId=" + subscriptionId
    ...
    /**
     * Builds a new {@link PrepaymentPrepaymentResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PrepaymentPrepaymentResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PrepaymentPrepaymentResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link PrepaymentPrepaymentResponse} object using the set fields.
         * @return {@link PrepaymentPrepaymentResponse}
         */
        public PrepaymentPrepaymentResponse build() {
            return new PrepaymentPrepaymentResponse(id, subscriptionId, amountInCents,
