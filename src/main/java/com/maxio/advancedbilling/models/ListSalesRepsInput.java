...
/**
 * This is a model class for ListSalesRepsInput type.
 */
public class ListSalesRepsInput {
    ...
    /**
     * Converts this ListSalesRepsInput into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ListSalesRepsInput [" + "sellerId=" + sellerId + ", authorization=" + authorization
                + ", liveMode=" + liveMode + ", page=" + page + ", perPage=" + perPage + "]";
    }

    /**
     * Builds a new {@link ListSalesRepsInput.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ListSalesRepsInput.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ListSalesRepsInput}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ListSalesRepsInput} object using the set fields.
         * @return {@link ListSalesRepsInput}
         */
        public ListSalesRepsInput build() {
            return new ListSalesRepsInput(sellerId, authorization, liveMode, page, perPage);
        }
    }
}
