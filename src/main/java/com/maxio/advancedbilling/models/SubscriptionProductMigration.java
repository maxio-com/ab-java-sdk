...
public class SubscriptionProductMigration {
    ...
    /**
     * Converts this SubscriptionProductMigration into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "SubscriptionProductMigration [" + "productId=" + productId
    ...
    /**
     * Builds a new {@link SubscriptionProductMigration.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link SubscriptionProductMigration.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link SubscriptionProductMigration}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link SubscriptionProductMigration} object using the set fields.
         * @return {@link SubscriptionProductMigration}
         */
        public SubscriptionProductMigration build() {
            return new SubscriptionProductMigration(productId, productPricePointId, includeTrial,
                    includeInitialCharge, includeCoupons, preservePeriod, productHandle,
                    productPricePointHandle, proration);
        }
    }
}
