...
/**
 * This is a model class for DeliverProformaInvoiceRequest type.
 */
public class DeliverProformaInvoiceRequest
        extends BaseModel {
    ...
    /**
     * Converts this DeliverProformaInvoiceRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "DeliverProformaInvoiceRequest [" + "recipientEmails=" + recipientEmails
                + ", ccRecipientEmails=" + ccRecipientEmails + ", bccRecipientEmails="
                + bccRecipientEmails + ", additionalProperties=" + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link DeliverProformaInvoiceRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link DeliverProformaInvoiceRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link DeliverProformaInvoiceRequest}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link DeliverProformaInvoiceRequest} object using the set fields.
         * @return {@link DeliverProformaInvoiceRequest}
         */
        public DeliverProformaInvoiceRequest build() {
            return new DeliverProformaInvoiceRequest(recipientEmails, ccRecipientEmails,
                    bccRecipientEmails);
        }
    }
}
