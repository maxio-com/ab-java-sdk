...
/**
 * This is a model class for CurrencyOveragePrices type.
 */
public class CurrencyOveragePrices
        extends BaseModel {
    private Integer id;
    ...
    private List<ComponentCurrencyPrice> currencyOveragePrices;
     ...
     * @param  currencyOveragePrices  List of ComponentCurrencyPrice value for
    ...
    public CurrencyOveragePrices(
            ...
            List<ComponentCurrencyPrice> currencyOveragePrices) {
        this.id = id;
        this.type = type;
    ...
    protected CurrencyOveragePrices(Integer id, PricePointType type, Boolean mDefault, String name,
    ...
    /**
     * Getter for CurrencyOveragePrices.
     * Applicable only to prepaid usage components. An array of currency pricing data for overage
     * prices.
     * @return Returns the List of ComponentCurrencyPrice
     */
    @JsonGetter("currency_overage_prices")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public List<ComponentCurrencyPrice> getCurrencyOveragePrices() {
        return currencyOveragePrices;
    }

    /**
     * Setter for CurrencyOveragePrices.
     * Applicable only to prepaid usage components. An array of currency pricing data for overage
     * prices.
     * @param currencyOveragePrices Value for List of ComponentCurrencyPrice
     */
    @JsonSetter("currency_overage_prices")
    public void setCurrencyOveragePrices(List<ComponentCurrencyPrice> currencyOveragePrices) {
        this.currencyOveragePrices = currencyOveragePrices;
    }

    /**
     * Converts this CurrencyOveragePrices into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CurrencyOveragePrices [" + "id=" + id + ", type=" + type + ", mDefault=" + mDefault
                ...
                + ", currencyOveragePrices=" + currencyOveragePrices + ", additionalProperties="
                + getAdditionalProperties() + "]";
    }

    /**
     * Builds a new {@link CurrencyOveragePrices.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CurrencyOveragePrices.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder()
                ...
                .currencyOveragePrices(getCurrencyOveragePrices());
    ...
    /**
     * Class to build instances of {@link CurrencyOveragePrices}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder currencyOveragePrices(List<ComponentCurrencyPrice> currencyOveragePrices) {
            this.currencyOveragePrices = currencyOveragePrices;
            return this;
        }

        /**
         * Builds a new {@link CurrencyOveragePrices} object using the set fields.
         * @return {@link CurrencyOveragePrices}
         */
        public CurrencyOveragePrices build() {
            return new CurrencyOveragePrices(id, type, mDefault, name, pricingScheme, componentId,
