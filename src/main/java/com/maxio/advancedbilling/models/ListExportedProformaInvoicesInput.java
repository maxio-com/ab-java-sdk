...
/**
 * This is a model class for ListExportedProformaInvoicesInput type.
 */
public class ListExportedProformaInvoicesInput {
    ...
    /**
     * Converts this ListExportedProformaInvoicesInput into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ListExportedProformaInvoicesInput [" + "batchId=" + batchId + ", perPage=" + perPage
                + ", page=" + page + "]";
    }
    ...
    /**
     * Class to build instances of {@link ListExportedProformaInvoicesInput}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ListExportedProformaInvoicesInput} object using the set fields.
         * @return {@link ListExportedProformaInvoicesInput}
         */
        public ListExportedProformaInvoicesInput build() {
            return new ListExportedProformaInvoicesInput(batchId, perPage, page);
        }
    }
}
