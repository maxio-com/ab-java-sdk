...
/**
 * This is a model class for PrepaymentPrepaymentsResponse type.
 */
public class PrepaymentPrepaymentsResponse {
    private double id;
     ...
     * Default constructor.
     */
    public PrepaymentPrepaymentsResponse() {
    }
    ...
    /**
     * Converts this PrepaymentPrepaymentsResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PrepaymentPrepaymentsResponse [" + "id=" + id + ", subscriptionId=" + subscriptionId
    ...
    /**
     * Builds a new {@link PrepaymentPrepaymentsResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PrepaymentPrepaymentsResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PrepaymentPrepaymentsResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link PrepaymentPrepaymentsResponse} object using the set fields.
         * @return {@link PrepaymentPrepaymentsResponse}
         */
        public PrepaymentPrepaymentsResponse build() {
            return new PrepaymentPrepaymentsResponse(id, subscriptionId, amountInCents,
                    remainingAmountInCents, external, memo, createdAt, refundedAmountInCents,
                    details, paymentType);
        }
    }
}
