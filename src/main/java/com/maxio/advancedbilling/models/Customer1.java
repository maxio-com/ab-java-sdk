...
public class Customer1
    ...
    protected Customer1(String firstName, String lastName, String email,
    ...
    /**
     * Converts this Customer1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Customer1 [" + "firstName=" + firstName + ", lastName=" + lastName + ", email="
    ...
    /**
     * Builds a new {@link Customer1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Customer1.Builder} object
     */
    ...
    public static class Builder {
        ...
        /**
         * Builds a new {@link Customer1} object using the set fields.
         * @return {@link Customer1}
         */
        public Customer1 build() {
            return new Customer1(firstName, lastName, email, ccEmails, organization, reference, id,
