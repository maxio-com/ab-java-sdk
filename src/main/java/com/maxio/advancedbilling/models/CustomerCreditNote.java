...
/**
 * This is a model class for CustomerCreditNote type.
 */
public class CustomerCreditNote {
     ...
     */
    protected CustomerCreditNote(Integer chargifyId, String firstName, String lastName,
    ...
    /**
     * Converts this CustomerCreditNote into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CustomerCreditNote [" + "chargifyId=" + chargifyId + ", firstName=" + firstName
                + ", lastName=" + lastName + ", organization=" + organization + ", email=" + email
                + ", vatNumber=" + vatNumber + ", reference=" + reference + "]";
    }

    /**
     * Builds a new {@link CustomerCreditNote.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CustomerCreditNote.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CustomerCreditNote}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CustomerCreditNote} object using the set fields.
         * @return {@link CustomerCreditNote}
         */
        public CustomerCreditNote build() {
            return new CustomerCreditNote(chargifyId, firstName, lastName, organization, email,
                    vatNumber, reference);
        }
    }
}
