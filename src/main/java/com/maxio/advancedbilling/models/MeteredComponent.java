...
public class MeteredComponent {
     ...
     * @return Returns the MeteredComponentUnitPrice
     */
    @JsonGetter("unit_price")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public MeteredComponentUnitPrice getUnitPrice() {
        return unitPrice;
    }
     ...
     * component on for the subscription. The price can contain up to 8 decimal places. i.e. 1.00 or
     * 0.0012 or 0.00000065
     * @param unitPrice Value for MeteredComponentUnitPrice
     */
    @JsonSetter("unit_price")
    public void setUnitPrice(MeteredComponentUnitPrice unitPrice) {
        this.unitPrice = unitPrice;
    }
    ...
    /**
     * Builds a new {@link MeteredComponent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link MeteredComponent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link MeteredComponent}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder unitPrice(MeteredComponentUnitPrice unitPrice) {
            this.unitPrice = unitPrice;
            return this;
        }
