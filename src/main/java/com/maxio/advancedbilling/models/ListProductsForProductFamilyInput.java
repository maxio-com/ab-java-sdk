...
public class ListProductsForProductFamilyInput {
    ...
    public String toString() {
        return "ListProductsForProductFamilyInput [" + "productFamilyId=" + productFamilyId
                ...
                + startDatetime + ", endDatetime=" + endDatetime + ", includeArchived="
    ...
    /**
     * Builds a new {@link ListProductsForProductFamilyInput.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ListProductsForProductFamilyInput.Builder} object
     */
