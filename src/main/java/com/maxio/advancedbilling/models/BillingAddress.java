...
public class BillingAddress {
    ...
    protected BillingAddress(OptionalNullable<String> street, OptionalNullable<String> line2,
    ...
    public String toString() {
        return "BillingAddress [" + "street=" + street + ", line2=" + line2 + ", city=" + city
    ...
    public static class Builder {
        ...
        public BillingAddress build() {
            return new BillingAddress(street, line2, city, state, zip, country);
        }
    }
}
