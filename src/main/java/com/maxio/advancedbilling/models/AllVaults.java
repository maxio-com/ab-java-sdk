...
public enum AllVaults {
     ...
     */
    @JsonCreator
    public static AllVaults constructFromString(String toConvert) throws IOException {
        AllVaults enumValue = fromString(toConvert);
        if (enumValue == null) {
     ...
     * @return The enum member against the given string value.
     */
    public static AllVaults fromString(String toConvert) {
    ...
    /**
     * Convert list of AllVaults values to list of string values.
     * @param toConvert The list of AllVaults values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<AllVaults> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (AllVaults enumValue : toConvert) {
