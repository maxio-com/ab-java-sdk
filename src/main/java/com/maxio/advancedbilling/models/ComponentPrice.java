...
/**
 * This is a model class for ComponentPrice type.
 */
public class ComponentPrice {
    ...
    /**
     * Converts this ComponentPrice into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ComponentPrice [" + "id=" + id + ", componentId=" + componentId
    ...
    /**
     * Builds a new {@link ComponentPrice.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ComponentPrice.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ComponentPrice}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ComponentPrice} object using the set fields.
         * @return {@link ComponentPrice}
         */
        public ComponentPrice build() {
            return new ComponentPrice(id, componentId, startingQuantity, endingQuantity, unitPrice,
