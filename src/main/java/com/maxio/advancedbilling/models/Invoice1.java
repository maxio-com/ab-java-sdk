...
public class Invoice1
    ...
    protected Invoice1(Long id, String uid, Integer siteId, Integer customerId,
    ...
    public String toString() {
        return "Invoice1 [" + "id=" + id + ", uid=" + uid + ", siteId=" + siteId + ", customerId="
    ...
    public static class Builder {
        ...
        public Invoice1 build() {
            return new Invoice1(id, uid, siteId, customerId, subscriptionId, number, sequenceNumber,
