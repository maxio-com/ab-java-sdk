...
/**
 * This is a model class for VoidInvoiceEventDataAnyOf8 type.
 */
public class VoidInvoiceEventDataAnyOf8 {
     ...
     * Default constructor.
     */
    public VoidInvoiceEventDataAnyOf8() {
    }
    ...
    /**
     * Converts this VoidInvoiceEventDataAnyOf8 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "VoidInvoiceEventDataAnyOf8 [" + "creditNoteAttributes=" + creditNoteAttributes
                + ", memo=" + memo + ", appliedAmount=" + appliedAmount + ", transactionTime="
                + transactionTime + "]";
    }

    /**
     * Builds a new {@link VoidInvoiceEventDataAnyOf8.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link VoidInvoiceEventDataAnyOf8.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link VoidInvoiceEventDataAnyOf8}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link VoidInvoiceEventDataAnyOf8} object using the set fields.
         * @return {@link VoidInvoiceEventDataAnyOf8}
         */
        public VoidInvoiceEventDataAnyOf8 build() {
            return new VoidInvoiceEventDataAnyOf8(creditNoteAttributes, memo, appliedAmount,
                    transactionTime);
        }
    }
}
