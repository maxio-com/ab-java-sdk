...
/**
 * This is a model class for CreditNoteInvoiceEvent type.
 */
public class CreditNoteInvoiceEvent {
    private String uid;
    ...
    private CustomerCreditNote customer;
     ...
     * @param  customer  CustomerCreditNote value for customer.
    ...
    /**
     * Getter for Customer.
     * @return Returns the CustomerCreditNote
     */
    @JsonGetter("customer")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public CustomerCreditNote getCustomer() {
        return customer;
    }

    /**
     * Setter for Customer.
     * @param customer Value for CustomerCreditNote
     */
    @JsonSetter("customer")
    public void setCustomer(CustomerCreditNote customer) {
        this.customer = customer;
    }
    ...
    /**
     * Converts this CreditNoteInvoiceEvent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CreditNoteInvoiceEvent [" + "uid=" + uid + ", siteId=" + siteId + ", customerId="
                + customerId + ", subscriptionId=" + subscriptionId + ", number=" + number
                + ", sequenceNumber=" + sequenceNumber + ", issueDate=" + issueDate
                + ", appliedDate=" + appliedDate + ", status=" + status + ", currency=" + currency
                + ", memo=" + memo + ", seller=" + seller + ", customer=" + customer
                + ", billingAddress=" + billingAddress + ", shippingAddress=" + shippingAddress
                + ", subtotalAmount=" + subtotalAmount + ", discountAmount=" + discountAmount
                + ", taxAmount=" + taxAmount + ", totalAmount=" + totalAmount + ", appliedAmount="
                + appliedAmount + ", remainingAmount=" + remainingAmount + ", lineItems="
                + lineItems + ", discounts=" + discounts + ", taxes=" + taxes + ", applications="
                + applications + ", refunds=" + refunds + ", originInvoices=" + originInvoices
                + "]";
    }

    /**
     * Builds a new {@link CreditNoteInvoiceEvent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CreditNoteInvoiceEvent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CreditNoteInvoiceEvent}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder customer(CustomerCreditNote customer) {
            this.customer = customer;
            return this;
        }
        ...
        /**
         * Builds a new {@link CreditNoteInvoiceEvent} object using the set fields.
         * @return {@link CreditNoteInvoiceEvent}
         */
        public CreditNoteInvoiceEvent build() {
            return new CreditNoteInvoiceEvent(uid, siteId, customerId, subscriptionId, number,
                    sequenceNumber, issueDate, appliedDate, status, currency, memo, seller,
                    customer, billingAddress, shippingAddress, subtotalAmount, discountAmount,
                    taxAmount, totalAmount, appliedAmount, remainingAmount, lineItems, discounts,
                    taxes, applications, refunds, originInvoices);
        }
    }
}
