...
/**
 * This is a model class for InvoiceLineItem2 type.
 */
public class InvoiceLineItem2
    ...
    protected InvoiceLineItem2(String uid, String title, String description, String quantity,
    ...
    /**
     * Converts this InvoiceLineItem2 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "InvoiceLineItem2 [" + "uid=" + uid + ", title=" + title + ", description="
    ...
    /**
     * Builds a new {@link InvoiceLineItem2.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link InvoiceLineItem2.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link InvoiceLineItem2}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link InvoiceLineItem2} object using the set fields.
         * @return {@link InvoiceLineItem2}
         */
        public InvoiceLineItem2 build() {
            return new InvoiceLineItem2(uid, title, description, quantity, unitPrice,
