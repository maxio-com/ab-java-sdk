...
public class InvoiceLineItem1
    ...
    public String toString() {
        return "InvoiceLineItem1 [" + "uid=" + uid + ", title=" + title + ", description="
                ...
                + ", customItem=" + customItem + ", kind=" + kind + ", billingScheduleItemId="
                + billingScheduleItemId + ", additionalProperties=" + getAdditionalProperties()
                + "]";
    }
    ...
    public static class Builder {
        ...
        public InvoiceLineItem1 build() {
            return new InvoiceLineItem1(uid, title, description, quantity, unitPrice,
                    ...
                    customItem, kind, billingScheduleItemId);
        }
    }
}
