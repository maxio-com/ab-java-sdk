...
/**
 * This is a model class for ReadEventsCountInput type.
 */
public class ReadEventsCountInput {
    ...
    /**
     * Converts this ReadEventsCountInput into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ReadEventsCountInput [" + "page=" + page + ", perPage=" + perPage + ", sinceId="
                + sinceId + ", maxId=" + maxId + ", direction=" + direction + ", filter=" + filter
                + "]";
    }

    /**
     * Builds a new {@link ReadEventsCountInput.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ReadEventsCountInput.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ReadEventsCountInput}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ReadEventsCountInput} object using the set fields.
         * @return {@link ReadEventsCountInput}
         */
        public ReadEventsCountInput build() {
            return new ReadEventsCountInput(page, perPage, sinceId, maxId, direction, filter);
        }
    }
}
