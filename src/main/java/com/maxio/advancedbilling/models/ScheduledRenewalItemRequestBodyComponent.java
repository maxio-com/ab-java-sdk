...
/**
 * This is a model class for ScheduledRenewalItemRequestBodyComponent type.
 */
public class ScheduledRenewalItemRequestBodyComponent
        extends BaseModel {
    private String itemType;
    private int itemId;
    private Integer pricePointId;
    private Integer quantity;
    private ScheduledRenewalComponentCustomPrice customPrice;
     ...
     * @param  customPrice  ScheduledRenewalComponentCustomPrice value for customPrice.
     */
    public ScheduledRenewalItemRequestBodyComponent(
            String itemType,
            int itemId,
            ...
            Integer quantity,
            ScheduledRenewalComponentCustomPrice customPrice) {
     ...
     */
    @JsonCreator
    protected ScheduledRenewalItemRequestBodyComponent(
     ...
     * @return Returns the ScheduledRenewalComponentCustomPrice
     */
    @JsonGetter("custom_price")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ScheduledRenewalComponentCustomPrice getCustomPrice() {
        return customPrice;
    }
     ...
     * Custom pricing for a component within a scheduled renewal.
     * @param customPrice Value for ScheduledRenewalComponentCustomPrice
     */
    @JsonSetter("custom_price")
    public void setCustomPrice(ScheduledRenewalComponentCustomPrice customPrice) {
        this.customPrice = customPrice;
    }

    /**
     * Converts this ScheduledRenewalItemRequestBodyComponent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ScheduledRenewalItemRequestBodyComponent [" + "itemType=" + itemType + ", itemId="
    ...
    /**
     * Builds a new {@link ScheduledRenewalItemRequestBodyComponent.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ScheduledRenewalItemRequestBodyComponent.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ScheduledRenewalItemRequestBodyComponent}.
     */
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder customPrice(ScheduledRenewalComponentCustomPrice customPrice) {
            this.customPrice = customPrice;
            return this;
        }

        /**
         * Builds a new {@link ScheduledRenewalItemRequestBodyComponent} object using the set
         * fields.
         * @return {@link ScheduledRenewalItemRequestBodyComponent}
         */
        public ScheduledRenewalItemRequestBodyComponent build() {
            return new ScheduledRenewalItemRequestBodyComponent(itemType, itemId, pricePointId,
