...
public enum ListEventsDateField {
     ...
     * @return The enum member against the given string value.
     */
    public static ListEventsDateField fromString(String toConvert) {
    ...
    /**
     * Convert list of ListEventsDateField values to list of string values.
     * @param toConvert The list of ListEventsDateField values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<ListEventsDateField> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (ListEventsDateField enumValue : toConvert) {
