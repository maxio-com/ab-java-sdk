 ...
 */
@JsonDeserialize(using = DeductServiceCreditAmount.DeductServiceCreditAmountDeserializer.class)
public abstract class DeductServiceCreditAmount {
     ...
     */
    public static DeductServiceCreditAmount fromMString(String mString) {
    ...
    private static class MStringCase extends DeductServiceCreditAmount {
    ...
    private static class PrecisionCase extends DeductServiceCreditAmount {
    ...
    /**
     * This is a custom deserializer class for DeductServiceCreditAmount.
     */
    protected static class DeductServiceCreditAmountDeserializer
            extends JsonDeserializer<DeductServiceCreditAmount> {

        @Override
        public DeductServiceCreditAmount deserialize(JsonParser jp, DeserializationContext ctxt)
