 ...
 */
@JsonDeserialize(using = ScheduledRenewalConfigurationItemRequestRenewalConfigurationItem.ScheduledRenewalConfigurationItemRequestRenewalConfigurationItemDeserializer.class)
public abstract class ScheduledRenewalConfigurationItemRequestRenewalConfigurationItem {
     ...
     */
    public static ScheduledRenewalConfigurationItemRequestRenewalConfigurationItem fromScheduledRenewalItemRequestBodyComponent(
     ...
     */
    public static ScheduledRenewalConfigurationItemRequestRenewalConfigurationItem fromScheduledRenewalItemRequestBodyProduct(
    ...
    private static class ScheduledRenewalItemRequestBodyComponentCase extends ScheduledRenewalConfigurationItemRequestRenewalConfigurationItem {
    ...
    private static class ScheduledRenewalItemRequestBodyProductCase extends ScheduledRenewalConfigurationItemRequestRenewalConfigurationItem {
     ...
     */
    protected static class ScheduledRenewalConfigurationItemRequestRenewalConfigurationItemDeserializer
            extends JsonDeserializer<ScheduledRenewalConfigurationItemRequestRenewalConfigurationItem> {

        @Override
        public ScheduledRenewalConfigurationItemRequestRenewalConfigurationItem deserialize(JsonParser jp, DeserializationContext ctxt)
