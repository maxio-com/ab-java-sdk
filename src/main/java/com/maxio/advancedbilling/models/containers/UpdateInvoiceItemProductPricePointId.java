 ...
 */
@JsonDeserialize(using = UpdateInvoiceItemProductPricePointId.UpdateInvoiceItemProductPricePointIdDeserializer.class)
public abstract class UpdateInvoiceItemProductPricePointId {
     ...
     */
    public static UpdateInvoiceItemProductPricePointId fromString(String string) {
    ...
    private static class StringCase extends UpdateInvoiceItemProductPricePointId {
    ...
    private static class NumberCase extends UpdateInvoiceItemProductPricePointId {
    ...
    /**
     * This is a custom deserializer class for UpdateInvoiceItemProductPricePointId.
     */
    protected static class UpdateInvoiceItemProductPricePointIdDeserializer
            extends JsonDeserializer<UpdateInvoiceItemProductPricePointId> {

        @Override
        public UpdateInvoiceItemProductPricePointId deserialize(JsonParser jp, DeserializationContext ctxt)
