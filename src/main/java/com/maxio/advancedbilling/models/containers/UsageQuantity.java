 ...
 */
@JsonDeserialize(using = UsageQuantity.UsageQuantityDeserializer.class)
public abstract class UsageQuantity {
     ...
     */
    public static UsageQuantity fromMString(String mString) {
    ...
    private static class NumberCase extends UsageQuantity {
    ...
    private static class MStringCase extends UsageQuantity {
    ...
    /**
     * This is a custom deserializer class for UsageQuantity.
     */
    protected static class UsageQuantityDeserializer
            extends JsonDeserializer<UsageQuantity> {

        @Override
        public UsageQuantity deserialize(JsonParser jp, DeserializationContext ctxt)
