 ...
 */
@JsonDeserialize(using = CreateMultiInvoicePaymentAmount.CreateMultiInvoicePaymentAmountDeserializer.class)
public abstract class CreateMultiInvoicePaymentAmount {
     ...
     */
    public static CreateMultiInvoicePaymentAmount fromMString(String mString) {
    ...
    private static class MStringCase extends CreateMultiInvoicePaymentAmount {
    ...
    private static class PrecisionCase extends CreateMultiInvoicePaymentAmount {
    ...
    /**
     * This is a custom deserializer class for CreateMultiInvoicePaymentAmount.
     */
    protected static class CreateMultiInvoicePaymentAmountDeserializer
            extends JsonDeserializer<CreateMultiInvoicePaymentAmount> {

        @Override
        public CreateMultiInvoicePaymentAmount deserialize(JsonParser jp, DeserializationContext ctxt)
