 ...
 */
@JsonDeserialize(using = ComponentCustomPricePricingScheme.ComponentCustomPricePricingSchemeDeserializer.class)
public abstract class ComponentCustomPricePricingScheme {
     ...
     */
    public static ComponentCustomPricePricingScheme fromPricingScheme(PricingScheme pricingScheme) {
    ...
    private static class PricingSchemeCase extends ComponentCustomPricePricingScheme {
    ...
    /**
     * This is a custom deserializer class for ComponentCustomPricePricingScheme.
     */
    protected static class ComponentCustomPricePricingSchemeDeserializer
            extends JsonDeserializer<ComponentCustomPricePricingScheme> {

        @Override
        public ComponentCustomPricePricingScheme deserialize(JsonParser jp, DeserializationContext ctxt)
