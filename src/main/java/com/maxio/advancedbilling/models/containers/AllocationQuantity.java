 ...
 */
@JsonDeserialize(using = AllocationQuantity.AllocationQuantityDeserializer.class)
public abstract class AllocationQuantity {
     ...
     */
    public static AllocationQuantity fromString(String string) {
    ...
    private static class NumberCase extends AllocationQuantity {
    ...
    private static class StringCase extends AllocationQuantity {
    ...
    /**
     * This is a custom deserializer class for AllocationQuantity.
     */
    protected static class AllocationQuantityDeserializer
            extends JsonDeserializer<AllocationQuantity> {

        @Override
        public AllocationQuantity deserialize(JsonParser jp, DeserializationContext ctxt)
