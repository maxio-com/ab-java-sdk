 ...
 */
@JsonDeserialize(using = MeteredComponentPricingScheme.MeteredComponentPricingSchemeDeserializer.class)
public abstract class MeteredComponentPricingScheme {
     ...
     */
    public static MeteredComponentPricingScheme fromPricingScheme(PricingScheme pricingScheme) {
    ...
    private static class PricingSchemeCase extends MeteredComponentPricingScheme {
    ...
    /**
     * This is a custom deserializer class for MeteredComponentPricingScheme.
     */
    protected static class MeteredComponentPricingSchemeDeserializer
            extends JsonDeserializer<MeteredComponentPricingScheme> {

        @Override
        public MeteredComponentPricingScheme deserialize(JsonParser jp, DeserializationContext ctxt)
