 ...
 */
@JsonDeserialize(using = OveragePricingPricingScheme.OveragePricingPricingSchemeDeserializer.class)
public abstract class OveragePricingPricingScheme {
     ...
     */
    public static OveragePricingPricingScheme fromPricingScheme(PricingScheme pricingScheme) {
    ...
    private static class PricingSchemeCase extends OveragePricingPricingScheme {
    ...
    /**
     * This is a custom deserializer class for OveragePricingPricingScheme.
     */
    protected static class OveragePricingPricingSchemeDeserializer
            extends JsonDeserializer<OveragePricingPricingScheme> {

        @Override
        public OveragePricingPricingScheme deserialize(JsonParser jp, DeserializationContext ctxt)
