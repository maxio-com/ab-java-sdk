 ...
 */
@JsonDeserialize(using = ReadProductPricePointProductId.ReadProductPricePointProductIdDeserializer.class)
public abstract class ReadProductPricePointProductId {
     ...
     */
    public static ReadProductPricePointProductId fromString(String string) {
    ...
    private static class NumberCase extends ReadProductPricePointProductId {
    ...
    private static class StringCase extends ReadProductPricePointProductId {
    ...
    /**
     * This is a custom deserializer class for ReadProductPricePointProductId.
     */
    protected static class ReadProductPricePointProductIdDeserializer
            extends JsonDeserializer<ReadProductPricePointProductId> {

        @Override
        public ReadProductPricePointProductId deserialize(JsonParser jp, DeserializationContext ctxt)
