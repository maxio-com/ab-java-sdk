 ...
 */
@JsonDeserialize(using = RefundSegmentUids.RefundSegmentUidsDeserializer.class)
public abstract class RefundSegmentUids {
     ...
     */
    public static RefundSegmentUids fromMString(String mString) {
    ...
    private static class ListOfStringCase extends RefundSegmentUids {
    ...
    private static class MStringCase extends RefundSegmentUids {
    ...
    /**
     * This is a custom deserializer class for RefundSegmentUids.
     */
    protected static class RefundSegmentUidsDeserializer
            extends JsonDeserializer<RefundSegmentUids> {

        @Override
        public RefundSegmentUids deserialize(JsonParser jp, DeserializationContext ctxt)
