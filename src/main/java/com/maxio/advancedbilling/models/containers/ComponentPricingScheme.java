 ...
 */
@JsonDeserialize(using = ComponentPricingScheme.ComponentPricingSchemeDeserializer.class)
public abstract class ComponentPricingScheme {
    ...
    private static class PricingSchemeCase extends ComponentPricingScheme {
    ...
    /**
     * This is a custom deserializer class for ComponentPricingScheme.
     */
    protected static class ComponentPricingSchemeDeserializer
            extends JsonDeserializer<ComponentPricingScheme> {

        @Override
        public ComponentPricingScheme deserialize(JsonParser jp, DeserializationContext ctxt)
