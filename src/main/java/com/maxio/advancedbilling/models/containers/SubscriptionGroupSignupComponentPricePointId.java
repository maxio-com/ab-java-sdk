 ...
 */
@JsonDeserialize(using = SubscriptionGroupSignupComponentPricePointId.SubscriptionGroupSignupComponentPricePointIdDeserializer.class)
public abstract class SubscriptionGroupSignupComponentPricePointId {
     ...
     */
    public static SubscriptionGroupSignupComponentPricePointId fromMString(String mString) {
    ...
    private static class MStringCase extends SubscriptionGroupSignupComponentPricePointId {
    ...
    private static class NumberCase extends SubscriptionGroupSignupComponentPricePointId {
    ...
    /**
     * This is a custom deserializer class for SubscriptionGroupSignupComponentPricePointId.
     */
    protected static class SubscriptionGroupSignupComponentPricePointIdDeserializer
            extends JsonDeserializer<SubscriptionGroupSignupComponentPricePointId> {

        @Override
        public SubscriptionGroupSignupComponentPricePointId deserialize(JsonParser jp, DeserializationContext ctxt)
