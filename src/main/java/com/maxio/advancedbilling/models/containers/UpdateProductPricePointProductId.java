 ...
 */
@JsonDeserialize(using = UpdateProductPricePointProductId.UpdateProductPricePointProductIdDeserializer.class)
public abstract class UpdateProductPricePointProductId {
     ...
     */
    public static UpdateProductPricePointProductId fromString(String string) {
    ...
    private static class NumberCase extends UpdateProductPricePointProductId {
    ...
    private static class StringCase extends UpdateProductPricePointProductId {
    ...
    /**
     * This is a custom deserializer class for UpdateProductPricePointProductId.
     */
    protected static class UpdateProductPricePointProductIdDeserializer
            extends JsonDeserializer<UpdateProductPricePointProductId> {

        @Override
        public UpdateProductPricePointProductId deserialize(JsonParser jp, DeserializationContext ctxt)
