 ...
 */
@JsonDeserialize(using = AllocationPreviewItemPreviousQuantity.AllocationPreviewItemPreviousQuantityDeserializer.class)
public abstract class AllocationPreviewItemPreviousQuantity {
     ...
     */
    public static AllocationPreviewItemPreviousQuantity fromString(String string) {
    ...
    private static class NumberCase extends AllocationPreviewItemPreviousQuantity {
    ...
    private static class StringCase extends AllocationPreviewItemPreviousQuantity {
    ...
    /**
     * This is a custom deserializer class for AllocationPreviewItemPreviousQuantity.
     */
    protected static class AllocationPreviewItemPreviousQuantityDeserializer
            extends JsonDeserializer<AllocationPreviewItemPreviousQuantity> {

        @Override
        public AllocationPreviewItemPreviousQuantity deserialize(JsonParser jp, DeserializationContext ctxt)
