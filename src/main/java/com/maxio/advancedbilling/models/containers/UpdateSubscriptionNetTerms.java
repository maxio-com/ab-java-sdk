 ...
 */
@JsonDeserialize(using = UpdateSubscriptionNetTerms.UpdateSubscriptionNetTermsDeserializer.class)
public abstract class UpdateSubscriptionNetTerms {
     ...
     */
    public static UpdateSubscriptionNetTerms fromMString(String mString) {
    ...
    private static class MStringCase extends UpdateSubscriptionNetTerms {
    ...
    private static class NumberCase extends UpdateSubscriptionNetTerms {
    ...
    /**
     * This is a custom deserializer class for UpdateSubscriptionNetTerms.
     */
    protected static class UpdateSubscriptionNetTermsDeserializer
            extends JsonDeserializer<UpdateSubscriptionNetTerms> {

        @Override
        public UpdateSubscriptionNetTerms deserialize(JsonParser jp, DeserializationContext ctxt)
