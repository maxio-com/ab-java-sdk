 ...
 */
@JsonDeserialize(using = ReadComponentPricePointPricePointId.ReadComponentPricePointPricePointIdDeserializer.class)
public abstract class ReadComponentPricePointPricePointId {
     ...
     */
    public static ReadComponentPricePointPricePointId fromString(String string) {
    ...
    private static class NumberCase extends ReadComponentPricePointPricePointId {
    ...
    private static class StringCase extends ReadComponentPricePointPricePointId {
    ...
    /**
     * This is a custom deserializer class for ReadComponentPricePointPricePointId.
     */
    protected static class ReadComponentPricePointPricePointIdDeserializer
            extends JsonDeserializer<ReadComponentPricePointPricePointId> {

        @Override
        public ReadComponentPricePointPricePointId deserialize(JsonParser jp, DeserializationContext ctxt)
