 ...
 */
@JsonDeserialize(using = UpdateInvoiceItemUnitPrice.UpdateInvoiceItemUnitPriceDeserializer.class)
public abstract class UpdateInvoiceItemUnitPrice {
     ...
     */
    public static UpdateInvoiceItemUnitPrice fromString(String string) {
    ...
    private static class PrecisionCase extends UpdateInvoiceItemUnitPrice {
    ...
    private static class StringCase extends UpdateInvoiceItemUnitPrice {
    ...
    /**
     * This is a custom deserializer class for UpdateInvoiceItemUnitPrice.
     */
    protected static class UpdateInvoiceItemUnitPriceDeserializer
            extends JsonDeserializer<UpdateInvoiceItemUnitPrice> {

        @Override
        public UpdateInvoiceItemUnitPrice deserialize(JsonParser jp, DeserializationContext ctxt)
