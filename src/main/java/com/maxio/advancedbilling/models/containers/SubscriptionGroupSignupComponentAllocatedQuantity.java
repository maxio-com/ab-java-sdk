...
public abstract class SubscriptionGroupSignupComponentAllocatedQuantity {
     ...
     */
    public static SubscriptionGroupSignupComponentAllocatedQuantity fromString(String string) {
    ...
    private static class StringCase extends SubscriptionGroupSignupComponentAllocatedQuantity {
