 ...
 */
@JsonDeserialize(using = PriceUnitPrice.PriceUnitPriceDeserializer.class)
public abstract class PriceUnitPrice {
     ...
     */
    public static PriceUnitPrice fromMString(String mString) {
    ...
    private static class PrecisionCase extends PriceUnitPrice {
    ...
    private static class MStringCase extends PriceUnitPrice {
    ...
    /**
     * This is a custom deserializer class for PriceUnitPrice.
     */
    protected static class PriceUnitPriceDeserializer
            extends JsonDeserializer<PriceUnitPrice> {

        @Override
        public PriceUnitPrice deserialize(JsonParser jp, DeserializationContext ctxt)
