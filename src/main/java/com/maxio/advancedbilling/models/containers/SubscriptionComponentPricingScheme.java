 ...
 */
@JsonDeserialize(using = SubscriptionComponentPricingScheme.SubscriptionComponentPricingSchemeDeserializer.class)
public abstract class SubscriptionComponentPricingScheme {
     ...
     */
    public static SubscriptionComponentPricingScheme fromPricingScheme(
    ...
    private static class PricingSchemeCase extends SubscriptionComponentPricingScheme {
    ...
    /**
     * This is a custom deserializer class for SubscriptionComponentPricingScheme.
     */
    protected static class SubscriptionComponentPricingSchemeDeserializer
            extends JsonDeserializer<SubscriptionComponentPricingScheme> {

        @Override
        public SubscriptionComponentPricingScheme deserialize(JsonParser jp, DeserializationContext ctxt)
