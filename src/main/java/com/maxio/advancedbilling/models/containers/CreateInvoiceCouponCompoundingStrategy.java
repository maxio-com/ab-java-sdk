 ...
 */
@JsonDeserialize(using = CreateInvoiceCouponCompoundingStrategy.CreateInvoiceCouponCompoundingStrategyDeserializer.class)
public abstract class CreateInvoiceCouponCompoundingStrategy {
     ...
     */
    public static CreateInvoiceCouponCompoundingStrategy fromCompoundingStrategy(
    ...
    private static class CompoundingStrategyCase extends CreateInvoiceCouponCompoundingStrategy {
    ...
    /**
     * This is a custom deserializer class for CreateInvoiceCouponCompoundingStrategy.
     */
    protected static class CreateInvoiceCouponCompoundingStrategyDeserializer
            extends JsonDeserializer<CreateInvoiceCouponCompoundingStrategy> {

        @Override
        public CreateInvoiceCouponCompoundingStrategy deserialize(JsonParser jp, DeserializationContext ctxt)
