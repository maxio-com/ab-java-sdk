 ...
 */
@JsonDeserialize(using = PrepaidUsageComponentPricingScheme.PrepaidUsageComponentPricingSchemeDeserializer.class)
public abstract class PrepaidUsageComponentPricingScheme {
     ...
     */
    public static PrepaidUsageComponentPricingScheme fromPricingScheme(
    ...
    private static class PricingSchemeCase extends PrepaidUsageComponentPricingScheme {
    ...
    /**
     * This is a custom deserializer class for PrepaidUsageComponentPricingScheme.
     */
    protected static class PrepaidUsageComponentPricingSchemeDeserializer
            extends JsonDeserializer<PrepaidUsageComponentPricingScheme> {

        @Override
        public PrepaidUsageComponentPricingScheme deserialize(JsonParser jp, DeserializationContext ctxt)
