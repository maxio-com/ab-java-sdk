 ...
 */
@JsonDeserialize(using = ArchiveProductPricePointPricePointId.ArchiveProductPricePointPricePointIdDeserializer.class)
public abstract class ArchiveProductPricePointPricePointId {
     ...
     */
    public static ArchiveProductPricePointPricePointId fromString(String string) {
    ...
    private static class NumberCase extends ArchiveProductPricePointPricePointId {
    ...
    private static class StringCase extends ArchiveProductPricePointPricePointId {
    ...
    /**
     * This is a custom deserializer class for ArchiveProductPricePointPricePointId.
     */
    protected static class ArchiveProductPricePointPricePointIdDeserializer
            extends JsonDeserializer<ArchiveProductPricePointPricePointId> {

        @Override
        public ArchiveProductPricePointPricePointId deserialize(JsonParser jp, DeserializationContext ctxt)
