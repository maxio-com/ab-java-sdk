 ...
 */
@JsonDeserialize(using = CreateComponentPricePointRequestPricePoint.CreateComponentPricePointRequestPricePointDeserializer.class)
public abstract class CreateComponentPricePointRequestPricePoint {
     ...
     */
    public static CreateComponentPricePointRequestPricePoint fromCreateComponentPricePoint(
     ...
     */
    public static CreateComponentPricePointRequestPricePoint fromCreatePrepaidUsageComponentPricePoint(
    ...
    private static class CreateComponentPricePointCase extends CreateComponentPricePointRequestPricePoint {
    ...
    private static class CreatePrepaidUsageComponentPricePointCase extends CreateComponentPricePointRequestPricePoint {
    ...
    /**
     * This is a custom deserializer class for CreateComponentPricePointRequestPricePoint.
     */
    protected static class CreateComponentPricePointRequestPricePointDeserializer
            extends JsonDeserializer<CreateComponentPricePointRequestPricePoint> {

        @Override
        public CreateComponentPricePointRequestPricePoint deserialize(JsonParser jp, DeserializationContext ctxt)
