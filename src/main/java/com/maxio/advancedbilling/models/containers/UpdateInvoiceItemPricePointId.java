 ...
 */
@JsonDeserialize(using = UpdateInvoiceItemPricePointId.UpdateInvoiceItemPricePointIdDeserializer.class)
public abstract class UpdateInvoiceItemPricePointId {
     ...
     */
    public static UpdateInvoiceItemPricePointId fromString(String string) {
    ...
    private static class StringCase extends UpdateInvoiceItemPricePointId {
    ...
    private static class NumberCase extends UpdateInvoiceItemPricePointId {
    ...
    /**
     * This is a custom deserializer class for UpdateInvoiceItemPricePointId.
     */
    protected static class UpdateInvoiceItemPricePointIdDeserializer
            extends JsonDeserializer<UpdateInvoiceItemPricePointId> {

        @Override
        public UpdateInvoiceItemPricePointId deserialize(JsonParser jp, DeserializationContext ctxt)
