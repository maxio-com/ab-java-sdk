 ...
 */
@JsonDeserialize(using = CreateInvoiceCouponAmount.CreateInvoiceCouponAmountDeserializer.class)
public abstract class CreateInvoiceCouponAmount {
     ...
     */
    public static CreateInvoiceCouponAmount fromMString(String mString) {
    ...
    private static class MStringCase extends CreateInvoiceCouponAmount {
    ...
    private static class PrecisionCase extends CreateInvoiceCouponAmount {
    ...
    /**
     * This is a custom deserializer class for CreateInvoiceCouponAmount.
     */
    protected static class CreateInvoiceCouponAmountDeserializer
            extends JsonDeserializer<CreateInvoiceCouponAmount> {

        @Override
        public CreateInvoiceCouponAmount deserialize(JsonParser jp, DeserializationContext ctxt)
