...
public abstract class RemovePaymentEventDataPaymentMethod {
     ...
     */
    public static RemovePaymentEventDataPaymentMethod fromPaymentMethodApplePayType(
     ...
     */
    public static RemovePaymentEventDataPaymentMethod fromPaymentMethodBankAccountType(
     ...
     */
    public static RemovePaymentEventDataPaymentMethod fromPaymentMethodCreditCardType(
     ...
     */
    public static RemovePaymentEventDataPaymentMethod fromPaymentMethodExternalType(
     ...
     */
    public static RemovePaymentEventDataPaymentMethod fromPaymentMethodPaypalType(
    ...
    private static class PaymentMethodApplePayTypeCase extends RemovePaymentEventDataPaymentMethod {
    ...
    private static class PaymentMethodBankAccountTypeCase extends RemovePaymentEventDataPaymentMethod {
    ...
    private static class PaymentMethodCreditCardTypeCase extends RemovePaymentEventDataPaymentMethod {
    ...
    private static class PaymentMethodExternalTypeCase extends RemovePaymentEventDataPaymentMethod {
    ...
    private static class PaymentMethodPaypalTypeCase extends RemovePaymentEventDataPaymentMethod {
    ...
    /**
     * This is a custom deserializer class for RemovePaymentEventDataPaymentMethod.
     */
    protected static class RemovePaymentEventDataPaymentMethodDeserializer
            extends JsonDeserializer<RemovePaymentEventDataPaymentMethod> {

        @Override
        public RemovePaymentEventDataPaymentMethod deserialize(JsonParser jp, DeserializationContext ctxt)
