 ...
 */
@JsonDeserialize(using = CreateInvoiceItemComponentId.CreateInvoiceItemComponentIdDeserializer.class)
public abstract class CreateInvoiceItemComponentId {
     ...
     */
    public static CreateInvoiceItemComponentId fromMString(String mString) {
    ...
    private static class MStringCase extends CreateInvoiceItemComponentId {
    ...
    private static class NumberCase extends CreateInvoiceItemComponentId {
    ...
    /**
     * This is a custom deserializer class for CreateInvoiceItemComponentId.
     */
    protected static class CreateInvoiceItemComponentIdDeserializer
            extends JsonDeserializer<CreateInvoiceItemComponentId> {

        @Override
        public CreateInvoiceItemComponentId deserialize(JsonParser jp, DeserializationContext ctxt)
