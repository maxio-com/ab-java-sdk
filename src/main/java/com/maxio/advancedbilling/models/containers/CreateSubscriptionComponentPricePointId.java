...
public abstract class CreateSubscriptionComponentPricePointId {
     ...
     */
    public static CreateSubscriptionComponentPricePointId fromString(String string) {
    ...
    private static class StringCase extends CreateSubscriptionComponentPricePointId {
