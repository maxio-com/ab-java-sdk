 ...
 */
@JsonDeserialize(using = CreateSubscriptionComponentPricePointId.CreateSubscriptionComponentPricePointIdDeserializer.class)
public abstract class CreateSubscriptionComponentPricePointId {
     ...
     */
    public static CreateSubscriptionComponentPricePointId fromMString(String mString) {
    ...
    private static class NumberCase extends CreateSubscriptionComponentPricePointId {
    ...
    private static class MStringCase extends CreateSubscriptionComponentPricePointId {
    ...
    /**
     * This is a custom deserializer class for CreateSubscriptionComponentPricePointId.
     */
    protected static class CreateSubscriptionComponentPricePointIdDeserializer
            extends JsonDeserializer<CreateSubscriptionComponentPricePointId> {

        @Override
        public CreateSubscriptionComponentPricePointId deserialize(JsonParser jp, DeserializationContext ctxt)
