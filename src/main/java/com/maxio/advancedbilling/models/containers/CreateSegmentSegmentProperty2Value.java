 ...
 */
@JsonDeserialize(using = CreateSegmentSegmentProperty2Value.CreateSegmentSegmentProperty2ValueDeserializer.class)
public abstract class CreateSegmentSegmentProperty2Value {
     ...
     */
    public static CreateSegmentSegmentProperty2Value fromMString(String mString) {
     ...
     */
    public static CreateSegmentSegmentProperty2Value fromMBoolean(boolean mBoolean) {
    ...
    private static class MStringCase extends CreateSegmentSegmentProperty2Value {
    ...
    private static class PrecisionCase extends CreateSegmentSegmentProperty2Value {
    ...
    private static class NumberCase extends CreateSegmentSegmentProperty2Value {
    ...
    private static class MBooleanCase extends CreateSegmentSegmentProperty2Value {
    ...
    /**
     * This is a custom deserializer class for CreateSegmentSegmentProperty2Value.
     */
    protected static class CreateSegmentSegmentProperty2ValueDeserializer
            extends JsonDeserializer<CreateSegmentSegmentProperty2Value> {

        @Override
        public CreateSegmentSegmentProperty2Value deserialize(JsonParser jp, DeserializationContext ctxt)
