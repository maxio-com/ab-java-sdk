...
public abstract class CreateSegmentSegmentProperty2Value {
     ...
     */
    public static CreateSegmentSegmentProperty2Value fromString(String string) {
     ...
     */
    public static CreateSegmentSegmentProperty2Value fromBoolean(boolean mBoolean) {
    ...
    private static class StringCase extends CreateSegmentSegmentProperty2Value {
    ...
    private static class BooleanCase extends CreateSegmentSegmentProperty2Value {
