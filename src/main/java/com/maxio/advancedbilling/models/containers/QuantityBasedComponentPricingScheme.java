 ...
 */
@JsonDeserialize(using = QuantityBasedComponentPricingScheme.QuantityBasedComponentPricingSchemeDeserializer.class)
public abstract class QuantityBasedComponentPricingScheme {
     ...
     */
    public static QuantityBasedComponentPricingScheme fromPricingScheme(
    ...
    private static class PricingSchemeCase extends QuantityBasedComponentPricingScheme {
    ...
    /**
     * This is a custom deserializer class for QuantityBasedComponentPricingScheme.
     */
    protected static class QuantityBasedComponentPricingSchemeDeserializer
            extends JsonDeserializer<QuantityBasedComponentPricingScheme> {

        @Override
        public QuantityBasedComponentPricingScheme deserialize(JsonParser jp, DeserializationContext ctxt)
