 ...
 */
@JsonDeserialize(using = PrepaidUsageComponentUnitPrice.PrepaidUsageComponentUnitPriceDeserializer.class)
public abstract class PrepaidUsageComponentUnitPrice {
     ...
     */
    public static PrepaidUsageComponentUnitPrice fromMString(String mString) {
    ...
    private static class MStringCase extends PrepaidUsageComponentUnitPrice {
    ...
    private static class PrecisionCase extends PrepaidUsageComponentUnitPrice {
    ...
    /**
     * This is a custom deserializer class for PrepaidUsageComponentUnitPrice.
     */
    protected static class PrepaidUsageComponentUnitPriceDeserializer
            extends JsonDeserializer<PrepaidUsageComponentUnitPrice> {

        @Override
        public PrepaidUsageComponentUnitPrice deserialize(JsonParser jp, DeserializationContext ctxt)
