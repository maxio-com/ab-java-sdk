 ...
 */
@JsonDeserialize(using = CouponCouponResponseCompoundingStrategyCase0.CouponCouponResponseCompoundingStrategyCase0Deserializer.class)
public abstract class CouponCouponResponseCompoundingStrategyCase0 {
     ...
     */
    public static CouponCouponResponseCompoundingStrategyCase0 fromCompoundingStrategy(
    ...
    private static class CompoundingStrategyCase extends CouponCouponResponseCompoundingStrategyCase0 {
    ...
    /**
     * This is a custom deserializer class for CouponCouponResponseCompoundingStrategyCase0.
     */
    protected static class CouponCouponResponseCompoundingStrategyCase0Deserializer
            extends JsonDeserializer<CouponCouponResponseCompoundingStrategyCase0> {

        @Override
        public CouponCouponResponseCompoundingStrategyCase0 deserialize(JsonParser jp, DeserializationContext ctxt)
