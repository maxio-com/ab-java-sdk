 ...
 */
@JsonDeserialize(using = SubscriptionComponentUnitBalance.SubscriptionComponentUnitBalanceDeserializer.class)
public abstract class SubscriptionComponentUnitBalance {
     ...
     */
    public static SubscriptionComponentUnitBalance fromString(String string) {
    ...
    private static class NumberCase extends SubscriptionComponentUnitBalance {
    ...
    private static class StringCase extends SubscriptionComponentUnitBalance {
    ...
    /**
     * This is a custom deserializer class for SubscriptionComponentUnitBalance.
     */
    protected static class SubscriptionComponentUnitBalanceDeserializer
            extends JsonDeserializer<SubscriptionComponentUnitBalance> {

        @Override
        public SubscriptionComponentUnitBalance deserialize(JsonParser jp, DeserializationContext ctxt)
