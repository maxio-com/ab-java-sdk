 ...
 */
@JsonDeserialize(using = CreateProductPricePointProductId.CreateProductPricePointProductIdDeserializer.class)
public abstract class CreateProductPricePointProductId {
     ...
     */
    public static CreateProductPricePointProductId fromString(String string) {
    ...
    private static class NumberCase extends CreateProductPricePointProductId {
    ...
    private static class StringCase extends CreateProductPricePointProductId {
    ...
    /**
     * This is a custom deserializer class for CreateProductPricePointProductId.
     */
    protected static class CreateProductPricePointProductIdDeserializer
            extends JsonDeserializer<CreateProductPricePointProductId> {

        @Override
        public CreateProductPricePointProductId deserialize(JsonParser jp, DeserializationContext ctxt)
