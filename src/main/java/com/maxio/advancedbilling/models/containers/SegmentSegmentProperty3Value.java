...
public abstract class SegmentSegmentProperty3Value {
     ...
     */
    public static SegmentSegmentProperty3Value fromString(String string) {
     ...
     */
    public static SegmentSegmentProperty3Value fromBoolean(boolean mBoolean) {
    ...
    private static class StringCase extends SegmentSegmentProperty3Value {
    ...
    private static class BooleanCase extends SegmentSegmentProperty3Value {
