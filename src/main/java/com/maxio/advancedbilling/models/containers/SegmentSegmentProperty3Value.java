 ...
 */
@JsonDeserialize(using = SegmentSegmentProperty3Value.SegmentSegmentProperty3ValueDeserializer.class)
public abstract class SegmentSegmentProperty3Value {
     ...
     */
    public static SegmentSegmentProperty3Value fromMString(String mString) {
     ...
     */
    public static SegmentSegmentProperty3Value fromMBoolean(boolean mBoolean) {
    ...
    private static class MStringCase extends SegmentSegmentProperty3Value {
    ...
    private static class PrecisionCase extends SegmentSegmentProperty3Value {
    ...
    private static class NumberCase extends SegmentSegmentProperty3Value {
    ...
    private static class MBooleanCase extends SegmentSegmentProperty3Value {
    ...
    /**
     * This is a custom deserializer class for SegmentSegmentProperty3Value.
     */
    protected static class SegmentSegmentProperty3ValueDeserializer
            extends JsonDeserializer<SegmentSegmentProperty3Value> {

        @Override
        public SegmentSegmentProperty3Value deserialize(JsonParser jp, DeserializationContext ctxt)
