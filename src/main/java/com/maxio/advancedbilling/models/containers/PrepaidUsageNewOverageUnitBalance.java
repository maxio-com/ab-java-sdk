 ...
 */
@JsonDeserialize(using = PrepaidUsageNewOverageUnitBalance.PrepaidUsageNewOverageUnitBalanceDeserializer.class)
public abstract class PrepaidUsageNewOverageUnitBalance {
     ...
     */
    public static PrepaidUsageNewOverageUnitBalance fromString(String string) {
    ...
    private static class NumberCase extends PrepaidUsageNewOverageUnitBalance {
    ...
    private static class StringCase extends PrepaidUsageNewOverageUnitBalance {
    ...
    /**
     * This is a custom deserializer class for PrepaidUsageNewOverageUnitBalance.
     */
    protected static class PrepaidUsageNewOverageUnitBalanceDeserializer
            extends JsonDeserializer<PrepaidUsageNewOverageUnitBalance> {

        @Override
        public PrepaidUsageNewOverageUnitBalance deserialize(JsonParser jp, DeserializationContext ctxt)
