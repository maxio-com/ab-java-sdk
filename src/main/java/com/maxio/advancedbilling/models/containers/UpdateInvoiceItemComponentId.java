 ...
 */
@JsonDeserialize(using = UpdateInvoiceItemComponentId.UpdateInvoiceItemComponentIdDeserializer.class)
public abstract class UpdateInvoiceItemComponentId {
     ...
     */
    public static UpdateInvoiceItemComponentId fromString(String string) {
    ...
    private static class StringCase extends UpdateInvoiceItemComponentId {
    ...
    private static class NumberCase extends UpdateInvoiceItemComponentId {
    ...
    /**
     * This is a custom deserializer class for UpdateInvoiceItemComponentId.
     */
    protected static class UpdateInvoiceItemComponentIdDeserializer
            extends JsonDeserializer<UpdateInvoiceItemComponentId> {

        @Override
        public UpdateInvoiceItemComponentId deserialize(JsonParser jp, DeserializationContext ctxt)
