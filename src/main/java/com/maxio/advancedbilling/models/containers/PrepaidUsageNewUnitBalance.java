 ...
 */
@JsonDeserialize(using = PrepaidUsageNewUnitBalance.PrepaidUsageNewUnitBalanceDeserializer.class)
public abstract class PrepaidUsageNewUnitBalance {
     ...
     */
    public static PrepaidUsageNewUnitBalance fromString(String string) {
    ...
    private static class NumberCase extends PrepaidUsageNewUnitBalance {
    ...
    private static class StringCase extends PrepaidUsageNewUnitBalance {
    ...
    /**
     * This is a custom deserializer class for PrepaidUsageNewUnitBalance.
     */
    protected static class PrepaidUsageNewUnitBalanceDeserializer
            extends JsonDeserializer<PrepaidUsageNewUnitBalance> {

        @Override
        public PrepaidUsageNewUnitBalance deserialize(JsonParser jp, DeserializationContext ctxt)
