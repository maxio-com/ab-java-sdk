 ...
 */
@JsonDeserialize(using = ArchiveComponentPricePointComponentId.ArchiveComponentPricePointComponentIdDeserializer.class)
public abstract class ArchiveComponentPricePointComponentId {
     ...
     */
    public static ArchiveComponentPricePointComponentId fromString(String string) {
    ...
    private static class NumberCase extends ArchiveComponentPricePointComponentId {
    ...
    private static class StringCase extends ArchiveComponentPricePointComponentId {
    ...
    /**
     * This is a custom deserializer class for ArchiveComponentPricePointComponentId.
     */
    protected static class ArchiveComponentPricePointComponentIdDeserializer
            extends JsonDeserializer<ArchiveComponentPricePointComponentId> {

        @Override
        public ArchiveComponentPricePointComponentId deserialize(JsonParser jp, DeserializationContext ctxt)
