 ...
 */
@JsonDeserialize(using = CustomerChangeShippingAddress.CustomerChangeShippingAddressDeserializer.class)
public abstract class CustomerChangeShippingAddress {
    ...
    private static class AddressChangeCase extends CustomerChangeShippingAddress {
    ...
    /**
     * This is a custom deserializer class for CustomerChangeShippingAddress.
     */
    protected static class CustomerChangeShippingAddressDeserializer
            extends JsonDeserializer<CustomerChangeShippingAddress> {

        @Override
        public CustomerChangeShippingAddress deserialize(JsonParser jp, DeserializationContext ctxt)
