 ...
 */
@JsonDeserialize(using = ScheduledRenewalProductPricePointInterval.ScheduledRenewalProductPricePointIntervalDeserializer.class)
public abstract class ScheduledRenewalProductPricePointInterval {
     ...
     */
    public static ScheduledRenewalProductPricePointInterval fromString(String string) {
    ...
    private static class StringCase extends ScheduledRenewalProductPricePointInterval {
    ...
    private static class NumberCase extends ScheduledRenewalProductPricePointInterval {
    ...
    /**
     * This is a custom deserializer class for ScheduledRenewalProductPricePointInterval.
     */
    protected static class ScheduledRenewalProductPricePointIntervalDeserializer
            extends JsonDeserializer<ScheduledRenewalProductPricePointInterval> {

        @Override
        public ScheduledRenewalProductPricePointInterval deserialize(JsonParser jp, DeserializationContext ctxt)
