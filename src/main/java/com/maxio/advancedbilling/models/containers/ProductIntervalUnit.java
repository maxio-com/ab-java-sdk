 ...
 */
@JsonDeserialize(using = ProductIntervalUnit.ProductIntervalUnitDeserializer.class)
public abstract class ProductIntervalUnit {
     ...
     */
    public static ProductIntervalUnit fromIntervalUnit(IntervalUnit intervalUnit) {
    ...
    private static class IntervalUnitCase extends ProductIntervalUnit {
    ...
    /**
     * This is a custom deserializer class for ProductIntervalUnit.
     */
    protected static class ProductIntervalUnitDeserializer
            extends JsonDeserializer<ProductIntervalUnit> {

        @Override
        public ProductIntervalUnit deserialize(JsonParser jp, DeserializationContext ctxt)
