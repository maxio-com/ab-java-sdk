...
public abstract class PaymentProfileAttributesExpirationYear {
     ...
     */
    public static PaymentProfileAttributesExpirationYear fromString(String string) {
    ...
    private static class StringCase extends PaymentProfileAttributesExpirationYear {
