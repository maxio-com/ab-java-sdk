 ...
 */
@JsonDeserialize(using = PaymentProfileAttributesExpirationYear.PaymentProfileAttributesExpirationYearDeserializer.class)
public abstract class PaymentProfileAttributesExpirationYear {
     ...
     */
    public static PaymentProfileAttributesExpirationYear fromMString(String mString) {
    ...
    private static class NumberCase extends PaymentProfileAttributesExpirationYear {
    ...
    private static class MStringCase extends PaymentProfileAttributesExpirationYear {
    ...
    /**
     * This is a custom deserializer class for PaymentProfileAttributesExpirationYear.
     */
    protected static class PaymentProfileAttributesExpirationYearDeserializer
            extends JsonDeserializer<PaymentProfileAttributesExpirationYear> {

        @Override
        public PaymentProfileAttributesExpirationYear deserialize(JsonParser jp, DeserializationContext ctxt)
