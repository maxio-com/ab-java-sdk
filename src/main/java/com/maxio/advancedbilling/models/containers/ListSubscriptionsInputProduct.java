 ...
 */
@JsonDeserialize(using = ListSubscriptionsInputProduct.ListSubscriptionsInputProductDeserializer.class)
public abstract class ListSubscriptionsInputProduct {
     ...
     */
    public static ListSubscriptionsInputProduct fromString(String string) {
    ...
    private static class NumberCase extends ListSubscriptionsInputProduct {
    ...
    private static class StringCase extends ListSubscriptionsInputProduct {
    ...
    /**
     * This is a custom deserializer class for ListSubscriptionsInputProduct.
     */
    protected static class ListSubscriptionsInputProductDeserializer
            extends JsonDeserializer<ListSubscriptionsInputProduct> {

        @Override
        public ListSubscriptionsInputProduct deserialize(JsonParser jp, DeserializationContext ctxt)
