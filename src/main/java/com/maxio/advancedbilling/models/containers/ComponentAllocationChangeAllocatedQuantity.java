 ...
 */
@JsonDeserialize(using = ComponentAllocationChangeAllocatedQuantity.ComponentAllocationChangeAllocatedQuantityDeserializer.class)
public abstract class ComponentAllocationChangeAllocatedQuantity {
     ...
     */
    public static ComponentAllocationChangeAllocatedQuantity fromString(String string) {
    ...
    private static class NumberCase extends ComponentAllocationChangeAllocatedQuantity {
    ...
    private static class StringCase extends ComponentAllocationChangeAllocatedQuantity {
    ...
    /**
     * This is a custom deserializer class for ComponentAllocationChangeAllocatedQuantity.
     */
    protected static class ComponentAllocationChangeAllocatedQuantityDeserializer
            extends JsonDeserializer<ComponentAllocationChangeAllocatedQuantity> {

        @Override
        public ComponentAllocationChangeAllocatedQuantity deserialize(JsonParser jp, DeserializationContext ctxt)
