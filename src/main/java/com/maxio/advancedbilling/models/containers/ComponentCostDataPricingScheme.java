 ...
 */
@JsonDeserialize(using = ComponentCostDataPricingScheme.ComponentCostDataPricingSchemeDeserializer.class)
public abstract class ComponentCostDataPricingScheme {
     ...
     */
    public static ComponentCostDataPricingScheme fromPricingScheme(PricingScheme pricingScheme) {
    ...
    private static class PricingSchemeCase extends ComponentCostDataPricingScheme {
    ...
    /**
     * This is a custom deserializer class for ComponentCostDataPricingScheme.
     */
    protected static class ComponentCostDataPricingSchemeDeserializer
            extends JsonDeserializer<ComponentCostDataPricingScheme> {

        @Override
        public ComponentCostDataPricingScheme deserialize(JsonParser jp, DeserializationContext ctxt)
