...
public abstract class PaymentProfileAttributesExpirationMonth {
     ...
     */
    public static PaymentProfileAttributesExpirationMonth fromString(String string) {
    ...
    private static class StringCase extends PaymentProfileAttributesExpirationMonth {
