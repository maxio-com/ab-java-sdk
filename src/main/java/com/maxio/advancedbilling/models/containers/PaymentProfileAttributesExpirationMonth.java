 ...
 */
@JsonDeserialize(using = PaymentProfileAttributesExpirationMonth.PaymentProfileAttributesExpirationMonthDeserializer.class)
public abstract class PaymentProfileAttributesExpirationMonth {
     ...
     */
    public static PaymentProfileAttributesExpirationMonth fromMString(String mString) {
    ...
    private static class NumberCase extends PaymentProfileAttributesExpirationMonth {
    ...
    private static class MStringCase extends PaymentProfileAttributesExpirationMonth {
    ...
    /**
     * This is a custom deserializer class for PaymentProfileAttributesExpirationMonth.
     */
    protected static class PaymentProfileAttributesExpirationMonthDeserializer
            extends JsonDeserializer<PaymentProfileAttributesExpirationMonth> {

        @Override
        public PaymentProfileAttributesExpirationMonth deserialize(JsonParser jp, DeserializationContext ctxt)
