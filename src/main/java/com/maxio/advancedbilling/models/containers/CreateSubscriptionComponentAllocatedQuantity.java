 ...
 */
@JsonDeserialize(using = CreateSubscriptionComponentAllocatedQuantity.CreateSubscriptionComponentAllocatedQuantityDeserializer.class)
public abstract class CreateSubscriptionComponentAllocatedQuantity {
     ...
     */
    public static CreateSubscriptionComponentAllocatedQuantity fromString(String string) {
    ...
    private static class NumberCase extends CreateSubscriptionComponentAllocatedQuantity {
    ...
    private static class StringCase extends CreateSubscriptionComponentAllocatedQuantity {
    ...
    /**
     * This is a custom deserializer class for CreateSubscriptionComponentAllocatedQuantity.
     */
    protected static class CreateSubscriptionComponentAllocatedQuantityDeserializer
            extends JsonDeserializer<CreateSubscriptionComponentAllocatedQuantity> {

        @Override
        public CreateSubscriptionComponentAllocatedQuantity deserialize(JsonParser jp, DeserializationContext ctxt)
