 ...
 */
@JsonDeserialize(using = QuantityBasedComponentUnitPrice.QuantityBasedComponentUnitPriceDeserializer.class)
public abstract class QuantityBasedComponentUnitPrice {
     ...
     */
    public static QuantityBasedComponentUnitPrice fromMString(String mString) {
    ...
    private static class MStringCase extends QuantityBasedComponentUnitPrice {
    ...
    private static class PrecisionCase extends QuantityBasedComponentUnitPrice {
    ...
    /**
     * This is a custom deserializer class for QuantityBasedComponentUnitPrice.
     */
    protected static class QuantityBasedComponentUnitPriceDeserializer
            extends JsonDeserializer<QuantityBasedComponentUnitPrice> {

        @Override
        public QuantityBasedComponentUnitPrice deserialize(JsonParser jp, DeserializationContext ctxt)
