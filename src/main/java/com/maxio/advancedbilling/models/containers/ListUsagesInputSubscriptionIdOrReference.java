 ...
 */
@JsonDeserialize(using = ListUsagesInputSubscriptionIdOrReference.ListUsagesInputSubscriptionIdOrReferenceDeserializer.class)
public abstract class ListUsagesInputSubscriptionIdOrReference {
     ...
     */
    public static ListUsagesInputSubscriptionIdOrReference fromString(String string) {
    ...
    private static class NumberCase extends ListUsagesInputSubscriptionIdOrReference {
    ...
    private static class StringCase extends ListUsagesInputSubscriptionIdOrReference {
    ...
    /**
     * This is a custom deserializer class for ListUsagesInputSubscriptionIdOrReference.
     */
    protected static class ListUsagesInputSubscriptionIdOrReferenceDeserializer
            extends JsonDeserializer<ListUsagesInputSubscriptionIdOrReference> {

        @Override
        public ListUsagesInputSubscriptionIdOrReference deserialize(JsonParser jp, DeserializationContext ctxt)
