...
public abstract class CreateOrUpdatePercentageCouponPercentage {
     ...
     */
    public static CreateOrUpdatePercentageCouponPercentage fromMString(String mString) {
    ...
    private static class MStringCase extends CreateOrUpdatePercentageCouponPercentage {
