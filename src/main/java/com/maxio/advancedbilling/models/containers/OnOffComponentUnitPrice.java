 ...
 */
@JsonDeserialize(using = OnOffComponentUnitPrice.OnOffComponentUnitPriceDeserializer.class)
public abstract class OnOffComponentUnitPrice {
     ...
     */
    public static OnOffComponentUnitPrice fromMString(String mString) {
    ...
    private static class MStringCase extends OnOffComponentUnitPrice {
    ...
    private static class PrecisionCase extends OnOffComponentUnitPrice {
    ...
    /**
     * This is a custom deserializer class for OnOffComponentUnitPrice.
     */
    protected static class OnOffComponentUnitPriceDeserializer
            extends JsonDeserializer<OnOffComponentUnitPrice> {

        @Override
        public OnOffComponentUnitPrice deserialize(JsonParser jp, DeserializationContext ctxt)
