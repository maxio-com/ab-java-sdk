...
public abstract class CreateInvoiceCouponPercentage {
     ...
     */
    public static CreateInvoiceCouponPercentage fromMString(String mString) {
    ...
    private static class MStringCase extends CreateInvoiceCouponPercentage {
    ...
    private static class PrecisionCase extends CreateInvoiceCouponPercentage {
    ...
    /**
     * This is a custom deserializer class for CreateInvoiceCouponPercentage.
     */
    protected static class CreateInvoiceCouponPercentageDeserializer
            extends JsonDeserializer<CreateInvoiceCouponPercentage> {

        @Override
        public CreateInvoiceCouponPercentage deserialize(JsonParser jp, DeserializationContext ctxt)
