 ...
 */
@JsonDeserialize(using = CreateSegmentSegmentProperty3Value.CreateSegmentSegmentProperty3ValueDeserializer.class)
public abstract class CreateSegmentSegmentProperty3Value {
    ...
    private static class PrecisionCase extends CreateSegmentSegmentProperty3Value {
    ...
    private static class NumberCase extends CreateSegmentSegmentProperty3Value {
    ...
    /**
     * This is a custom deserializer class for CreateSegmentSegmentProperty3Value.
     */
    protected static class CreateSegmentSegmentProperty3ValueDeserializer
            extends JsonDeserializer<CreateSegmentSegmentProperty3Value> {

        @Override
        public CreateSegmentSegmentProperty3Value deserialize(JsonParser jp, DeserializationContext ctxt)
