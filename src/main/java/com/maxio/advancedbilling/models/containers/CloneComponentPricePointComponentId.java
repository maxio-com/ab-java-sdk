 ...
 */
@JsonDeserialize(using = CloneComponentPricePointComponentId.CloneComponentPricePointComponentIdDeserializer.class)
public abstract class CloneComponentPricePointComponentId {
     ...
     */
    public static CloneComponentPricePointComponentId fromString(String string) {
    ...
    private static class NumberCase extends CloneComponentPricePointComponentId {
    ...
    private static class StringCase extends CloneComponentPricePointComponentId {
    ...
    /**
     * This is a custom deserializer class for CloneComponentPricePointComponentId.
     */
    protected static class CloneComponentPricePointComponentIdDeserializer
            extends JsonDeserializer<CloneComponentPricePointComponentId> {

        @Override
        public CloneComponentPricePointComponentId deserialize(JsonParser jp, DeserializationContext ctxt)
