 ...
 */
@JsonDeserialize(using = ProductTrialIntervalUnitCase0.ProductTrialIntervalUnitCase0Deserializer.class)
public abstract class ProductTrialIntervalUnitCase0 {
    ...
    private static class IntervalUnitCase extends ProductTrialIntervalUnitCase0 {
    ...
    /**
     * This is a custom deserializer class for ProductTrialIntervalUnitCase0.
     */
    protected static class ProductTrialIntervalUnitCase0Deserializer
            extends JsonDeserializer<ProductTrialIntervalUnitCase0> {

        @Override
        public ProductTrialIntervalUnitCase0 deserialize(JsonParser jp, DeserializationContext ctxt)
