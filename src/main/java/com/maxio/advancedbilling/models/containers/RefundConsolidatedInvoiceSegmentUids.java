...
public abstract class RefundConsolidatedInvoiceSegmentUids {
     ...
     */
    public static RefundConsolidatedInvoiceSegmentUids fromString(String string) {
    ...
    private static class StringCase extends RefundConsolidatedInvoiceSegmentUids {
