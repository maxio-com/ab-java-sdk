 ...
 */
@JsonDeserialize(using = InvoiceEventInvoiceEventPaymentMethod.InvoiceEventInvoiceEventPaymentMethodDeserializer.class)
public abstract class InvoiceEventInvoiceEventPaymentMethod {
     ...
     */
    public static InvoiceEventInvoiceEventPaymentMethod fromPaymentMethodApplePayType(
     ...
     */
    public static InvoiceEventInvoiceEventPaymentMethod fromPaymentMethodBankAccountType(
     ...
     */
    public static InvoiceEventInvoiceEventPaymentMethod fromPaymentMethodCreditCardType(
     ...
     */
    public static InvoiceEventInvoiceEventPaymentMethod fromPaymentMethodExternalType(
     ...
     */
    public static InvoiceEventInvoiceEventPaymentMethod fromPaymentMethodPaypalType(
    ...
    private static class PaymentMethodApplePayTypeCase extends InvoiceEventInvoiceEventPaymentMethod {
    ...
    private static class PaymentMethodBankAccountTypeCase extends InvoiceEventInvoiceEventPaymentMethod {
    ...
    private static class PaymentMethodCreditCardTypeCase extends InvoiceEventInvoiceEventPaymentMethod {
    ...
    private static class PaymentMethodExternalTypeCase extends InvoiceEventInvoiceEventPaymentMethod {
    ...
    private static class PaymentMethodPaypalTypeCase extends InvoiceEventInvoiceEventPaymentMethod {
    ...
    /**
     * This is a custom deserializer class for InvoiceEventInvoiceEventPaymentMethod.
     */
    protected static class InvoiceEventInvoiceEventPaymentMethodDeserializer
            extends JsonDeserializer<InvoiceEventInvoiceEventPaymentMethod> {

        @Override
        public InvoiceEventInvoiceEventPaymentMethod deserialize(JsonParser jp, DeserializationContext ctxt)
