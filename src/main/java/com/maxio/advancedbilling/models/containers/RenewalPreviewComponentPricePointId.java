 ...
 */
@JsonDeserialize(using = RenewalPreviewComponentPricePointId.RenewalPreviewComponentPricePointIdDeserializer.class)
public abstract class RenewalPreviewComponentPricePointId {
     ...
     */
    public static RenewalPreviewComponentPricePointId fromMString(String mString) {
    ...
    private static class MStringCase extends RenewalPreviewComponentPricePointId {
    ...
    private static class NumberCase extends RenewalPreviewComponentPricePointId {
    ...
    /**
     * This is a custom deserializer class for RenewalPreviewComponentPricePointId.
     */
    protected static class RenewalPreviewComponentPricePointIdDeserializer
            extends JsonDeserializer<RenewalPreviewComponentPricePointId> {

        @Override
        public RenewalPreviewComponentPricePointId deserialize(JsonParser jp, DeserializationContext ctxt)
