 ...
 */
@JsonDeserialize(using = SubscriptionComponentAllocatedQuantity.SubscriptionComponentAllocatedQuantityDeserializer.class)
public abstract class SubscriptionComponentAllocatedQuantity {
     ...
     */
    public static SubscriptionComponentAllocatedQuantity fromString(String string) {
    ...
    private static class NumberCase extends SubscriptionComponentAllocatedQuantity {
    ...
    private static class StringCase extends SubscriptionComponentAllocatedQuantity {
    ...
    /**
     * This is a custom deserializer class for SubscriptionComponentAllocatedQuantity.
     */
    protected static class SubscriptionComponentAllocatedQuantityDeserializer
            extends JsonDeserializer<SubscriptionComponentAllocatedQuantity> {

        @Override
        public SubscriptionComponentAllocatedQuantity deserialize(JsonParser jp, DeserializationContext ctxt)
