 ...
 */
@JsonDeserialize(using = EBBComponentPricingScheme.EBBComponentPricingSchemeDeserializer.class)
public abstract class EBBComponentPricingScheme {
     ...
     */
    public static EBBComponentPricingScheme fromPricingScheme(PricingScheme pricingScheme) {
    ...
    private static class PricingSchemeCase extends EBBComponentPricingScheme {
    ...
    /**
     * This is a custom deserializer class for EBBComponentPricingScheme.
     */
    protected static class EBBComponentPricingSchemeDeserializer
            extends JsonDeserializer<EBBComponentPricingScheme> {

        @Override
        public EBBComponentPricingScheme deserialize(JsonParser jp, DeserializationContext ctxt)
