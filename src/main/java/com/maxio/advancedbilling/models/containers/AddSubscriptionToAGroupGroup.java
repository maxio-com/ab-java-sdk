 ...
 */
@JsonDeserialize(using = AddSubscriptionToAGroupGroup.AddSubscriptionToAGroupGroupDeserializer.class)
public abstract class AddSubscriptionToAGroupGroup {
    ...
    private static class GroupSettingsCase extends AddSubscriptionToAGroupGroup {
    ...
    /**
     * This is a custom deserializer class for AddSubscriptionToAGroupGroup.
     */
    protected static class AddSubscriptionToAGroupGroupDeserializer
            extends JsonDeserializer<AddSubscriptionToAGroupGroup> {

        @Override
        public AddSubscriptionToAGroupGroup deserialize(JsonParser jp, DeserializationContext ctxt)
