 ...
 */
@JsonDeserialize(using = UpdatePriceStartingQuantity.UpdatePriceStartingQuantityDeserializer.class)
public abstract class UpdatePriceStartingQuantity {
     ...
     */
    public static UpdatePriceStartingQuantity fromString(String string) {
    ...
    private static class NumberCase extends UpdatePriceStartingQuantity {
    ...
    private static class StringCase extends UpdatePriceStartingQuantity {
    ...
    /**
     * This is a custom deserializer class for UpdatePriceStartingQuantity.
     */
    protected static class UpdatePriceStartingQuantityDeserializer
            extends JsonDeserializer<UpdatePriceStartingQuantity> {

        @Override
        public UpdatePriceStartingQuantity deserialize(JsonParser jp, DeserializationContext ctxt)
