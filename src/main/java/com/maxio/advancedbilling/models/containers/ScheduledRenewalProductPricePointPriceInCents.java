 ...
 */
@JsonDeserialize(using = ScheduledRenewalProductPricePointPriceInCents.ScheduledRenewalProductPricePointPriceInCentsDeserializer.class)
public abstract class ScheduledRenewalProductPricePointPriceInCents {
     ...
     */
    public static ScheduledRenewalProductPricePointPriceInCents fromString(String string) {
    ...
    private static class StringCase extends ScheduledRenewalProductPricePointPriceInCents {
    ...
    private static class LongCase extends ScheduledRenewalProductPricePointPriceInCents {
    ...
    /**
     * This is a custom deserializer class for ScheduledRenewalProductPricePointPriceInCents.
     */
    protected static class ScheduledRenewalProductPricePointPriceInCentsDeserializer
            extends JsonDeserializer<ScheduledRenewalProductPricePointPriceInCents> {

        @Override
        public ScheduledRenewalProductPricePointPriceInCents deserialize(JsonParser jp, DeserializationContext ctxt)
