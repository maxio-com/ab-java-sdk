 ...
 */
@JsonDeserialize(using = CreateSubscriptionOfferId.CreateSubscriptionOfferIdDeserializer.class)
public abstract class CreateSubscriptionOfferId {
     ...
     */
    public static CreateSubscriptionOfferId fromMString(String mString) {
    ...
    private static class MStringCase extends CreateSubscriptionOfferId {
    ...
    private static class NumberCase extends CreateSubscriptionOfferId {
    ...
    /**
     * This is a custom deserializer class for CreateSubscriptionOfferId.
     */
    protected static class CreateSubscriptionOfferIdDeserializer
            extends JsonDeserializer<CreateSubscriptionOfferId> {

        @Override
        public CreateSubscriptionOfferId deserialize(JsonParser jp, DeserializationContext ctxt)
