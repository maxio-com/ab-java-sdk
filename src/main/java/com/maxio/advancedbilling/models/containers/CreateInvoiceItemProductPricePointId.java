 ...
 */
@JsonDeserialize(using = CreateInvoiceItemProductPricePointId.CreateInvoiceItemProductPricePointIdDeserializer.class)
public abstract class CreateInvoiceItemProductPricePointId {
     ...
     */
    public static CreateInvoiceItemProductPricePointId fromMString(String mString) {
    ...
    private static class MStringCase extends CreateInvoiceItemProductPricePointId {
    ...
    private static class NumberCase extends CreateInvoiceItemProductPricePointId {
    ...
    /**
     * This is a custom deserializer class for CreateInvoiceItemProductPricePointId.
     */
    protected static class CreateInvoiceItemProductPricePointIdDeserializer
            extends JsonDeserializer<CreateInvoiceItemProductPricePointId> {

        @Override
        public CreateInvoiceItemProductPricePointId deserialize(JsonParser jp, DeserializationContext ctxt)
