...
public abstract class CreateInvoiceItemProductPricePointId {
     ...
     */
    public static CreateInvoiceItemProductPricePointId fromString(String string) {
    ...
    private static class StringCase extends CreateInvoiceItemProductPricePointId {
