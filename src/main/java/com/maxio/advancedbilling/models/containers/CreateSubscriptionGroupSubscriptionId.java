 ...
 */
@JsonDeserialize(using = CreateSubscriptionGroupSubscriptionId.CreateSubscriptionGroupSubscriptionIdDeserializer.class)
public abstract class CreateSubscriptionGroupSubscriptionId {
     ...
     */
    public static CreateSubscriptionGroupSubscriptionId fromMString(String mString) {
    ...
    private static class MStringCase extends CreateSubscriptionGroupSubscriptionId {
    ...
    private static class NumberCase extends CreateSubscriptionGroupSubscriptionId {
    ...
    /**
     * This is a custom deserializer class for CreateSubscriptionGroupSubscriptionId.
     */
    protected static class CreateSubscriptionGroupSubscriptionIdDeserializer
            extends JsonDeserializer<CreateSubscriptionGroupSubscriptionId> {

        @Override
        public CreateSubscriptionGroupSubscriptionId deserialize(JsonParser jp, DeserializationContext ctxt)
