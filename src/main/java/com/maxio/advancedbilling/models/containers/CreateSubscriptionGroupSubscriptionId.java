...
public abstract class CreateSubscriptionGroupSubscriptionId {
     ...
     */
    public static CreateSubscriptionGroupSubscriptionId fromString(String string) {
    ...
    private static class StringCase extends CreateSubscriptionGroupSubscriptionId {
