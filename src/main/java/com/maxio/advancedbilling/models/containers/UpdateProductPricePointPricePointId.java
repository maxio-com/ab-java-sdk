 ...
 */
@JsonDeserialize(using = UpdateProductPricePointPricePointId.UpdateProductPricePointPricePointIdDeserializer.class)
public abstract class UpdateProductPricePointPricePointId {
     ...
     */
    public static UpdateProductPricePointPricePointId fromString(String string) {
    ...
    private static class NumberCase extends UpdateProductPricePointPricePointId {
    ...
    private static class StringCase extends UpdateProductPricePointPricePointId {
    ...
    /**
     * This is a custom deserializer class for UpdateProductPricePointPricePointId.
     */
    protected static class UpdateProductPricePointPricePointIdDeserializer
            extends JsonDeserializer<UpdateProductPricePointPricePointId> {

        @Override
        public UpdateProductPricePointPricePointId deserialize(JsonParser jp, DeserializationContext ctxt)
