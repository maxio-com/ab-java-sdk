 ...
 */
@JsonDeserialize(using = CreateUsageSubscriptionIdOrReference.CreateUsageSubscriptionIdOrReferenceDeserializer.class)
public abstract class CreateUsageSubscriptionIdOrReference {
     ...
     */
    public static CreateUsageSubscriptionIdOrReference fromString(String string) {
    ...
    private static class NumberCase extends CreateUsageSubscriptionIdOrReference {
    ...
    private static class StringCase extends CreateUsageSubscriptionIdOrReference {
    ...
    /**
     * This is a custom deserializer class for CreateUsageSubscriptionIdOrReference.
     */
    protected static class CreateUsageSubscriptionIdOrReferenceDeserializer
            extends JsonDeserializer<CreateUsageSubscriptionIdOrReference> {

        @Override
        public CreateUsageSubscriptionIdOrReference deserialize(JsonParser jp, DeserializationContext ctxt)
