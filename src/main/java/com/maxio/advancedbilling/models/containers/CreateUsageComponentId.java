 ...
 */
@JsonDeserialize(using = CreateUsageComponentId.CreateUsageComponentIdDeserializer.class)
public abstract class CreateUsageComponentId {
     ...
     */
    public static CreateUsageComponentId fromString(String string) {
    ...
    private static class NumberCase extends CreateUsageComponentId {
    ...
    private static class StringCase extends CreateUsageComponentId {
    ...
    /**
     * This is a custom deserializer class for CreateUsageComponentId.
     */
    protected static class CreateUsageComponentIdDeserializer
            extends JsonDeserializer<CreateUsageComponentId> {

        @Override
        public CreateUsageComponentId deserialize(JsonParser jp, DeserializationContext ctxt)
