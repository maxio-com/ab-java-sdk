 ...
 */
@JsonDeserialize(using = UpdateInvoiceItemQuantity.UpdateInvoiceItemQuantityDeserializer.class)
public abstract class UpdateInvoiceItemQuantity {
     ...
     */
    public static UpdateInvoiceItemQuantity fromString(String string) {
    ...
    private static class PrecisionCase extends UpdateInvoiceItemQuantity {
    ...
    private static class StringCase extends UpdateInvoiceItemQuantity {
    ...
    /**
     * This is a custom deserializer class for UpdateInvoiceItemQuantity.
     */
    protected static class UpdateInvoiceItemQuantityDeserializer
            extends JsonDeserializer<UpdateInvoiceItemQuantity> {

        @Override
        public UpdateInvoiceItemQuantity deserialize(JsonParser jp, DeserializationContext ctxt)
