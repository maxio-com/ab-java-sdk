 ...
 */
@JsonDeserialize(using = CreateCouponBody.CreateCouponBodyDeserializer.class)
public abstract class CreateCouponBody {
     ...
     */
    public static CreateCouponBody fromCreateOrUpdateCoupon(
    ...
    private static class CreateOrUpdateCouponCase extends CreateCouponBody {
    ...
    /**
     * This is a custom deserializer class for CreateCouponBody.
     */
    protected static class CreateCouponBodyDeserializer
            extends JsonDeserializer<CreateCouponBody> {

        @Override
        public CreateCouponBody deserialize(JsonParser jp, DeserializationContext ctxt)
