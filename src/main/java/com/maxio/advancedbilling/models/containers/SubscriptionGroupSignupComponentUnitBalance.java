 ...
 */
@JsonDeserialize(using = SubscriptionGroupSignupComponentUnitBalance.SubscriptionGroupSignupComponentUnitBalanceDeserializer.class)
public abstract class SubscriptionGroupSignupComponentUnitBalance {
     ...
     */
    public static SubscriptionGroupSignupComponentUnitBalance fromMString(String mString) {
    ...
    private static class MStringCase extends SubscriptionGroupSignupComponentUnitBalance {
    ...
    private static class NumberCase extends SubscriptionGroupSignupComponentUnitBalance {
    ...
    /**
     * This is a custom deserializer class for SubscriptionGroupSignupComponentUnitBalance.
     */
    protected static class SubscriptionGroupSignupComponentUnitBalanceDeserializer
            extends JsonDeserializer<SubscriptionGroupSignupComponentUnitBalance> {

        @Override
        public SubscriptionGroupSignupComponentUnitBalance deserialize(JsonParser jp, DeserializationContext ctxt)
