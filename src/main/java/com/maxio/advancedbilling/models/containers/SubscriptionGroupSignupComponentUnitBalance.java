...
public abstract class SubscriptionGroupSignupComponentUnitBalance {
     ...
     */
    public static SubscriptionGroupSignupComponentUnitBalance fromString(String string) {
    ...
    private static class StringCase extends SubscriptionGroupSignupComponentUnitBalance {
