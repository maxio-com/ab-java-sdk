 ...
 */
@JsonDeserialize(using = CreateInvoiceCouponProductFamilyId.CreateInvoiceCouponProductFamilyIdDeserializer.class)
public abstract class CreateInvoiceCouponProductFamilyId {
     ...
     */
    public static CreateInvoiceCouponProductFamilyId fromMString(String mString) {
    ...
    private static class MStringCase extends CreateInvoiceCouponProductFamilyId {
    ...
    private static class NumberCase extends CreateInvoiceCouponProductFamilyId {
    ...
    /**
     * This is a custom deserializer class for CreateInvoiceCouponProductFamilyId.
     */
    protected static class CreateInvoiceCouponProductFamilyIdDeserializer
            extends JsonDeserializer<CreateInvoiceCouponProductFamilyId> {

        @Override
        public CreateInvoiceCouponProductFamilyId deserialize(JsonParser jp, DeserializationContext ctxt)
