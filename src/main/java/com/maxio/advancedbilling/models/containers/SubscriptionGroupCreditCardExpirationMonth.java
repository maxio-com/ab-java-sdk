 ...
 */
@JsonDeserialize(using = SubscriptionGroupCreditCardExpirationMonth.SubscriptionGroupCreditCardExpirationMonthDeserializer.class)
public abstract class SubscriptionGroupCreditCardExpirationMonth {
     ...
     */
    public static SubscriptionGroupCreditCardExpirationMonth fromMString(String mString) {
    ...
    private static class MStringCase extends SubscriptionGroupCreditCardExpirationMonth {
    ...
    private static class NumberCase extends SubscriptionGroupCreditCardExpirationMonth {
    ...
    /**
     * This is a custom deserializer class for SubscriptionGroupCreditCardExpirationMonth.
     */
    protected static class SubscriptionGroupCreditCardExpirationMonthDeserializer
            extends JsonDeserializer<SubscriptionGroupCreditCardExpirationMonth> {

        @Override
        public SubscriptionGroupCreditCardExpirationMonth deserialize(JsonParser jp, DeserializationContext ctxt)
