...
public abstract class SubscriptionGroupCreditCardExpirationMonth {
     ...
     */
    public static SubscriptionGroupCreditCardExpirationMonth fromString(String string) {
    ...
    private static class StringCase extends SubscriptionGroupCreditCardExpirationMonth {
