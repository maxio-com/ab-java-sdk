 ...
 */
@JsonDeserialize(using = ArchiveComponentPricePointPricePointId.ArchiveComponentPricePointPricePointIdDeserializer.class)
public abstract class ArchiveComponentPricePointPricePointId {
     ...
     */
    public static ArchiveComponentPricePointPricePointId fromString(String string) {
    ...
    private static class NumberCase extends ArchiveComponentPricePointPricePointId {
    ...
    private static class StringCase extends ArchiveComponentPricePointPricePointId {
    ...
    /**
     * This is a custom deserializer class for ArchiveComponentPricePointPricePointId.
     */
    protected static class ArchiveComponentPricePointPricePointIdDeserializer
            extends JsonDeserializer<ArchiveComponentPricePointPricePointId> {

        @Override
        public ArchiveComponentPricePointPricePointId deserialize(JsonParser jp, DeserializationContext ctxt)
