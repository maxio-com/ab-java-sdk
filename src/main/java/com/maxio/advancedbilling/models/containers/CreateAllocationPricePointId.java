 ...
 */
@JsonDeserialize(using = CreateAllocationPricePointId.CreateAllocationPricePointIdDeserializer.class)
public abstract class CreateAllocationPricePointId {
     ...
     */
    public static CreateAllocationPricePointId fromMString(String mString) {
    ...
    private static class MStringCase extends CreateAllocationPricePointId {
    ...
    private static class NumberCase extends CreateAllocationPricePointId {
    ...
    /**
     * This is a custom deserializer class for CreateAllocationPricePointId.
     */
    protected static class CreateAllocationPricePointIdDeserializer
            extends JsonDeserializer<CreateAllocationPricePointId> {

        @Override
        public CreateAllocationPricePointId deserialize(JsonParser jp, DeserializationContext ctxt)
