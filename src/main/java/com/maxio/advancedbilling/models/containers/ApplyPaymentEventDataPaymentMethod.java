 ...
 */
@JsonDeserialize(using = ApplyPaymentEventDataPaymentMethod.ApplyPaymentEventDataPaymentMethodDeserializer.class)
public abstract class ApplyPaymentEventDataPaymentMethod {
     ...
     */
    public static ApplyPaymentEventDataPaymentMethod fromPaymentMethodApplePayType(
     ...
     */
    public static ApplyPaymentEventDataPaymentMethod fromPaymentMethodBankAccountType(
     ...
     */
    public static ApplyPaymentEventDataPaymentMethod fromPaymentMethodCreditCardType(
     ...
     */
    public static ApplyPaymentEventDataPaymentMethod fromPaymentMethodExternalType(
     ...
     */
    public static ApplyPaymentEventDataPaymentMethod fromPaymentMethodPaypalType(
    ...
    private static class PaymentMethodApplePayTypeCase extends ApplyPaymentEventDataPaymentMethod {
    ...
    private static class PaymentMethodBankAccountTypeCase extends ApplyPaymentEventDataPaymentMethod {
    ...
    private static class PaymentMethodCreditCardTypeCase extends ApplyPaymentEventDataPaymentMethod {
    ...
    private static class PaymentMethodExternalTypeCase extends ApplyPaymentEventDataPaymentMethod {
    ...
    private static class PaymentMethodPaypalTypeCase extends ApplyPaymentEventDataPaymentMethod {
    ...
    /**
     * This is a custom deserializer class for ApplyPaymentEventDataPaymentMethod.
     */
    protected static class ApplyPaymentEventDataPaymentMethodDeserializer
            extends JsonDeserializer<ApplyPaymentEventDataPaymentMethod> {

        @Override
        public ApplyPaymentEventDataPaymentMethod deserialize(JsonParser jp, DeserializationContext ctxt)
