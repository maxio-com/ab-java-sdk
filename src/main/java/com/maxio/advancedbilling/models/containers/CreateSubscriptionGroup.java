 ...
 */
@JsonDeserialize(using = CreateSubscriptionGroup.CreateSubscriptionGroupDeserializer.class)
public abstract class CreateSubscriptionGroup {
     ...
     */
    public static CreateSubscriptionGroup fromGroupSettings(GroupSettings groupSettings) {
     ...
     */
    public static CreateSubscriptionGroup fromMBoolean(boolean mBoolean) {
    ...
    private static class GroupSettingsCase extends CreateSubscriptionGroup {
    ...
    private static class MBooleanCase extends CreateSubscriptionGroup {
    ...
    /**
     * This is a custom deserializer class for CreateSubscriptionGroup.
     */
    protected static class CreateSubscriptionGroupDeserializer
            extends JsonDeserializer<CreateSubscriptionGroup> {

        @Override
        public CreateSubscriptionGroup deserialize(JsonParser jp, DeserializationContext ctxt)
