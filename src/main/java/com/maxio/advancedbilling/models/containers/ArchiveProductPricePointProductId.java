 ...
 */
@JsonDeserialize(using = ArchiveProductPricePointProductId.ArchiveProductPricePointProductIdDeserializer.class)
public abstract class ArchiveProductPricePointProductId {
     ...
     */
    public static ArchiveProductPricePointProductId fromString(String string) {
    ...
    private static class NumberCase extends ArchiveProductPricePointProductId {
    ...
    private static class StringCase extends ArchiveProductPricePointProductId {
    ...
    /**
     * This is a custom deserializer class for ArchiveProductPricePointProductId.
     */
    protected static class ArchiveProductPricePointProductIdDeserializer
            extends JsonDeserializer<ArchiveProductPricePointProductId> {

        @Override
        public ArchiveProductPricePointProductId deserialize(JsonParser jp, DeserializationContext ctxt)
