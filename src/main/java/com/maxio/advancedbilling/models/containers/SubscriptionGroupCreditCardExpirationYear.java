...
public abstract class SubscriptionGroupCreditCardExpirationYear {
     ...
     */
    public static SubscriptionGroupCreditCardExpirationYear fromString(String string) {
    ...
    private static class StringCase extends SubscriptionGroupCreditCardExpirationYear {
