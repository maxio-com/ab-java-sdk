 ...
 */
@JsonDeserialize(using = SubscriptionGroupCreditCardExpirationYear.SubscriptionGroupCreditCardExpirationYearDeserializer.class)
public abstract class SubscriptionGroupCreditCardExpirationYear {
     ...
     */
    public static SubscriptionGroupCreditCardExpirationYear fromMString(String mString) {
    ...
    private static class MStringCase extends SubscriptionGroupCreditCardExpirationYear {
    ...
    private static class NumberCase extends SubscriptionGroupCreditCardExpirationYear {
    ...
    /**
     * This is a custom deserializer class for SubscriptionGroupCreditCardExpirationYear.
     */
    protected static class SubscriptionGroupCreditCardExpirationYearDeserializer
            extends JsonDeserializer<SubscriptionGroupCreditCardExpirationYear> {

        @Override
        public SubscriptionGroupCreditCardExpirationYear deserialize(JsonParser jp, DeserializationContext ctxt)
