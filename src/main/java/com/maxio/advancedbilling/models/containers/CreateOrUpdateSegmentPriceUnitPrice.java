 ...
 */
@JsonDeserialize(using = CreateOrUpdateSegmentPriceUnitPrice.CreateOrUpdateSegmentPriceUnitPriceDeserializer.class)
public abstract class CreateOrUpdateSegmentPriceUnitPrice {
     ...
     */
    public static CreateOrUpdateSegmentPriceUnitPrice fromMString(String mString) {
    ...
    private static class MStringCase extends CreateOrUpdateSegmentPriceUnitPrice {
    ...
    private static class PrecisionCase extends CreateOrUpdateSegmentPriceUnitPrice {
    ...
    /**
     * This is a custom deserializer class for CreateOrUpdateSegmentPriceUnitPrice.
     */
    protected static class CreateOrUpdateSegmentPriceUnitPriceDeserializer
            extends JsonDeserializer<CreateOrUpdateSegmentPriceUnitPrice> {

        @Override
        public CreateOrUpdateSegmentPriceUnitPrice deserialize(JsonParser jp, DeserializationContext ctxt)
