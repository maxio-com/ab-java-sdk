 ...
 */
@JsonDeserialize(using = EBBComponentUnitPrice.EBBComponentUnitPriceDeserializer.class)
public abstract class EBBComponentUnitPrice {
     ...
     */
    public static EBBComponentUnitPrice fromMString(String mString) {
    ...
    private static class MStringCase extends EBBComponentUnitPrice {
    ...
    private static class PrecisionCase extends EBBComponentUnitPrice {
    ...
    /**
     * This is a custom deserializer class for EBBComponentUnitPrice.
     */
    protected static class EBBComponentUnitPriceDeserializer
            extends JsonDeserializer<EBBComponentUnitPrice> {

        @Override
        public EBBComponentUnitPrice deserialize(JsonParser jp, DeserializationContext ctxt)
