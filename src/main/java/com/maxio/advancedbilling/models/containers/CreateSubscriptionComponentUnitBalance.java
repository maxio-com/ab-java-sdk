 ...
 */
@JsonDeserialize(using = CreateSubscriptionComponentUnitBalance.CreateSubscriptionComponentUnitBalanceDeserializer.class)
public abstract class CreateSubscriptionComponentUnitBalance {
     ...
     */
    public static CreateSubscriptionComponentUnitBalance fromString(String string) {
    ...
    private static class NumberCase extends CreateSubscriptionComponentUnitBalance {
    ...
    private static class StringCase extends CreateSubscriptionComponentUnitBalance {
    ...
    /**
     * This is a custom deserializer class for CreateSubscriptionComponentUnitBalance.
     */
    protected static class CreateSubscriptionComponentUnitBalanceDeserializer
            extends JsonDeserializer<CreateSubscriptionComponentUnitBalance> {

        @Override
        public CreateSubscriptionComponentUnitBalance deserialize(JsonParser jp, DeserializationContext ctxt)
