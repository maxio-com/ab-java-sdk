 ...
 */
@JsonDeserialize(using = CreateSubscriptionComponentComponentId.CreateSubscriptionComponentComponentIdDeserializer.class)
public abstract class CreateSubscriptionComponentComponentId {
     ...
     */
    public static CreateSubscriptionComponentComponentId fromMString(String mString) {
    ...
    private static class NumberCase extends CreateSubscriptionComponentComponentId {
    ...
    private static class MStringCase extends CreateSubscriptionComponentComponentId {
    ...
    /**
     * This is a custom deserializer class for CreateSubscriptionComponentComponentId.
     */
    protected static class CreateSubscriptionComponentComponentIdDeserializer
            extends JsonDeserializer<CreateSubscriptionComponentComponentId> {

        @Override
        public CreateSubscriptionComponentComponentId deserialize(JsonParser jp, DeserializationContext ctxt)
