...
public abstract class CreateSubscriptionComponentComponentId {
     ...
     */
    public static CreateSubscriptionComponentComponentId fromString(String string) {
    ...
    private static class StringCase extends CreateSubscriptionComponentComponentId {
