 ...
 */
@JsonDeserialize(using = RenewalPreviewComponentComponentId.RenewalPreviewComponentComponentIdDeserializer.class)
public abstract class RenewalPreviewComponentComponentId {
     ...
     */
    public static RenewalPreviewComponentComponentId fromMString(String mString) {
    ...
    private static class MStringCase extends RenewalPreviewComponentComponentId {
    ...
    private static class NumberCase extends RenewalPreviewComponentComponentId {
    ...
    /**
     * This is a custom deserializer class for RenewalPreviewComponentComponentId.
     */
    protected static class RenewalPreviewComponentComponentIdDeserializer
            extends JsonDeserializer<RenewalPreviewComponentComponentId> {

        @Override
        public RenewalPreviewComponentComponentId deserialize(JsonParser jp, DeserializationContext ctxt)
