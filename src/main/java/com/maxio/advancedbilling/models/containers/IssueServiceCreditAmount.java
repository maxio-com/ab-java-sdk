 ...
 */
@JsonDeserialize(using = IssueServiceCreditAmount.IssueServiceCreditAmountDeserializer.class)
public abstract class IssueServiceCreditAmount {
     ...
     */
    public static IssueServiceCreditAmount fromMString(String mString) {
    ...
    private static class PrecisionCase extends IssueServiceCreditAmount {
    ...
    private static class MStringCase extends IssueServiceCreditAmount {
    ...
    /**
     * This is a custom deserializer class for IssueServiceCreditAmount.
     */
    protected static class IssueServiceCreditAmountDeserializer
            extends JsonDeserializer<IssueServiceCreditAmount> {

        @Override
        public IssueServiceCreditAmount deserialize(JsonParser jp, DeserializationContext ctxt)
