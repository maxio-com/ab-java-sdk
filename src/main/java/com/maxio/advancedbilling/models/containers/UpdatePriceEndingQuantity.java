 ...
 */
@JsonDeserialize(using = UpdatePriceEndingQuantity.UpdatePriceEndingQuantityDeserializer.class)
public abstract class UpdatePriceEndingQuantity {
     ...
     */
    public static UpdatePriceEndingQuantity fromString(String string) {
    ...
    private static class NumberCase extends UpdatePriceEndingQuantity {
    ...
    private static class StringCase extends UpdatePriceEndingQuantity {
    ...
    /**
     * This is a custom deserializer class for UpdatePriceEndingQuantity.
     */
    protected static class UpdatePriceEndingQuantityDeserializer
            extends JsonDeserializer<UpdatePriceEndingQuantity> {

        @Override
        public UpdatePriceEndingQuantity deserialize(JsonParser jp, DeserializationContext ctxt)
