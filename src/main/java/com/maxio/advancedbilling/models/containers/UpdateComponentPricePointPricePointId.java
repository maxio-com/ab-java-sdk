 ...
 */
@JsonDeserialize(using = UpdateComponentPricePointPricePointId.UpdateComponentPricePointPricePointIdDeserializer.class)
public abstract class UpdateComponentPricePointPricePointId {
     ...
     */
    public static UpdateComponentPricePointPricePointId fromString(String string) {
    ...
    private static class NumberCase extends UpdateComponentPricePointPricePointId {
    ...
    private static class StringCase extends UpdateComponentPricePointPricePointId {
    ...
    /**
     * This is a custom deserializer class for UpdateComponentPricePointPricePointId.
     */
    protected static class UpdateComponentPricePointPricePointIdDeserializer
            extends JsonDeserializer<UpdateComponentPricePointPricePointId> {

        @Override
        public UpdateComponentPricePointPricePointId deserialize(JsonParser jp, DeserializationContext ctxt)
