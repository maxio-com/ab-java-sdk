 ...
 */
@JsonDeserialize(using = UpdateComponentPricePointComponentId.UpdateComponentPricePointComponentIdDeserializer.class)
public abstract class UpdateComponentPricePointComponentId {
     ...
     */
    public static UpdateComponentPricePointComponentId fromString(String string) {
    ...
    private static class NumberCase extends UpdateComponentPricePointComponentId {
    ...
    private static class StringCase extends UpdateComponentPricePointComponentId {
    ...
    /**
     * This is a custom deserializer class for UpdateComponentPricePointComponentId.
     */
    protected static class UpdateComponentPricePointComponentIdDeserializer
            extends JsonDeserializer<UpdateComponentPricePointComponentId> {

        @Override
        public UpdateComponentPricePointComponentId deserialize(JsonParser jp, DeserializationContext ctxt)
