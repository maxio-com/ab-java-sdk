 ...
 */
@JsonDeserialize(using = PriceStartingQuantity.PriceStartingQuantityDeserializer.class)
public abstract class PriceStartingQuantity {
     ...
     */
    public static PriceStartingQuantity fromMString(String mString) {
    ...
    private static class NumberCase extends PriceStartingQuantity {
    ...
    private static class MStringCase extends PriceStartingQuantity {
    ...
    /**
     * This is a custom deserializer class for PriceStartingQuantity.
     */
    protected static class PriceStartingQuantityDeserializer
            extends JsonDeserializer<PriceStartingQuantity> {

        @Override
        public PriceStartingQuantity deserialize(JsonParser jp, DeserializationContext ctxt)
