...
public abstract class CreateSegmentSegmentProperty1Value {
     ...
     */
    public static CreateSegmentSegmentProperty1Value fromString(String string) {
     ...
     */
    public static CreateSegmentSegmentProperty1Value fromBoolean(boolean mBoolean) {
    ...
    private static class StringCase extends CreateSegmentSegmentProperty1Value {
    ...
    private static class BooleanCase extends CreateSegmentSegmentProperty1Value {
