 ...
 */
@JsonDeserialize(using = CreateSegmentSegmentProperty1Value.CreateSegmentSegmentProperty1ValueDeserializer.class)
public abstract class CreateSegmentSegmentProperty1Value {
     ...
     */
    public static CreateSegmentSegmentProperty1Value fromMString(String mString) {
     ...
     */
    public static CreateSegmentSegmentProperty1Value fromMBoolean(boolean mBoolean) {
    ...
    private static class MStringCase extends CreateSegmentSegmentProperty1Value {
    ...
    private static class PrecisionCase extends CreateSegmentSegmentProperty1Value {
    ...
    private static class NumberCase extends CreateSegmentSegmentProperty1Value {
    ...
    private static class MBooleanCase extends CreateSegmentSegmentProperty1Value {
    ...
    /**
     * This is a custom deserializer class for CreateSegmentSegmentProperty1Value.
     */
    protected static class CreateSegmentSegmentProperty1ValueDeserializer
            extends JsonDeserializer<CreateSegmentSegmentProperty1Value> {

        @Override
        public CreateSegmentSegmentProperty1Value deserialize(JsonParser jp, DeserializationContext ctxt)
