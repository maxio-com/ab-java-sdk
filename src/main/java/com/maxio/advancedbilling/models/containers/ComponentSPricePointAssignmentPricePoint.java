...
public abstract class ComponentSPricePointAssignmentPricePoint {
     ...
     */
    public static ComponentSPricePointAssignmentPricePoint fromMString(String mString) {
    ...
    private static class MStringCase extends ComponentSPricePointAssignmentPricePoint {
