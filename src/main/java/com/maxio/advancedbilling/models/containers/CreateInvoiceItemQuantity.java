 ...
 */
@JsonDeserialize(using = CreateInvoiceItemQuantity.CreateInvoiceItemQuantityDeserializer.class)
public abstract class CreateInvoiceItemQuantity {
     ...
     */
    public static CreateInvoiceItemQuantity fromMString(String mString) {
    ...
    private static class PrecisionCase extends CreateInvoiceItemQuantity {
    ...
    private static class MStringCase extends CreateInvoiceItemQuantity {
    ...
    /**
     * This is a custom deserializer class for CreateInvoiceItemQuantity.
     */
    protected static class CreateInvoiceItemQuantityDeserializer
            extends JsonDeserializer<CreateInvoiceItemQuantity> {

        @Override
        public CreateInvoiceItemQuantity deserialize(JsonParser jp, DeserializationContext ctxt)
