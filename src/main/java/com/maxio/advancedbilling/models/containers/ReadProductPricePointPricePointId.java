 ...
 */
@JsonDeserialize(using = ReadProductPricePointPricePointId.ReadProductPricePointPricePointIdDeserializer.class)
public abstract class ReadProductPricePointPricePointId {
     ...
     */
    public static ReadProductPricePointPricePointId fromString(String string) {
    ...
    private static class NumberCase extends ReadProductPricePointPricePointId {
    ...
    private static class StringCase extends ReadProductPricePointPricePointId {
    ...
    /**
     * This is a custom deserializer class for ReadProductPricePointPricePointId.
     */
    protected static class ReadProductPricePointPricePointIdDeserializer
            extends JsonDeserializer<ReadProductPricePointPricePointId> {

        @Override
        public ReadProductPricePointPricePointId deserialize(JsonParser jp, DeserializationContext ctxt)
