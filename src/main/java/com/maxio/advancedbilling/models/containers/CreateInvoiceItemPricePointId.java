 ...
 */
@JsonDeserialize(using = CreateInvoiceItemPricePointId.CreateInvoiceItemPricePointIdDeserializer.class)
public abstract class CreateInvoiceItemPricePointId {
    ...
    private static class NumberCase extends CreateInvoiceItemPricePointId {
    ...
    /**
     * This is a custom deserializer class for CreateInvoiceItemPricePointId.
     */
    protected static class CreateInvoiceItemPricePointIdDeserializer
            extends JsonDeserializer<CreateInvoiceItemPricePointId> {

        @Override
        public CreateInvoiceItemPricePointId deserialize(JsonParser jp, DeserializationContext ctxt)
