 ...
 */
@JsonDeserialize(using = SubscriptionGroupSignupComponentComponentId.SubscriptionGroupSignupComponentComponentIdDeserializer.class)
public abstract class SubscriptionGroupSignupComponentComponentId {
     ...
     */
    public static SubscriptionGroupSignupComponentComponentId fromMString(String mString) {
    ...
    private static class MStringCase extends SubscriptionGroupSignupComponentComponentId {
    ...
    private static class NumberCase extends SubscriptionGroupSignupComponentComponentId {
    ...
    /**
     * This is a custom deserializer class for SubscriptionGroupSignupComponentComponentId.
     */
    protected static class SubscriptionGroupSignupComponentComponentIdDeserializer
            extends JsonDeserializer<SubscriptionGroupSignupComponentComponentId> {

        @Override
        public SubscriptionGroupSignupComponentComponentId deserialize(JsonParser jp, DeserializationContext ctxt)
