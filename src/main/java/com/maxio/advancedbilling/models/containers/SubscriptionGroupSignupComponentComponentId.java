...
public abstract class SubscriptionGroupSignupComponentComponentId {
     ...
     */
    public static SubscriptionGroupSignupComponentComponentId fromString(String string) {
    ...
    private static class StringCase extends SubscriptionGroupSignupComponentComponentId {
