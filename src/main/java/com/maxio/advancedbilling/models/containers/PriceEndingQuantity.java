 ...
 */
@JsonDeserialize(using = PriceEndingQuantity.PriceEndingQuantityDeserializer.class)
public abstract class PriceEndingQuantity {
     ...
     */
    public static PriceEndingQuantity fromMString(String mString) {
    ...
    private static class NumberCase extends PriceEndingQuantity {
    ...
    private static class MStringCase extends PriceEndingQuantity {
    ...
    /**
     * This is a custom deserializer class for PriceEndingQuantity.
     */
    protected static class PriceEndingQuantityDeserializer
            extends JsonDeserializer<PriceEndingQuantity> {

        @Override
        public PriceEndingQuantity deserialize(JsonParser jp, DeserializationContext ctxt)
