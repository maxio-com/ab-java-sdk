 ...
 */
@JsonDeserialize(using = CreateInvoicePaymentAmount.CreateInvoicePaymentAmountDeserializer.class)
public abstract class CreateInvoicePaymentAmount {
     ...
     */
    public static CreateInvoicePaymentAmount fromMString(String mString) {
    ...
    private static class MStringCase extends CreateInvoicePaymentAmount {
    ...
    private static class PrecisionCase extends CreateInvoicePaymentAmount {
    ...
    /**
     * This is a custom deserializer class for CreateInvoicePaymentAmount.
     */
    protected static class CreateInvoicePaymentAmountDeserializer
            extends JsonDeserializer<CreateInvoicePaymentAmount> {

        @Override
        public CreateInvoicePaymentAmount deserialize(JsonParser jp, DeserializationContext ctxt)
