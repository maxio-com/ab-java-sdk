...
public abstract class CreateSegmentSegmentProperty4Value {
     ...
     */
    public static CreateSegmentSegmentProperty4Value fromString(String string) {
     ...
     */
    public static CreateSegmentSegmentProperty4Value fromBoolean(boolean mBoolean) {
    ...
    private static class StringCase extends CreateSegmentSegmentProperty4Value {
    ...
    private static class BooleanCase extends CreateSegmentSegmentProperty4Value {
