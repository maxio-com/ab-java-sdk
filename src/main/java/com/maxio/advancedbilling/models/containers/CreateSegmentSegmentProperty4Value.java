 ...
 */
@JsonDeserialize(using = CreateSegmentSegmentProperty4Value.CreateSegmentSegmentProperty4ValueDeserializer.class)
public abstract class CreateSegmentSegmentProperty4Value {
     ...
     */
    public static CreateSegmentSegmentProperty4Value fromMString(String mString) {
     ...
     */
    public static CreateSegmentSegmentProperty4Value fromMBoolean(boolean mBoolean) {
    ...
    private static class MStringCase extends CreateSegmentSegmentProperty4Value {
    ...
    private static class PrecisionCase extends CreateSegmentSegmentProperty4Value {
    ...
    private static class NumberCase extends CreateSegmentSegmentProperty4Value {
    ...
    private static class MBooleanCase extends CreateSegmentSegmentProperty4Value {
    ...
    /**
     * This is a custom deserializer class for CreateSegmentSegmentProperty4Value.
     */
    protected static class CreateSegmentSegmentProperty4ValueDeserializer
            extends JsonDeserializer<CreateSegmentSegmentProperty4Value> {

        @Override
        public CreateSegmentSegmentProperty4Value deserialize(JsonParser jp, DeserializationContext ctxt)
