 ...
 */
@JsonDeserialize(using = MeteredUsageNewUnitBalance.MeteredUsageNewUnitBalanceDeserializer.class)
public abstract class MeteredUsageNewUnitBalance {
     ...
     */
    public static MeteredUsageNewUnitBalance fromString(String string) {
    ...
    private static class NumberCase extends MeteredUsageNewUnitBalance {
    ...
    private static class StringCase extends MeteredUsageNewUnitBalance {
    ...
    /**
     * This is a custom deserializer class for MeteredUsageNewUnitBalance.
     */
    protected static class MeteredUsageNewUnitBalanceDeserializer
            extends JsonDeserializer<MeteredUsageNewUnitBalance> {

        @Override
        public MeteredUsageNewUnitBalance deserialize(JsonParser jp, DeserializationContext ctxt)
