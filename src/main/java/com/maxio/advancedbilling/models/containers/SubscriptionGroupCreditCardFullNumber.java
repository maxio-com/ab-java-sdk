 ...
 */
@JsonDeserialize(using = SubscriptionGroupCreditCardFullNumber.SubscriptionGroupCreditCardFullNumberDeserializer.class)
public abstract class SubscriptionGroupCreditCardFullNumber {
     ...
     */
    public static SubscriptionGroupCreditCardFullNumber fromMString(String mString) {
    ...
    private static class MStringCase extends SubscriptionGroupCreditCardFullNumber {
    ...
    private static class NumberCase extends SubscriptionGroupCreditCardFullNumber {
    ...
    /**
     * This is a custom deserializer class for SubscriptionGroupCreditCardFullNumber.
     */
    protected static class SubscriptionGroupCreditCardFullNumberDeserializer
            extends JsonDeserializer<SubscriptionGroupCreditCardFullNumber> {

        @Override
        public SubscriptionGroupCreditCardFullNumber deserialize(JsonParser jp, DeserializationContext ctxt)
