...
public abstract class SubscriptionGroupCreditCardFullNumber {
     ...
     */
    public static SubscriptionGroupCreditCardFullNumber fromString(String string) {
    ...
    private static class StringCase extends SubscriptionGroupCreditCardFullNumber {
