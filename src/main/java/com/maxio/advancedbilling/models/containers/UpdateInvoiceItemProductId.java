 ...
 */
@JsonDeserialize(using = UpdateInvoiceItemProductId.UpdateInvoiceItemProductIdDeserializer.class)
public abstract class UpdateInvoiceItemProductId {
     ...
     */
    public static UpdateInvoiceItemProductId fromString(String string) {
    ...
    private static class StringCase extends UpdateInvoiceItemProductId {
    ...
    private static class NumberCase extends UpdateInvoiceItemProductId {
    ...
    /**
     * This is a custom deserializer class for UpdateInvoiceItemProductId.
     */
    protected static class UpdateInvoiceItemProductIdDeserializer
            extends JsonDeserializer<UpdateInvoiceItemProductId> {

        @Override
        public UpdateInvoiceItemProductId deserialize(JsonParser jp, DeserializationContext ctxt)
