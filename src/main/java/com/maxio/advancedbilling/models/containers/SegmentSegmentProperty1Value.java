 ...
 */
@JsonDeserialize(using = SegmentSegmentProperty1Value.SegmentSegmentProperty1ValueDeserializer.class)
public abstract class SegmentSegmentProperty1Value {
     ...
     */
    public static SegmentSegmentProperty1Value fromMString(String mString) {
     ...
     */
    public static SegmentSegmentProperty1Value fromMBoolean(boolean mBoolean) {
    ...
    private static class MStringCase extends SegmentSegmentProperty1Value {
    ...
    private static class PrecisionCase extends SegmentSegmentProperty1Value {
    ...
    private static class NumberCase extends SegmentSegmentProperty1Value {
    ...
    private static class MBooleanCase extends SegmentSegmentProperty1Value {
    ...
    /**
     * This is a custom deserializer class for SegmentSegmentProperty1Value.
     */
    protected static class SegmentSegmentProperty1ValueDeserializer
            extends JsonDeserializer<SegmentSegmentProperty1Value> {

        @Override
        public SegmentSegmentProperty1Value deserialize(JsonParser jp, DeserializationContext ctxt)
