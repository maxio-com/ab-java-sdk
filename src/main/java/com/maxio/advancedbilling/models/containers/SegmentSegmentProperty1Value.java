...
public abstract class SegmentSegmentProperty1Value {
     ...
     */
    public static SegmentSegmentProperty1Value fromString(String string) {
     ...
     */
    public static SegmentSegmentProperty1Value fromBoolean(boolean mBoolean) {
    ...
    private static class StringCase extends SegmentSegmentProperty1Value {
    ...
    private static class BooleanCase extends SegmentSegmentProperty1Value {
