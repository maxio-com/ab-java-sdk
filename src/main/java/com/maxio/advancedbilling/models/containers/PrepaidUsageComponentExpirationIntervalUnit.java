 ...
 */
@JsonDeserialize(using = PrepaidUsageComponentExpirationIntervalUnit.PrepaidUsageComponentExpirationIntervalUnitDeserializer.class)
public abstract class PrepaidUsageComponentExpirationIntervalUnit {
     ...
     */
    public static PrepaidUsageComponentExpirationIntervalUnit fromIntervalUnit(
    ...
    private static class IntervalUnitCase extends PrepaidUsageComponentExpirationIntervalUnit {
    ...
    /**
     * This is a custom deserializer class for PrepaidUsageComponentExpirationIntervalUnit.
     */
    protected static class PrepaidUsageComponentExpirationIntervalUnitDeserializer
            extends JsonDeserializer<PrepaidUsageComponentExpirationIntervalUnit> {

        @Override
        public PrepaidUsageComponentExpirationIntervalUnit deserialize(JsonParser jp, DeserializationContext ctxt)
