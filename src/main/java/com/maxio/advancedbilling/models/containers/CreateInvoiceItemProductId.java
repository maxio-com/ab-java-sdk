 ...
 */
@JsonDeserialize(using = CreateInvoiceItemProductId.CreateInvoiceItemProductIdDeserializer.class)
public abstract class CreateInvoiceItemProductId {
     ...
     */
    public static CreateInvoiceItemProductId fromMString(String mString) {
    ...
    private static class MStringCase extends CreateInvoiceItemProductId {
    ...
    private static class NumberCase extends CreateInvoiceItemProductId {
    ...
    /**
     * This is a custom deserializer class for CreateInvoiceItemProductId.
     */
    protected static class CreateInvoiceItemProductIdDeserializer
            extends JsonDeserializer<CreateInvoiceItemProductId> {

        @Override
        public CreateInvoiceItemProductId deserialize(JsonParser jp, DeserializationContext ctxt)
