...
public abstract class CustomPriceUsedForSubscriptionCreateUpdateInterval {
     ...
     */
    public static CustomPriceUsedForSubscriptionCreateUpdateInterval fromMString(String mString) {
    ...
    private static class MStringCase extends CustomPriceUsedForSubscriptionCreateUpdateInterval {
