...
public abstract class SegmentSegmentProperty2Value {
     ...
     */
    public static SegmentSegmentProperty2Value fromString(String string) {
     ...
     */
    public static SegmentSegmentProperty2Value fromBoolean(boolean mBoolean) {
    ...
    private static class StringCase extends SegmentSegmentProperty2Value {
    ...
    private static class BooleanCase extends SegmentSegmentProperty2Value {
