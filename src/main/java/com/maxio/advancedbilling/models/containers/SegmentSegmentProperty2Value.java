 ...
 */
@JsonDeserialize(using = SegmentSegmentProperty2Value.SegmentSegmentProperty2ValueDeserializer.class)
public abstract class SegmentSegmentProperty2Value {
     ...
     */
    public static SegmentSegmentProperty2Value fromMString(String mString) {
     ...
     */
    public static SegmentSegmentProperty2Value fromMBoolean(boolean mBoolean) {
    ...
    private static class MStringCase extends SegmentSegmentProperty2Value {
    ...
    private static class PrecisionCase extends SegmentSegmentProperty2Value {
    ...
    private static class NumberCase extends SegmentSegmentProperty2Value {
    ...
    private static class MBooleanCase extends SegmentSegmentProperty2Value {
    ...
    /**
     * This is a custom deserializer class for SegmentSegmentProperty2Value.
     */
    protected static class SegmentSegmentProperty2ValueDeserializer
            extends JsonDeserializer<SegmentSegmentProperty2Value> {

        @Override
        public SegmentSegmentProperty2Value deserialize(JsonParser jp, DeserializationContext ctxt)
