 ...
 */
@JsonDeserialize(using = ListProductPricePointsInputProductId.ListProductPricePointsInputProductIdDeserializer.class)
public abstract class ListProductPricePointsInputProductId {
     ...
     */
    public static ListProductPricePointsInputProductId fromString(String string) {
    ...
    private static class NumberCase extends ListProductPricePointsInputProductId {
    ...
    private static class StringCase extends ListProductPricePointsInputProductId {
    ...
    /**
     * This is a custom deserializer class for ListProductPricePointsInputProductId.
     */
    protected static class ListProductPricePointsInputProductIdDeserializer
            extends JsonDeserializer<ListProductPricePointsInputProductId> {

        @Override
        public ListProductPricePointsInputProductId deserialize(JsonParser jp, DeserializationContext ctxt)
