 ...
 */
@JsonDeserialize(using = AllocationPreviousQuantity.AllocationPreviousQuantityDeserializer.class)
public abstract class AllocationPreviousQuantity {
     ...
     */
    public static AllocationPreviousQuantity fromString(String string) {
    ...
    private static class NumberCase extends AllocationPreviousQuantity {
    ...
    private static class StringCase extends AllocationPreviousQuantity {
    ...
    /**
     * This is a custom deserializer class for AllocationPreviousQuantity.
     */
    protected static class AllocationPreviousQuantityDeserializer
            extends JsonDeserializer<AllocationPreviousQuantity> {

        @Override
        public AllocationPreviousQuantity deserialize(JsonParser jp, DeserializationContext ctxt)
