 ...
 */
@JsonDeserialize(using = ListSubscriptionsInputDirection.ListSubscriptionsInputDirectionDeserializer.class)
public abstract class ListSubscriptionsInputDirection {
     ...
     */
    public static ListSubscriptionsInputDirection fromSortingDirection(
    ...
    private static class SortingDirectionCase extends ListSubscriptionsInputDirection {
    ...
    /**
     * This is a custom deserializer class for ListSubscriptionsInputDirection.
     */
    protected static class ListSubscriptionsInputDirectionDeserializer
            extends JsonDeserializer<ListSubscriptionsInputDirection> {

        @Override
        public ListSubscriptionsInputDirection deserialize(JsonParser jp, DeserializationContext ctxt)
