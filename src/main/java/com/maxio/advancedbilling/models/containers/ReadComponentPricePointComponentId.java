 ...
 */
@JsonDeserialize(using = ReadComponentPricePointComponentId.ReadComponentPricePointComponentIdDeserializer.class)
public abstract class ReadComponentPricePointComponentId {
     ...
     */
    public static ReadComponentPricePointComponentId fromString(String string) {
    ...
    private static class NumberCase extends ReadComponentPricePointComponentId {
    ...
    private static class StringCase extends ReadComponentPricePointComponentId {
    ...
    /**
     * This is a custom deserializer class for ReadComponentPricePointComponentId.
     */
    protected static class ReadComponentPricePointComponentIdDeserializer
            extends JsonDeserializer<ReadComponentPricePointComponentId> {

        @Override
        public ReadComponentPricePointComponentId deserialize(JsonParser jp, DeserializationContext ctxt)
