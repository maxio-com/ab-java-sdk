...
public class CreateCustomer {
    ...
    public String toString() {
        return "CreateCustomer [" + "firstName=" + firstName + ", lastName=" + lastName + ", email="
    ...
    /**
     * Builds a new {@link CreateCustomer.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CreateCustomer.Builder} object
     */
    public Builder toBuilder() {
        Builder builder = new Builder(firstName, lastName, email)
    ...
    /**
     * Class to build instances of {@link CreateCustomer}.
     */
