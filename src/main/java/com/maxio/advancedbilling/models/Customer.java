...
public class Customer
    ...
    protected Customer(OptionalNullable<Integer> chargifyId, String firstName, String lastName,
    ...
    public String toString() {
        return "Customer [" + "chargifyId=" + chargifyId + ", firstName=" + firstName
    ...
    public static class Builder {
        ...
        public Customer build() {
            return new Customer(chargifyId, firstName, lastName, organization, email, vatNumber,
                    reference);
        }
    }
}
