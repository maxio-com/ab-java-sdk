...
/**
 * This is a model class for Metafields1 type.
 */
public class Metafields1 {
    ...
    /**
     * Converts this Metafields1 into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "Metafields1 [" + "currentName=" + currentName + ", name=" + name + ", scope="
                + scope + ", inputType=" + inputType + ", mEnum=" + mEnum + "]";
    }

    /**
     * Builds a new {@link Metafields1.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link Metafields1.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link Metafields1}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link Metafields1} object using the set fields.
         * @return {@link Metafields1}
         */
        public Metafields1 build() {
            return new Metafields1(currentName, name, scope, inputType, mEnum);
        }
    }
}
