 ...
 */
public class ApplePayPaymentProfile
        extends BaseModel {
    private Integer id;
    private String firstName;
    private String lastName;
    private Integer customerId;
    private ApplePayVault currentVault;
     ...
     * @param  currentVault  ApplePayVault value for currentVault.
    ...
    protected ApplePayPaymentProfile(PaymentType paymentType, Integer id, String firstName,
            String lastName, Integer customerId, ApplePayVault currentVault, String vaultToken,
     ...
     */
    @JsonCreator
    protected ApplePayPaymentProfile(
     ...
     * @return Returns the ApplePayVault
     */
    @JsonGetter("current_vault")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public ApplePayVault getCurrentVault() {
        return currentVault;
    }
     ...
     * The vault that stores the payment profile with the provided vault_token.
     * @param currentVault Value for ApplePayVault
     */
    @JsonSetter("current_vault")
    public void setCurrentVault(ApplePayVault currentVault) {
        this.currentVault = currentVault;
    }
    ...
    public String toString() {
        return "ApplePayPaymentProfile [" + "paymentType=" + paymentType + ", id=" + id
    ...
    /**
     * Builds a new {@link ApplePayPaymentProfile.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ApplePayPaymentProfile.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ApplePayPaymentProfile}.
     */
    public static class Builder {
        private PaymentType paymentType = PaymentType.APPLE_PAY;
        private Integer id;
        private String firstName;
        private String lastName;
        private Integer customerId;
         ...
         * @return Builder
         */
        public Builder currentVault(ApplePayVault currentVault) {
            this.currentVault = currentVault;
            return this;
        }
         ...
         */
        public ApplePayPaymentProfile build() {
