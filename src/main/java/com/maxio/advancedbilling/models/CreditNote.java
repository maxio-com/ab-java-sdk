...
/**
 * This is a model class for CreditNote type.
 */
public class CreditNote {
    ...
    /**
     * Converts this CreditNote into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CreditNote [" + "uid=" + uid + ", siteId=" + siteId + ", customerId=" + customerId
    ...
    /**
     * Builds a new {@link CreditNote.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CreditNote.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CreditNote}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CreditNote} object using the set fields.
         * @return {@link CreditNote}
         */
        public CreditNote build() {
            return new CreditNote(uid, siteId, customerId, subscriptionId, number, sequenceNumber,
