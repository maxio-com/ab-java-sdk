...
/**
 * This is a model class for BackportInvoiceEvent type.
 */
public class BackportInvoiceEvent
        extends BaseModel {
    private long id;
    ...
    public BackportInvoiceEvent() {
        eventType = InvoiceEventType.BACKPORT_INVOICE;
    }
    ...
    public BackportInvoiceEvent(
            ...
            @JsonProperty("event_data") Invoice eventData) {
        this.id = id;
     ...
     * Example schema for an `backport_invoice` event
     * @param eventData Value for Invoice
     */
    @JsonSetter("event_data")
    public void setEventData(Invoice eventData) {
        this.eventData = eventData;
    }

    /**
     * Converts this BackportInvoiceEvent into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "BackportInvoiceEvent [" + "id=" + id + ", timestamp=" + timestamp + ", invoice="
    ...
    public static class Builder {
         ...
         * @return Builder
         */
        public Builder eventData(Invoice eventData) {
            this.eventData = eventData;
            return this;
        }

        /**
         * Builds a new {@link BackportInvoiceEvent} object using the set fields.
         * @return {@link BackportInvoiceEvent}
         */
        public BackportInvoiceEvent build() {
            return new BackportInvoiceEvent(id, timestamp, invoice, eventType, eventData);
        }
    }
}
