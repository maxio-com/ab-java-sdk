...
import com.maxio.advancedbilling.models.containers.CouponCouponResponseCompoundingStrategy;
import io.apimatic.core.types.OptionalNullable;
import java.util.List;

/**
 * This is a model class for CouponCouponResponse type.
 */
public class CouponCouponResponse {
    private Double id;
    private String name;
    private String code;
    ...
    private CouponCouponResponseCompoundingStrategy compoundingStrategy;
     ...
     * @param  compoundingStrategy  CouponCouponResponseCompoundingStrategy value for
     *         compoundingStrategy.
    ...
    public CouponCouponResponse(
            ...
            Boolean stackable,
            CouponCouponResponseCompoundingStrategy compoundingStrategy,
     ...
     */
    protected CouponCouponResponse(Double id, String name, String code, String description,
     ...
     * @return Returns the CouponCouponResponseCompoundingStrategy
     */
    @JsonGetter("compounding_strategy")
    @JsonInclude(JsonInclude.Include.NON_NULL)
    public CouponCouponResponseCompoundingStrategy getCompoundingStrategy() {
        return compoundingStrategy;
    }

    /**
     * Setter for CompoundingStrategy.
     * @param compoundingStrategy Value for CouponCouponResponseCompoundingStrategy
     */
    @JsonSetter("compounding_strategy")
    public void setCompoundingStrategy(CouponCouponResponseCompoundingStrategy compoundingStrategy) {
        this.compoundingStrategy = compoundingStrategy;
    }
    ...
    /**
     * Converts this CouponCouponResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "CouponCouponResponse [" + "id=" + id + ", name=" + name + ", code=" + code
                + ", description=" + description + ", amount=" + amount + ", amountInCents="
                + amountInCents + ", productFamilyId=" + productFamilyId + ", productFamilyName="
    ...
    /**
     * Builds a new {@link CouponCouponResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link CouponCouponResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link CouponCouponResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link CouponCouponResponse} object using the set fields.
         * @return {@link CouponCouponResponse}
         */
        public CouponCouponResponse build() {
            return new CouponCouponResponse(id, name, code, description, amount, amountInCents,
                    productFamilyId, productFamilyName, startDate, endDate, percentage, recurring,
                    recurringScheme, durationPeriodCount, durationInterval, durationIntervalUnit,
