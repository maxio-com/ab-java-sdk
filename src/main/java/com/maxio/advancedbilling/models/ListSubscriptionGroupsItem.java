...
/**
 * This is a model class for ListSubscriptionGroupsItem type.
 */
public class ListSubscriptionGroupsItem {
    ...
    public String toString() {
        return "ListSubscriptionGroupsItem [" + "uid=" + uid + ", scheme=" + scheme
    ...
    /**
     * Builds a new {@link ListSubscriptionGroupsItem.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ListSubscriptionGroupsItem.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ListSubscriptionGroupsItem}.
     */
