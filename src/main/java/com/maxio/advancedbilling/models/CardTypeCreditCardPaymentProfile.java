...
/**
 * CardTypeCreditCardPaymentProfile to be used.
 */
public enum CardTypeCreditCardPaymentProfile {
    VISA,
    ...
    private static TreeMap<String, CardTypeCreditCardPaymentProfile> valueMap = new TreeMap<>();
     ...
     */
    @JsonCreator
    public static CardTypeCreditCardPaymentProfile constructFromString(String toConvert) throws IOException {
        CardTypeCreditCardPaymentProfile enumValue = fromString(toConvert);
        if (enumValue == null)
        {
     ...
     * @return The enum member against the given string value.
     */
    public static CardTypeCreditCardPaymentProfile fromString(String toConvert) {
    ...
    /**
     * Convert list of CardTypeCreditCardPaymentProfile values to list of string values.
     * @param toConvert The list of CardTypeCreditCardPaymentProfile values to convert.
     * @return List of representative string values.
     */
    public static List<String> toValue(List<CardTypeCreditCardPaymentProfile> toConvert) {
        if (toConvert == null) {
            return null;
        }
        List<String> convertedValues = new ArrayList<>();
        for (CardTypeCreditCardPaymentProfile enumValue : toConvert) {
