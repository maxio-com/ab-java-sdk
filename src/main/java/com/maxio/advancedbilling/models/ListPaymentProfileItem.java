...
/**
 * This is a model class for ListPaymentProfileItem type.
 */
public class ListPaymentProfileItem {
    ...
    protected ListPaymentProfileItem(Integer id, String firstName, String lastName,
            ...
            String bankAccountHolderType, String paymentType, Integer siteGatewaySettingId,
            String gatewayHandle) {
        this.id = id;
        this.firstName = firstName;
        this.lastName = lastName;
    ...
    /**
     * Converts this ListPaymentProfileItem into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "ListPaymentProfileItem [" + "id=" + id + ", firstName=" + firstName + ", lastName="
                + lastName + ", customerId=" + customerId + ", currentVault=" + currentVault
                + ", vaultToken=" + vaultToken + ", billingAddress=" + billingAddress
                ...
                + bankAccountHolderType + ", paymentType=" + paymentType + ", siteGatewaySettingId="
                + siteGatewaySettingId + ", gatewayHandle=" + gatewayHandle + "]";
    }

    /**
     * Builds a new {@link ListPaymentProfileItem.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link ListPaymentProfileItem.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link ListPaymentProfileItem}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link ListPaymentProfileItem} object using the set fields.
         * @return {@link ListPaymentProfileItem}
         */
        public ListPaymentProfileItem build() {
            return new ListPaymentProfileItem(id, firstName, lastName, customerId, currentVault,
                    vaultToken, billingAddress, billingCity, billingState, billingZip,
                    ...
                    bankAccountHolderType, paymentType, siteGatewaySettingId, gatewayHandle);
        }
    }
}
